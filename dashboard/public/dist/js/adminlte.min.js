...
+(function (a) {
  ...
  var c = "lte.boxrefresh",
    ...
    f = function (b, c) {
      if (((this.element = b), (this.options = c), (this.$overlay = a(c.overlayTemplate)), "" === c.source))
    ...
    (g.prototype.activate = function () {
      ...
      (g.prototype.fixSidebar = function () {
        if (!a("body").hasClass(f.fixed))
          return void (void 0 !== a.fn.slimScroll && a(e.sidebar).slimScroll({ destroy: !0 }).height("auto"));
