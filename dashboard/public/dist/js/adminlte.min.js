  ...
  var c = "lte.boxrefresh",
    ...
    f = function (b, c) {
      if (
        ((this.element = b),
        (this.options = c),
        (this.$overlay = a(c.overlayTemplate)),
        "" === c.source)
      )
        throw new Error(
  ...
  (f.prototype.load = function () {
    this._addOverlay(),
      ...
      a.get(
        ...
        this.options.params,
        function (b) {
          this.options.loadInContent && a(this.element).find(this.options.content).html(b),
  ...
  ((a) => {
    ...
    (h.prototype.toggle = function (a, b) {
      var c = a.next(e.treeviewMenu),
        ...
        g = d.hasClass(f.open);
      d.is(e.treeview) &&
        ((this.options.followLink && "#" !== a.attr("href")) || b.preventDefault(),
      ...
      (h.prototype.expand = function (b, c) {
        ...
        c.addClass(f.open),
          b.slideDown(
            this.options.animationSpeed,
            function () {
              a(this.element).trigger(d), c.height("auto");
            }.bind(this)
          );
      }),
          ...
          b.slideUp(
            ...
            function () {
              a(this.element).trigger(d),
                c.find(e.treeview).removeClass(f.open).find(e.treeviewMenu).hide();
            }.bind(this)
          );
      }),
      (h.prototype._setUpListeners = function () {
    ...
    (g.prototype.activate = function () {
      this.fix(),
        ...
        this.options.resetHeight &&
          a("body, html, " + e.wrapper).css({ height: "auto", "min-height": "100%" }),
        this.bindedResize ||
          (a(window).resize(
            function () {
              this.fix(),
      ...
      (g.prototype.fixSidebar = function () {
        if (!a("body").hasClass(f.fixed))
          return void (
            void 0 !== a.fn.slimScroll && a(e.sidebar).slimScroll({ destroy: !0 }).height("auto")
          );
        this.options.slimscroll &&
          void 0 !== a.fn.slimScroll &&
          0 === a(e.mainSidebar).find(e.slimScrollDiv).length &&
          a(e.sidebar).slimScroll({ height: a(window).height() - a(e.mainHeader).height() + "px" });
      });
    var h = a.fn.layout;
    (a.fn.layout = b),
