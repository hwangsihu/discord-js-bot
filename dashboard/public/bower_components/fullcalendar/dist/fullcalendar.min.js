...
!(function (t, e) {
  ...
  return (function (t) {
    ...
    function (t, e, n) {
      ...
      function j(t, e) {
        ...
        return U(t)
          ? pt.duration(t * e)
          : ((n = t.asMonths()),
            Math.abs(n) >= 1 && ut(n) ? pt.duration({ months: n * e }) : pt.duration({ days: t.asDays() * e }));
      }
      function U(t) {
                ...
                e
                  ? ((r = { left: s.getEvX(e), top: s.getEvY(e) }),
                    ...
                    o &&
                      ...
                      (this.origHit && (n = s.intersectRects(this.origHit, n) || n), (i = s.getRectCenter(n))),
        ...
        u = (function () {
          ...
          return (
            ...
            (t.prototype.stopTouch = function (t, e) {
              void 0 === e && (e = !1),
                this.isTouching &&
                  ((this.isTouching = !1), this.trigger("touchend", t), e || this.startTouchMouseIgnore());
            }),
    ...
    function (t, e, n) {
      ...
      e.default = {
        parse: function (t, e) {
          return i.isTimeString(t.start) || r.isDuration(t.start) || i.isTimeString(t.end) || r.isDuration(t.end)
            ? s.default.parse(t, e)
            : o.default.parse(t, e);
        },
      };
        ...
        l = (function () {
          ...
          return (
            ...
            (t.prototype.mutateSingle = function (t) {
              ...
              return (
                this.dateMutation &&
                  ((e = t.dateProfile), (t.dateProfile = this.dateMutation.buildNewDateProfile(e, t.source.calendar))),
            ...
            (t.prototype.buildNewDateProfile = function (t, e) {
              ...
              return (
                ...
                this.forceTimed
                  ...
                  : this.forceAllDay && (n.hasTime() && n.stripTime(), r && r.hasTime() && r.stripTime()),
          ...
          return (
            ...
            (e.prototype.lockOverflow = function (t) {
              ...
              (t = t || this.getScrollbarWidths()),
                "auto" === e &&
                  (e =
                    t.top || t.bottom || this.scrollEl[0].scrollWidth - 1 > this.scrollEl[0].clientWidth
                      ? "scroll"
                      : "hidden"),
                "auto" === n &&
                  (n =
                    t.left || t.right || this.scrollEl[0].scrollHeight - 1 > this.scrollEl[0].clientHeight
                      ? "scroll"
                      : "hidden"),
          ...
          return (
            ...
            (e.prototype.bindDateHandlerToEl = function (t, e, n) {
              ...
              this.el.on(e, function (t) {
                if (
                  !i(t.target).is(
                    r.segSelector + ":not(.fc-helper)," + r.segSelector + ":not(.fc-helper) *,.fc-more,a[data-goto]"
                  )
                )
                  return n.call(r, t);
              });
            ...
            (e.prototype.canStartSelection = function (t, e) {
              return (
                ...
                (this.isEventDefDraggable(t.footprint.eventDef) || this.isEventDefResizable(t.footprint.eventDef))
              );
            }),
            ...
            (e.prototype.isEventDefStartEditable = function (t) {
              ...
              return (
                null == e && null == (e = this.opt("eventStartEditable")) && (e = this.isEventDefGenerallyEditable(t)),
                e
              );
            }),
        ...
        p = (function (t) {
          ...
          return (
            ...
            (e.prototype.triggerExternalDrop = function (t, e, n, r, i) {
              this.publiclyTrigger("drop", { context: n[0], args: [t.dateProfile.start.clone(), r, i, this] }),
                e &&
                  this.publiclyTrigger("eventReceive", { context: this, args: [t.buildInstance().toLegacy(), this] });
            }),
            ...
            (e.prototype.processRangeUnselect = function (t) {
              ...
              this.isSelected &&
                ...
                (((e = this.opt("unselectCancel")) && i(t.target).closest(e).length) || this.unselect(t));
            }),
        ...
        o = (function () {
          ...
          return (
            ...
            (t.prototype.getSegClasses = function (t, e, n) {
              var r = ["fc-event", t.isStart ? "fc-start" : "fc-not-start", t.isEnd ? "fc-end" : "fc-not-end"].concat(
                this.getClasses(t.footprint.eventDef)
              );
              return (
          ...
          return (
            ...
            (t.prototype.adjustActiveRange = function (t, e, n) {
              var r = t.getStart(),
                i = t.getEnd();
              return (
                this._view.usesMinMaxTime && (e < 0 && r.time(0).add(e), n > 864e5 && i.time(n - 864e5)),
                new o.default(r, i)
              );
            }),
            (t.prototype.buildRangeFromDuration = function (t, e, n, s) {
              ...
              return (
                h ||
                  ...
                  l ? ((u = r.duration(l)), (h = u < n ? i.computeDurationGreatestUnit(u, l) : s)) : (h = s)),
                n.as("days") <= 1 &&
        ...
        a = (function () {
          ...
          return (
            ...
            (t.prototype.endAutoScroll = function () {
              this.scrollIntervalId &&
                (clearInterval(this.scrollIntervalId), (this.scrollIntervalId = null), this.handleScrollEnd());
            }),
          ...
          return (
            ...
            (e.prototype.updateDayTableCols = function () {
              (this.colCnt = this.computeColCnt()),
                (this.colHeadFormat =
                  this.opt("columnHeaderFormat") || this.opt("columnFormat") || this.computeColHeadFormat());
            }),
          ...
          return (
            ...
            (e.prototype.renderGrid = function () {
              var t,
                ...
                i = this.colCnt,
                o = "";
              for (this.headContainerEl && this.headContainerEl.html(this.renderHeadHtml()), t = 0; t < r; t++)
            ...
            (e.prototype.renderNumberCellHtml = function (t) {
              ...
              return s || this.cellWeekNumbersVisible
                ? ((e = this.getDayClasses(t)),
                  ...
                  this.cellWeekNumbersVisible &&
                    t.day() === n &&
                    (i += r.buildGotoAnchorHtml({ date: t, type: "week" }, { class: "fc-week-number" }, t.format("w"))),
            ...
            (e.prototype.renderSegPopoverContent = function (t, e, n) {
              ...
              for (n = this.eventRenderer.renderFgSegEls(n, !0), this.popoverSegs = n, r = 0; r < n.length; r++)
                this.hitsNeeded(), (n[r].hit = this.getCellHit(t, e)), this.hitsNotNeeded(), d.append(n[r].el);
              return u;
            }),
            ...
            return (
              ...
              r.opt("weekNumbers") &&
                (r.opt("weekNumbersWithinDays")
                  ...
                  : ((r.dayGrid.cellWeekNumbersVisible = !1), (r.dayGrid.colWeekNumbersVisible = !0))),
            ...
            (e.prototype.updateSize = function (e, n, r) {
              ...
              t.prototype.updateSize.call(this, e, n, r),
                ...
                n ||
                  ...
                  (o.left || o.right) &&
                    (s.compensateScroll(l, o), (i = this.computeScrollerHeight(e)), this.scroller.setHeight(i)),
        ...
        s = (function (t) {
          ...
          return (
            ...
            (e.prototype.buildRenderRange = function (e, n, r) {
              ...
              return (
                /^(year|month)$/.test(n) && (s.startOf("week"), a.weekday() && a.add(1, "week").startOf("week")),
                new i.default(s, a)
              );
            }),
            e
        ...
        d = (function () {
          ...
          return (
            ...
            (t.prototype.isSelectionFootprintAllowed = function (t) {
              ...
              return (
                !!this.isFootprintAllowed(t, i, this.opt("selectConstraint"), this.opt("selectOverlap")) &&
            ...
            (t.prototype.isFootprintAllowed = function (t, e, n, o, s) {
              ...
              if (
                null != n &&
                ((a = this.constraintValToFootprints(n, t.isAllDay)), !this.isFootprintWithinConstraints(t, a))
              )
                return !1;
        ...
        u = (function () {
          ...
          return (
            (t.prototype.buildEventInstanceGroup = function (t, e) {
              ...
              if (r.length)
                return (n = new o.default(i.eventDefsToEventInstances(r, e))), (n.explicitEventDef = r[0]), n;
            }),
            (t.prototype.buildEventDefs = function (t) {
              var e,
                ...
                s = [];
              for (
                !0 === n ? (i = [{}]) : r.isPlainObject(n) ? (i = [n]) : r.isArray(n) && ((i = n), (o = !0)), e = 0;
                e < i.length;
                e++
              )
          ...
          return (
            ...
            (t.prototype.requestSource = function (t) {
              ...
              (this.requestsByUid[t.uid] = n),
                ...
                t.fetch(this.start, this.end, this.timezone).then(
                  function (t) {
                    "cancelled" !== n.status &&
                      ((n.status = "completed"), (n.eventDefs = t), e.addEventDefs(t), e.pendingCnt--, e.tryRelease());
                  },
                  function () {
            ...
            (t.prototype.purgeAllSources = function () {
              var t,
                ...
                r = 0;
              for (t in n)
                (e = n[t]), "pending" === e.status ? (e.status = "cancelled") : "completed" === e.status && r++;
          ...
          return (
            ...
            (t.prototype.buildMutatedEventInstanceGroup = function (t, e) {
              ...
              for (n = 0; n < i.length; n++)
                (r = i[n].clone()) instanceof d.default && (e.mutateSingle(r), o.push.apply(o, r.buildInstances()));
                    ...
                    i.extend({}, e.AJAX_DEFAULTS, l, {
                      ...
                      success: function (e, r, s) {
                        ...
                        a.calendar.popLoading(),
                          e
                            ? ((l = o.applyAll(u, a, [e, r, s])), i.isArray(l) && (e = l), t(a.parseEventDefs(e)))
                            : n();
                      },
          ...
          return (
            ...
            (t.prototype.stop = function (t, e) {
              ...
              this.isFollowing &&
                ...
                t && i && !this.isHidden
                  ? ((this.isAnimating = !0),
                    this.el.animate({ top: this.top0, left: this.left0 }, { duration: i, complete: o }))
                  : o());
            }),
          ...
          return (
            ...
            (e.prototype.queue = function (t, e, n) {
              ...
              e && (r = this.waitsByNamespace[e]),
                this.waitNamespace &&
                  (e === this.waitNamespace && null != r ? this.delayWait(r) : (this.clearWait(), this.tryStart())),
        ...
        H = (function () {
          ...
          return (
            ...
            (t.prototype.destroy = function () {
              this.view && this.clearView(),
                ...
                this.windowResizeProxy &&
                  (i(window).unbind("resize", this.windowResizeProxy), (this.windowResizeProxy = null)),
                u.default.unneeded();
            }),
            ...
            (t.prototype.applyTimezone = function (t) {
              ...
              return (
                r && ((e = n.clone().add(r)), t.time().asMilliseconds() - e.time().asMilliseconds() == 0 && (n = e)), n
              );
            }),
            ...
            (t.prototype.getDefaultEventEnd = function (t, e) {
              var n = e.clone();
              return (
                t ? n.stripTime().add(this.defaultAllDayEventDuration) : n.add(this.defaultTimedEventDuration),
                    ...
                    ? ((i = o.computeExternalDrop(r, u)),
                      i
                        ? ((e = new h.default(i.buildInstances())),
                          (n = u.eventProps ? s.isEventInstanceGroupAllowed(e) : s.isExternalInstanceGroupAllowed(e)))
                        : (n = !1))
                    : (n = !1),
          ...
          return (
            ...
            (e.prototype.handleMouseDown = function (t, e) {
              this.component.canStartResize(t, e) &&
                this.buildDragListener(t, i(e.target).is(".fc-start-resizer")).startInteraction(e, { distance: 5 });
            }),
                ...
                hitOver: function (n, l, c) {
                  ...
                  g && v
                    ? ((r = e
                      ...
                      r
                        ? ((h = d.buildMutatedEventInstanceGroup(p.id, r)), (f = s.isEventInstanceGroupAllowed(h)))
                        : (f = !1))
                    : (f = !1),
                    ...
                    r &&
                      ...
                      a.renderEventResize(
                        s.eventRangesToEventFootprints(h.sliceRenderRanges(s.dateProfile.renderUnzonedRange, u)),
                        t
                      ));
                },
                hitOut: function () {
            ...
            (e.prototype.computeEventStartResizeMutation = function (t, e, n) {
              ...
              return (
                ...
                ((r = new a.default()), r.setStartDelta(l), (i = new s.default()), i.setDateMutation(r), i)
              );
            }),
            (e.prototype.computeEventEndResizeMutation = function (t, e, n) {
              ...
              return (
                ...
                ((r = new a.default()), r.setEndDelta(l), (i = new s.default()), i.setDateMutation(r), i)
              );
            }),
            e
          );
                  ...
                  t.hit && (u = t.hit),
                    ...
                    p && f
                      ? ((r = o.computeEventDropMutation(p, f, h)),
                        r
                          ? ((v = c.buildMutatedEventInstanceGroup(h.id, r)), (y = s.isEventInstanceGroupAllowed(v)))
                          : (y = !1))
                      : (y = !1),
                    y || ((r = null), i.disableCursor()),
                    r &&
                    a.renderDrag(
                      s.eventRangesToEventFootprints(v.sliceRenderRanges(s.dateProfile.renderUnzonedRange, d)),
                      t,
                      g.isTouch
                    )
                      ? n.hide()
          ...
          return (
            ...
            (e.prototype.renderSkeletonHtml = function () {
              ...
              return (
                ...
                '">' +
                (this.dayGrid
                  ? '<div class="fc-day-grid"/><hr class="fc-divider ' + t.getClass("widgetHeader") + '"/>'
                  : "") +
                "</td></tr></tbody></table>"
              );
            }),
            ...
            (e.prototype.updateSize = function (e, n, r) {
              ...
              this.timeGrid.bottomRuleEl.hide(),
                ...
                n ||
                  ...
                  (s.left || s.right) &&
                    (u.compensateScroll(a, s), (o = this.computeScrollerHeight(e)), this.scroller.setHeight(o)),
      ...
      (e.default = f),
        ...
        (i = {
            ...
            return this.opt("weekNumbers")
              ? ((t = r.format(this.opt("smallWeekFormat"))),
                '<th class="fc-axis fc-week-number ' +
                  ...
                  e.axisStyleAttr() +
                  ">" +
                  e.buildGotoAnchorHtml({ date: r, type: "week", forceOff: this.colCnt > 1 }, u.htmlEscape(t)) +
                  "</th>")
          ...
          renderBgIntroHtml: function () {
            var t = this.view;
            return (
              '<td class="fc-axis ' + t.calendar.theme.getClass("widgetContent") + '" ' + t.axisStyleAttr() + "></td>"
            );
          },
          ...
          return (
            ...
            (e.prototype.sliceRangeByTimes = function (t) {
              ...
              for (n = 0; n < this.daysPerRow; n++)
                (e = t.intersect(this.dayRanges[n])) &&
                  r.push({ startMs: e.startMs, endMs: e.endMs, isStart: e.isStart, isEnd: e.isEnd, dayIndex: n });
              return r;
            }),
            ...
            (e.prototype.renderSlats = function () {
              ...
              (this.slatContainerEl = this.el
                .find("> .fc-slats")
                .html('<table class="' + t.getClass("tableGrid") + '">' + this.renderSlatRowHtml() + "</table>")),
            ...
            (e.prototype.renderColumns = function () {
              ...
              (this.dayRanges = this.dayDates.map(function (e) {
                ...
                this.el
                  .find("> .fc-bg")
                  .html('<table class="' + e.getClass("tableGrid") + '">' + this.renderBgTrHtml(0) + "</table>"),
          ...
          return (
            ...
            (e.prototype.renderSegs = function (t, e) {
              var n,
                ...
                s = [];
              for (
                this.eventRenderer.renderFgSegsIntoContainers(t, this.component.helperContainerEls), n = 0;
                n < t.length;
                n++
              )
                (r = t[n]),
          ...
          return (
            ...
            (e.prototype.renderSegRow = function (t, e) {
              function n(t) {
                for (; o < t; )
                  (d = (y[r - 1] || [])[o]),
                    d ? d.attr("rowspan", parseInt(d.attr("rowspan") || 1, 10) + 1) : ((d = s("<td/>")), a.append(d)),
                    (v[r][o] = d),
                    (y[r][o] = d),
                    o++;
              }
                  ...
                  for (l = 0; l < i.length; l++) {
                    for (
                      u = i[l],
                        ...
                        u.leftCol !== u.rightCol ? d.attr("colspan", u.rightCol - u.leftCol + 1) : (y[r][o] = d);
                      o <= u.rightCol;
                    )
                      (v[r][o] = d), (g[r][o] = u), o++;
                    a.append(d);
          ...
          return (
            ...
            (e.prototype.attachSegEls = function (t, e) {
              var n,
                ...
                o = [];
              for (n = 0; n < e.length; n++)
                (r = e[n]), (i = this.renderFillRow(t, r)), this.component.rowEls.eq(r.row).append(i), o.push(i[0]);
              return o;
            }),
        ...
        s = (function (t) {
          ...
          return (
            ...
            (e.prototype.buildRenderRange = function (e, n, r) {
              ...
              return (
                this.opt("fixedWeekCount") && ((i = Math.ceil(l.diff(a, "weeks", !0))), l.add(6 - i, "weeks")),
                new o.default(a, l)
              );
            }),
            e
          ...
          return (
            ...
            (e.prototype.renderSegList = function (t) {
              ...
              for (e = 0; e < o.length; e++)
                if ((n = o[e]))
                  for (
                    a.append(this.dayHeaderHtml(this.dayDates[e])), this.eventRenderer.sortEventSegs(n), r = 0;
                    r < n.length;
                    r++
                  )
                    a.append(n[r].el);
            ...
            (e.prototype.handleClick = function (e, n) {
              ...
              t.prototype.handleClick.call(this, e, n),
                i(n.target).closest("a[href]").length ||
                  ((r = e.footprint.eventDef.url) && !n.isDefaultPrevented() && (window.location.href = r));
            }),
            e
          );
        })(o.default);
          ...
          return (
            ...
            (t.prototype.render = function () {
              ...
              t
                ? (e
                    ? e.empty()
                    : (e = this.el = r("<div class='fc-toolbar " + this.toolbarOptions.extraClasses + "'/>")),
                  e
                    ...
                    r.each(s.split(","), function (t, s) {
                      ...
                      "title" === s
                        ...
                        : ((l = d[s])
                          ...
                          g &&
                            ...
                            y
                              ? ((m = i.htmlEscape(y)), (D = ""))
                              : v && ((m = "<span class='" + v + "'></span>"), (D = ' aria-label="' + s + '"')),
                            (w = r('<button type="button" class="' + b.join(" ") + '"' + D + ">" + m + "</button>")
                              .click(function (t) {
                                w.hasClass(o.getClass("stateDisabled")) ||
                                  (g(t),
                                  (w.hasClass(o.getClass("stateActive")) || w.hasClass(o.getClass("stateDisabled"))) &&
                      ...
                      f &&
                        h
                          ...
                          .end(),
                      h.length > 1
                        ? ((u = r("<div/>")), f && u.addClass(o.getClass("buttonGroup")), u.append(h), l.append(u))
                        : l.append(h);
                  }),
                l
              );
