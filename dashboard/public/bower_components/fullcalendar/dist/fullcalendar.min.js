...
})("undefined" != typeof self ? self : this, (t, e) =>
  ((t) => {
    function e(r) {
    ...
    (t, e, n) => {
      ...
      function b(t, e) {
        return Number.parseFloat(t.css(e)) || 0;
      }
      function w(t) {
      ...
      var r = n(2),
        ...
        l = ((t) => {
          ...
          return (
            ...
            (e.normalizeId = (t) => (t ? String(t) : null)),
            (e.prototype.fetch = (t, e, n) => {}),
            (e.prototype.removeEventDefsById = (t) => {}),
            (e.prototype.removeAllEventDefs = () => {}),
            (e.prototype.getPrimitive = (t) => {}),
      ...
      var r = n(2),
        ...
        s = ((t) => {
          ...
          return (
            ...
            (e.prototype._prepareIntercept = (t) => {
              var e = function (e, n) {
      ...
      var n = (() => {
        ...
        return (
          (t.mixInto = function (t) {
            Object.getOwnPropertyNames(this.prototype).forEach((n) => {
              t.prototype[n] || (t.prototype[n] = this.prototype[n]);
            });
          }),
          (t.mixOver = function (t) {
            Object.getOwnPropertyNames(this.prototype).forEach((n) => {
              t.prototype[n] = this.prototype[n];
            });
          }),
          t
        );
          ...
          return (
            ...
            (t.prototype.sliceInverseRenderRanges = function (t) {
              var e = this.eventInstances.map(i.eventInstanceToUnzonedRange),
                n = this.getEventDef();
              return (e = r.default.invertRanges(e, t)), e.map((t) => new o.default(t, n));
            }),
    ...
    (t, e, n) => {
      function r(t, e) {
        t.then = (n) => ("function" == typeof n ? s.resolve(n(e)) : t);
      }
      function i(t) {
        t.then = (e, n) => ("function" == typeof n && n(), t);
      }
      Object.defineProperty(e, "__esModule", { value: !0 });
      var o = n(3),
        s = {
            ...
            (t.prototype.bind = function () {
              this.listenTo(r(document), {
                ...
                window.addEventListener(
                  "touchmove",
                  (this.handleTouchMoveProxy = (e) => {
                    this.handleTouchMove(r.Event(e));
                  }),
                  { passive: !1 }
                ),
                window.addEventListener(
                  "scroll",
                  (this.handleScrollProxy = (e) => {
                    this.handleScroll(r.Event(e));
                  }),
                  !0
                );
            }),
    ...
    (t, e, n) => {
      ...
      var p = {
        ...
        h = {
          ...
          mediumTimeFormat: (t) => t.longDateFormat("LT").replace(/\s*a$/i, "a"),
          smallTimeFormat: (t) =>
            t
              .longDateFormat("LT")
              .replace(":mm", "(:mm)")
          ...
          hourFormat: (t) =>
            t
              ...
              .replace(/(\Wmm)$/, "")
              .replace(/\s*a$/i, "a"),
          noMeridiemTimeFormat: (t) => t.longDateFormat("LT").replace(/\s*a$/i, ""),
        },
        f = {
          smallDayDateFormat: (t) => (t.isRTL ? "D dd" : "dd D"),
          weekFormat: (t) =>
            t.isRTL ? "w[ " + t.weekNumberTitle + "]" : "[" + t.weekNumberTitle + " ]w",
          smallWeekFormat: (t) =>
            t.isRTL ? "w[" + t.weekNumberTitle + "]" : "[" + t.weekNumberTitle + "]w",
        };
      ...
      var r = n(3),
        ...
        o = (() => {
          ...
          return (
            ...
            (t.normalizeId = (t) => String(t)),
            (t.generateId = () => "_fc" + t.uuid++),
            (t.prototype.clone = function () {
        ...
        l = ((t) => {
          ...
          return (
            ...
            (e.prototype.bindAllSegHandlersToEl = function (t) {
              [this.eventPointing, this.eventDragging, this.eventResizing].forEach((e) => {
                e && e.bindToEl(t);
              });
            }),
            (e.prototype.bindSegHandlerToEl = function (t, e, n) {
              t.on(e, this.segSelector, (t) => {
                var e = i(t.currentTarget);
                if (!e.is(".fc-helper")) {
                  var o = e.data("fc-seg");
                  if (o && !this.shouldIgnoreEventPointing()) return n.call(this, o, t);
                }
              });
            }),
            (e.prototype.shouldIgnoreMouse = () => a.default.get().shouldIgnoreMouse()),
        ...
        p = ((t) => {
          ...
          return (
            ...
            (e.prototype.requestEventsRender = function (t) {
              this.requestRender(
                () => {
                  this.executeEventRender(t), this.whenSizeUpdated(this.triggerAfterEventsRendered);
                },
                "event",
                "init"
              );
            ...
            (e.prototype.requestEventsUnrender = function () {
              this.requestRender(
                () => {
                  this.triggerBeforeEventsDestroyed(), this.executeEventUnrender();
                },
                "event",
                "destroy"
              );
              ...
              this.opt("nowIndicator") &&
                ...
                (this.nowIndicatorTimeoutID = setTimeout(() => {
                  (this.nowIndicatorTimeoutID = null),
                    ...
                    (n = +o.duration(1, t)),
                    (n = Math.max(100, n)),
                    (this.nowIndicatorIntervalID = setInterval(e, n));
                }, n)));
            }),
            ...
            (e.prototype.computeInitialDateScroll = () => ({})),
            (e.prototype.queryDateScroll = () => ({})),
            (e.prototype.applyDateScroll = (t) => {}),
            ...
            (e.prototype.isDateInOtherMonth = (t, e) => !1),
      ...
      var r = n(3),
        ...
        o = (() => {
          ...
          return (
            ...
            (t.prototype.renderFgSegs = (t) => !1),
            (t.prototype.unrenderFgSegs = (t) => {}),
            (t.prototype.renderBgSegs = function (t) {
              if (!this.fillRenderer) return !1;
              this.fillRenderer.renderSegs("bgEvent", t, {
                getClasses: (t) => this.getBgClasses(t.footprint.eventDef),
                getCss: (t) => ({ "background-color": this.getBgColor(t.footprint.eventDef) }),
                filterEl: (t, n) => this.filterEventRenderEl(t.footprint, n),
              });
            }),
            ...
            (t.prototype.renderFgSegEls = function (t, e) {
              ...
              if (t.length) {
                ...
                r(s).each((e, i) => {
                  var s = t[e],
                    l = r(i);
                  o && (l = this.filterEventRenderEl(s.footprint, l)),
                    l && (l.data("fc-seg", s), (s.el = l), a.push(s));
                });
              }
              return a;
            }),
            (t.prototype.beforeFgSegHtml = (t) => {}),
            (t.prototype.fgSegHtml = (t, e) => {}),
            ...
            (t.prototype.computeDisplayEventTime = () => !0),
            (t.prototype.computeDisplayEventEnd = () => !0),
            ...
            (t.prototype.getFallbackStylingObjs = (t) => [t.source]),
    ...
    (t, e, n) => {
      ...
      function g(t) {
        return t.replace(D, (t, e) => (e.match(/[1-9]/) ? e : ""));
      }
      function v(t) {
        var e,
          n,
      ...
      var m = "\v",
        ...
        E = {
          t: (t) => y.oldMomentFormat(t, "a").charAt(0),
          T: (t) => y.oldMomentFormat(t, "A").charAt(0),
        },
        S = {
          Y: { value: 1, unit: "year" },
            ...
            (e.prototype._watchDeps = function (t, e, n) {
              ...
              return (
                ...
                t.forEach((t) => {
                  var e = !1;
                  "?" === t.charAt(0) && ((t = t.substring(1)), (e = !0)),
                    this.has(t) ? ((a[t] = this.get(t)), s++) : e && s++;
                }),
                s === o && e(a),
                {
                  teardown: () => {
                    for (var t = 0; t < l.length; t++) this.off(l[t][0], l[t][1]);
                    (l = null), s === o && n();
                  },
                  flash: () => {
                    s === o && (n(), e(a));
      ...
      var r = n(2),
        ...
        s = ((t) => {
          ...
          return (
            ...
            (e.prototype.applyManualStandardProps = (t) => !0),
            (e.prototype.applyMiscProps = (t) => {}),
      ...
      var r = n(0),
        ...
        s = (() => {
          ...
          return (
            ...
            (t.prototype.getFallbackDuration = () => r.duration({ days: 1 })),
            ...
            (t.prototype.buildRenderRange = (t, e, n) => t.clone()),
        ...
        u = ((t) => {
          ...
          return (
            ...
            (e.prototype.removeEventDefsById = function (t) {
              return o.removeMatching(this.eventDefs, (e) => e.id === t);
            }),
        ...
        s = ((t) => {
          ...
          return (
            ...
            (e.prototype.updateDayTable = function () {
              for (
                var t,
                  ...
                  i = this.view,
                  o = i.calendar,
                  s = o.msToUtcMoment(this.dateProfile.renderUnzonedRange.startMs, !0),
                  a = o.msToUtcMoment(this.dateProfile.renderUnzonedRange.endMs, !0),
                  l = -1,
                  u = [],
                  d = [];
                s.isBefore(a);
            ...
            (e.prototype.renderHeadDateCellHtml = function (t, e, n) {
              var r,
                s = this.view,
                a = this.dateProfile.activeUnzonedRange.containsDate(t),
                l = ["fc-day-header", s.calendar.theme.getClass("widgetHeader")];
              return (
                (r =
                  "function" == typeof this.opt("columnHeaderHtml")
                    ? this.opt("columnHeaderHtml")(t)
                    : "function" == typeof this.opt("columnHeaderText")
                      ? i.htmlEscape(this.opt("columnHeaderText")(t))
                      : i.htmlEscape(t.format(this.colHeadFormat))),
                1 === this.rowCnt
                  ? (l = l.concat(this.getDayClasses(t, !0)))
                  : l.push("fc-" + i.dayIDs[t.day()]),
                '<th class="' +
                  l.join(" ") +
                  '"' +
                  (1 === (a && this.rowCnt) ? ' data-date="' + t.format("YYYY-MM-DD") + '"' : "") +
                  (e > 1 ? ' colspan="' + e + '"' : "") +
                  (n ? " " + n : "") +
                  ">" +
                  (a
          ...
          (t.prototype.renderSegs = function (t) {
            this.fillRenderer &&
              this.fillRenderer.renderSegs("businessHours", t, {
                getClasses: (t) => ["fc-nonbusiness", "fc-bgevent"],
              });
          }),
          (t.prototype.unrender = function () {
              ...
              if (e.length) {
                ...
                r(s).each((t, i) => {
                  ...
                  n.filterEl && (l = n.filterEl(s, l)),
                    l && ((l = r(l)), l.is(this.fillSegTag) && ((s.el = l), a.push(s)));
                });
              }
              return a;
            }),
          ...
          return (
            ...
            (e.prototype.renderMoreLink = function (t, e, n) {
              ...
              return i('<a class="fc-more"/>')
                ...
                .on("click", (s) => {
                  var a = this.opt("eventLimitClick"),
                    l = this.getCellDate(t, e),
                    u = i(s.currentTarget),
                    d = this.getCellEl(t, e),
                    c = this.getCellSegs(t, e),
                    p = this.resliceDaySegs(c, l),
                    h = this.resliceDaySegs(n, l);
                  "function" == typeof a &&
                    (a = this.publiclyTrigger("eventLimitClick", {
                      context: o,
                      args: [
            ...
            (e.prototype.showSegPopover = function (t, e, n, r) {
              ...
              (i = 1 === this.rowCnt ? l.el : this.rowEls.eq(t)),
                (o = {
                  ...
                  hide: () => {
                    this.popoverSegs && this.triggerBeforeEventSegsDestroyed(this.popoverSegs),
      ...
      var i = n(2),
        ...
        c = ((t) => {
          ...
          return (
            ...
            (e.prototype.computeInitialDateScroll = () => ({ top: 0 })),
      ...
      var o = n(5),
        ...
        d = (() => {
          ...
          return (
            ...
            (t.prototype.eventRangeToEventFootprints = (t) => [u.eventRangeToEventFootprint(t)]),
            ...
            (t.prototype.footprintContainsFootprint = (t, e) =>
              t.unzonedRange.containsRange(e.unzonedRange)),
            (t.prototype.footprintsIntersect = (t, e) =>
              t.unzonedRange.intersectsWith(e.unzonedRange)),
            t
          );
        })();
      e.default = d;
        ...
        u = (() => {
          ...
          return (
            ...
            (t.prototype.requestSource = function (t) {
              var n = { source: t, status: "pending", eventDefs: null };
              (this.requestsByUid[t.uid] = n),
                ...
                t.fetch(this.start, this.end, this.timezone).then(
                  ...
                  () => {
                    "cancelled" !== n.status &&
                      ((n.status = "failed"), this.pendingCnt--, this.tryRelease());
                  }
                );
            }),
            ...
            (t.prototype.removeEventDefsById = function (t) {
              this.getEventDefsById(t).forEach((t) => {
                this.removeEventDef(t);
              });
            }),
            ...
            (t.prototype.removeEventInstancesForDef = function (t) {
              var e,
                ...
                r = n[t.id];
              r &&
                ((e = i.removeMatching(r.eventInstances, (e) => e.def === t)),
          ...
          return (
            ...
            (t.prototype.querySources = function (t) {
              ...
              return (n = this.getSourceById(l.default.normalizeId(t)))
                ? [n]
                : ((t = u.default.parse(t, this.calendar)), t ? i.grep(o, (e) => r(t, e)) : void 0);
            }),
            (t.prototype.getSourceById = function (t) {
              return i.grep(this.otherSources, (e) => e.id && e.id === t)[0];
            }),
          ...
          return (
            ...
            (e.prototype.fetch = function (t, e, n) {
              return (
                ...
                o.default.construct((i) => {
                  this.func.call(this.calendar, t.clone(), e.clone(), n, (t) => {
                    this.calendar.popLoading(), i(this.parseEventDefs(t));
                  });
                })
              );
            }),
        ...
        l = ((t) => {
          ...
          return (
            ...
            (e.prototype.fetch = function (t, n, r) {
              var l = this.ajaxSettings,
                u = l.success,
                d = l.error,
                c = this.buildRequestParams(t, n, r);
              return (
                this.calendar.pushLoading(),
                s.default.construct((t, n) => {
                  i.ajax(
                    i.extend({}, e.AJAX_DEFAULTS, l, {
                      ...
                      success: (e, r, s) => {
                        ...
                        this.calendar.popLoading(),
                          e
                            ? ((l = o.applyAll(u, this, [e, r, s])),
                              i.isArray(l) && (e = l),
                              t(this.parseEventDefs(e)))
                            : n();
                      },
                      error: (t, e, r) => {
                        this.calendar.popLoading(), o.applyAll(d, this, [t, e, r]), n();
                      },
                    })
                  );
                })
        ...
        s = (() => {
          ...
          return (
            ...
            (t.prototype.stop = function (t, e) {
              var i = this.options.revertDuration,
                o = () => {
                  (this.isAnimating = !1),
                    this.removeElement(),
            ...
            (t.prototype.runRemaining = function () {
              ...
              do {
                if (((t = this.q.shift()), (e = this.runTask(t)) && e.then))
                  return void e.then(() => {
                    this.canRunNext() && this.runRemaining();
                  });
              } while (this.canRunNext());
              this.trigger("stop"), (this.isRunning = !1), this.tryStart();
            }),
            (t.prototype.runTask = (t) => t()),
            t
          );
        })();
          ...
          return (
            ...
            (e.prototype.spawnWait = function (t) {
              this.waitId = setTimeout(() => {
                (this.waitNamespace = null), this.tryStart();
              }, t);
            }),
      ...
      var r = n(2),
        ...
        o = ((t) => {
          ...
          return (
            ...
            (e.prototype.bindGlobalHandlers = () => {}),
            (e.prototype.unbindGlobalHandlers = () => {}),
            (e.prototype.renderSkeleton = () => {}),
            (e.prototype.unrenderSkeleton = () => {}),
            e
          );
        })(i.default);
      e.default = o;
      ...
      var i = n(2),
        ...
        p = ((t) => {
          ...
          return (
            ...
            (e.prototype.renderDates = (t) => {}),
            (e.prototype.unrenderDates = () => {}),
            (e.prototype.getNowIndicatorUnit = () => {}),
            ...
            (e.prototype.triggerBeforeEventSegsDestroyed = function (t) {
              this.hasPublicHandlers("eventDestroy") &&
                t.forEach((t) => {
                  ...
                  t.el &&
                    ((n = t.footprint.getEventLegacy()),
                    this.publiclyTrigger("eventDestroy", { context: n, args: [n, t.el, this] }));
                });
            }),
            ...
            (e.prototype.prepareHits = () => {}),
            (e.prototype.releaseHits = () => {}),
            (e.prototype.queryHit = function (t, e) {
              var n,
                r,
            ...
            (e.prototype.getHitFootprint = (t) => {}),
            (e.prototype.getHitEl = (t) => {}),
            ...
            (e.prototype.eventRangeToEventFootprints = (t) => [c.eventRangeToEventFootprint(t)]),
            ...
            (e.prototype.componentFootprintToSegs = (t) => []),
        ...
        H = (() => {
          ...
          return (
            ...
            (t.prototype.initialRender = function () {
              var e = this.el;
              e.addClass("fc"),
                e.on("click.fc", "a[data-goto]", (e) => {
                  var n = i(e.currentTarget),
                    r = n.data("goto"),
                    o = this.moment(r.date),
                    a = r.type,
                    l = this.view.opt("navLink" + s.capitaliseFirstLetter(a) + "Click");
                  "function" == typeof l
                    ? l(o, e)
                    : ("string" == typeof l && (a = l), this.zoomTo(o, a));
                }),
                this.optionsManager.watch(
                  ...
                  (n) => {
                    var r = I.getThemeSystemClass(n.themeSystem || n.theme),
                      i = new r(this.optionsManager),
                      o = i.getClass("widget");
                    (this.theme = i), o && e.addClass(o);
                  },
                  () => {
                    var n = this.theme.getClass("widget");
                    (this.theme = null), n && e.removeClass(n);
                  }
                ),
                this.optionsManager.watch(
                  ...
                  ["?businessHours"],
                  (e) => {
                    (this.businessHourGenerator = new E.default(e.businessHours, this)),
                      this.view &&
                ...
                this.optionsManager.watch("applyingDirClasses", ["?isRTL", "?locale"], (t) => {
            ...
            (t.prototype.bindViewHandlers = function (t) {
              t.watch("titleForCalendar", ["title"], (n) => {
                t === this.view && this.setToolbarsTitle(n.title);
              }),
                t.watch("dateProfileForCalendar", ["dateProfile"], (n) => {
                  t === this.view &&
                    ((this.currentDate = n.dateProfile.date),
                    this.updateToolbarButtons(n.dateProfile));
                });
            }),
            (t.prototype.unbindViewHandlers = (t) => {
            ...
            (t.prototype.queryToolbarsHeight = function () {
              return this.toolbarsManager.items.reduce(
                (t, e) => t + (e.el ? e.el.outerHeight(!0) : 0),
                0
              );
            }),
                ...
                this.optionsManager.watch(
                  ...
                  (e) => {
                    ...
                    e.monthNames && (o._months = e.monthNames),
                      ...
                      (this.localeData = o),
                      this.currentDate && this.localizeMoment(this.currentDate);
                  }
                );
            }),
            ...
            (t.prototype.initEventManager = function () {
              var e = new D.default(this),
                n = this.opt("eventSources") || [],
                r = this.opt("events");
              (this.eventManager = e),
                r && n.unshift(r),
                e.on("release", (e) => {
                  this.trigger("eventsReset", e);
                }),
                e.freeze(),
                n.forEach((n) => {
                  var r = S.default.parse(n, this);
                  r && e.addSource(r);
                }),
                e.thaw();
            }),
            ...
            (t.prototype.clientEvents = function (t) {
              var e = [];
              return (
                this.eventManager.getEventInstances().forEach((t) => {
                  e.push(t.toLegacy());
                }),
                r(e, t)
              );
            ...
            (e.prototype.listenToExternalDrag = function (t, e, n) {
              ...
              (this.dragListener = new c.default(s, {
                ...
                hitOver: (t) => {
                  ...
                  r
                    ? ((i = this.computeExternalDrop(r, u)),
                      i
          ...
          return (
            ...
            (e.prototype.buildDragListener = function (t, e) {
              ...
              return (this.dragListener = new l.default(s, {
                ...
                dragStart: (e) => {
                  (n = !0), this.eventPointing.handleMouseout(t, e), this.segResizeStart(t, e);
                },
                hitOver: (n, l, c) => {
                  var h,
                    f = !0,
                  ...
                  g && v
                    ? ((r = e
                        ? this.computeEventStartResizeMutation(g, v, t.footprint)
                        : this.computeEventEndResizeMutation(g, v, t.footprint)),
                      r
              ...
              var g = (this.dragListener = new l.default(a, {
                ...
                interactionStart: (r) => {
                  (t.component = s),
                    ...
                    (n = new u.default(t.el, {
                      ...
                      parentEl: a.el,
                      opacity: g.isTouch ? null : this.opt("dragOpacity"),
                ...
                dragStart: (n) => {
                  g.isTouch && !a.isEventDefSelected(h) && f && a.selectEventInstance(f),
                    (e = !0),
                    this.eventPointing.handleMouseout(t, n),
                    this.segDragStart(t, n),
                    a.hideEventsWithId(t.footprint.eventDef.id);
                },
                hitOver: (e, l, u) => {
                  var p,
                  ...
                  t.hit && (u = t.hit),
                    ...
                    p && f
                      ? ((r = this.computeEventDropMutation(p, f, h)),
                        r
                ...
                interactionEnd: (i) => {
                  delete t.component,
                    n.stop(!r, () => {
                      e && (a.unrenderDrag(t), this.segDragStop(t, i)),
                        a.showEventsWithId(t.footprint.eventDef.id),
        ...
        u = ((t) => {
          ...
          return (
            ...
            (e.prototype.bindToEl = function (t) {
              var n = this.component,
                r = this.dragListener;
              n.bindDateHandlerToEl(t, "mousedown", (t) => {
                this.opt("selectable") &&
                  !n.shouldIgnoreMouse() &&
                  r.startInteraction(t, { distance: this.opt("selectMinDistance") });
              }),
                n.bindDateHandlerToEl(t, "touchstart", (t) => {
                  this.opt("selectable") &&
                    !n.shouldIgnoreTouch() &&
                    r.startInteraction(t, { delay: this.getDelay() });
                }),
              ...
              return new o.default(n, {
                ...
                hitOver: (r, o, s) => {
                  ...
                  s &&
                    ...
                    (t = a && l ? this.computeSelection(a, l) : null),
                ...
                interactionEnd: (n, r) => {
                  !r && t && this.view.reportSelection(t, n);
                },
              });
            }),
            ...
            (e.prototype.computeSelectionFootprint = (t, e) => {
              var n = [
        ...
        s = ((t) => {
          ...
          return (
            ...
            (e.prototype.bindToEl = function (t) {
              var e = this.component,
                n = this.dragListener;
              e.bindDateHandlerToEl(t, "mousedown", (t) => {
                e.shouldIgnoreMouse() || n.startInteraction(t);
              }),
                e.bindDateHandlerToEl(t, "touchstart", (t) => {
                ...
                r = new i.default(n, {
                  ...
                  interactionEnd: (r, i) => {
                    ...
                    !i &&
                      ...
                      this.view.triggerDayClick(o, n.getHitEl(t), r);
                  },
                });
      ...
      var i,
        ...
        f = ((t) => {
          ...
          return (
            ...
            (e.prototype.getHitFootprint = (t) => t.component.getHitFootprint(t)),
            (e.prototype.getHitEl = (t) => t.component.getHitEl(t)),
            (e.prototype.executeEventRender = function (t) {
              var e,
                n,
                r = {},
      ...
      var r = n(2),
        ...
        m = ((t) => {
          ...
          return (
            ...
            (e.prototype.computeLabelInterval = (t) => {
              var e, n, r;
            ...
            (e.prototype.renderColumns = function () {
              ...
              (this.dayRanges = this.dayDates.map(
                (e) => new p.default(e.clone().add(t.minTime), e.clone().add(t.maxTime))
              )),
            ...
            (e.prototype.getNowIndicatorUnit = () => "minute"),
            (e.prototype.renderNowIndicator = function (t) {
            ...
            (e.prototype.generateSegVerticalCss = (t) => ({ top: t.top, bottom: -t.bottom })),
            (e.prototype.prepareHits = function () {
      ...
      var l = n(2),
        ...
        c = ((t) => {
          ...
          return (
            ...
            (e.prototype.computeDisplayEventEnd = () => !0),
            ...
            (e.prototype.renderSegRow = function (t, e) {
              function n(t) {
                while (o < t)
                  (d = (y[r - 1] || [])[o]),
                    d
                      ? d.attr("rowspan", Number.parseInt(d.attr("rowspan") || 1, 10) + 1)
                      : ((d = s("<td/>")), a.append(d)),
                    (v[r][o] = d),
                    (y[r][o] = d),
                    o++;
          ...
          return (
            ...
            (e.prototype.renderSegs = function (t, e) {
              ...
              return (
                ...
                this.component.rowEls.each((t, o) => {
                  var s,
                    a,
                    l = i(o),
      ...
      var r = n(2),
        ...
        l = ((t) => {
          ...
          return (
            ...
            (e.prototype.isDateInOtherMonth = (t, e) =>
              t.month() !== i.utc(e.currentUnzonedRange.startMs).month()),
            e
          );
        })(s.default);
