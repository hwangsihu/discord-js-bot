...
----------------------------------------------------------------------------------------------------------------------*/
        ...
        function getClientRect(el, origin) {
          ...
          var left =
            offset.left + getCssFloat(el, "border-left-width") + scrollbarWidths.left - (origin ? origin.left : 0);
...
----------------------------------------------------------------------------------------------------------------------*/
    ...
    */
          ...
          UnzonedRange.prototype.intersectsWith = function (otherRange) {
            return (
              (this.endMs == null || otherRange.startMs == null || this.endMs > otherRange.startMs) &&
              (this.startMs == null || otherRange.endMs == null || this.startMs < otherRange.endMs)
            );
          };
          UnzonedRange.prototype.containsRange = function (innerRange) {
            return (
              (this.startMs == null || (innerRange.startMs != null && innerRange.startMs >= this.startMs)) &&
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        function eventRangeToEventFootprint(eventRange) {
          return new EventFootprint_1.default(
            new ComponentFootprint_1.default(eventRange.unzonedRange, eventRange.eventDef.isAllDay()),
            eventRange.eventDef,
        ...
        var InteractiveDateComponent = /** @class */ (function (_super) {
          ...
          InteractiveDateComponent.prototype.canStartSelection = function (seg, ev) {
            return (
              ...
              (this.isEventDefDraggable(seg.footprint.eventDef) || this.isEventDefResizable(seg.footprint.eventDef))
            );
          };
          ...
          InteractiveDateComponent.prototype.canStartResize = function (seg, ev) {
            ...
            return (
              (!util_1.getEvIsTouch(ev) || view.isEventDefSelected(eventDef)) &&
          ...
          View.prototype.startNowIndicator = function () {
            ...
            if (this.opt("nowIndicator")) {
              ...
              if (unit) {
                ...
                delay =
                  this.initialNowDate.clone().startOf(unit).add(1, unit).valueOf() - this.initialNowDate.valueOf();
    ...
    ------------------------------------------------------------------------------------------------------------------*/
          ...
          DayTableMixin.prototype.renderHeadDateCellHtml = function (date, colspan, otherAttrs) {
            ...
            return (
              ...
              classNames.join(" ") +
              '"' +
              ((isDateValid && t.rowCnt) === 1 ? ' data-date="' + date.format("YYYY-MM-DD") + '"' : "") +
...
----------------------------------------------------------------------------------------------------------------------*/
    ...
    ------------------------------------------------------------------------------------------------------------------*/
          ...
          DayGrid.prototype.renderNumberCellHtml = function (date) {
            ...
            html +=
              '<td class="' + classes.join(" ") + '"' + (isDateValid ? ' data-date="' + date.format() + '"' : "") + ">";
                ...
                newSegs.push(
                  $.extend({}, seg, {
                    footprint: new EventFootprint_1.default(
                      new ComponentFootprint_1.default(slicedRange, seg.footprint.componentFootprint.isAllDay),
        ...
        function makeDayGridSubclass(SuperClass) {
          return /** @class */ (function (_super) {
            ...
            SubClass.prototype.getIsNumbersVisible = function () {
              return (
                DayGrid_1.default.prototype.getIsNumbersVisible.apply(this, arguments) || this.colWeekNumbersVisible
              );
            };
            return SubClass;
          })(SuperClass);
        ...
        var Calendar = /** @class */ (function () {
          ...
          Calendar.prototype.renderView = function (viewType) {
            ...
            if (!this.view && viewType) {
              newView = this.view =
                this.viewsByType[viewType] || (this.viewsByType[viewType] = this.instantiateView(viewType));
          ...
          Calendar.prototype._calcSize = function () {
            ...
            if (typeof contentHeightInput === "number") {
              ...
              this.suggestedViewHeight = Math.round(this.contentEl.width() / Math.max(this.opt("aspectRatio"), 0.5));
            }
          };
    ...
    */
          ...
          Calendar.prototype.updateEvent = function (eventProps) {
            ...
            if (eventDef instanceof SingleEventDef_1.default) {
              ...
              eventDefMutation = EventDefMutation_1.default.createFromRawProps(
                eventInstance,
...
----------------------------------------------------------------------------------------------------------------------*/
    ...
    */
          ...
          EventResizing.prototype.handleMouseDown = function (seg, ev) {
            if (this.component.canStartResize(seg, ev)) {
              this.buildDragListener(seg, $(ev.target).is(".fc-start-resizer")).startInteraction(ev, { distance: 5 });
            }
          };
    ...
    */
          ...
          DateSelecting.prototype.isSelectionFootprintAllowed = function (componentFootprint) {
            return (
              this.component.dateProfile.validUnzonedRange.containsRange(componentFootprint.unzonedRange) &&
    ...
    ------------------------------------------------------------------------------------------------------------------*/
          ...
          AgendaView.prototype.renderSkeletonHtml = function () {
            ...
            return (
              ...
              '">' +
              (this.dayGrid
                ? '<div class="fc-day-grid"/>' + '<hr class="fc-divider ' + theme.getClass("widgetHeader") + '"/>'
                : "") +
              "</td>" +
              "</tr>" +
              "</tbody>" +
        ...
        agendaTimeGridMethods = {
          ...
          renderHeadIntroHtml: function () {
            ...
            if (this.opt("weekNumbers")) {
              ...
              return (
                '<th class="fc-axis ' + calendar.theme.getClass("widgetHeader") + '" ' + view.axisStyleAttr() + "></th>"
              );
            }
          },
...
----------------------------------------------------------------------------------------------------------------------*/
    ...
    ------------------------------------------------------------------------------------------------------------------*/
          ...
          TimeGrid.prototype.renderContentSkeleton = function () {
            ...
            skeletonEl = this.contentSkeletonEl = $(
              '<div class="fc-content-skeleton">' + "<table>" + "<tr>" + cellHtml + "</tr>" + "</table>" + "</div>"
            );
    ...
    ------------------------------------------------------------------------------------------------------------------*/
          ...
          TimeGrid.prototype.computeTimeTop = function (time) {
            ...
            return (
              this.slatCoordCache.getTopPosition(slatIndex) + this.slatCoordCache.getHeight(slatIndex) * slatRemainder
            );
          };
        ...
        var TimeGridEventRenderer = /** @class */ (function (_super) {
          ...
          TimeGridEventRenderer.prototype.fgSegHtml = function (seg, disableResizing) {
            ...
            return (
              ...
              classes.join(" ") +
              '"' +
              (eventDef.url ? ' href="' + util_1.htmlEscape(eventDef.url) + '"' : "") +
              ...
              (timeText
                ? '<div class="fc-time"' +
                  ...
                  "</div>"
                : "") +
              (eventDef.title ? '<div class="fc-title">' + util_1.htmlEscape(eventDef.title) + "</div>" : "") +
              "</div>" +
              '<div class="fc-bg"/>' +
        ...
        var DayGridEventRenderer = /** @class */ (function (_super) {
          ...
          DayGridEventRenderer.prototype.fgSegHtml = function (seg, disableResizing) {
            ...
            var isResizableFromStart =
              !disableResizing && isAllDay && seg.isStart && view.isEventDefResizableFromStart(eventDef);
...
*/
        var ListView = /** @class */ (function (_super) {
          ...
          ListView.prototype.renderSegList = function (allSegs) {
            ...
            var i;
            var tableEl = $(
              '<table class="fc-list-table ' + this.calendar.theme.getClass("tableList") + '"><tbody/></table>'
            );
          ...
          ListEventRenderer.prototype.fgSegHtml = function (seg) {
            ...
            return (
              ...
              (this.displayEventTime
                ? '<td class="fc-list-item-time ' + theme.getClass("widgetContent") + '">' + (timeHtml || "") + "</td>"
                : "") +
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        var ViewSpecManager = /** @class */ (function () {
          ...
          ViewSpecManager.prototype.buildViewSpec = function (requestedViewType) {
            ...
            durationInput =
              durationInput || this.optionsManager.dynamicOverrides.duration || this.optionsManager.overrides.duration;
            if (durationInput) {
