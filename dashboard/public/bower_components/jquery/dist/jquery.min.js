...
!((e, t) => {
  ...
  (w.fn = w.prototype =
    ...
    w.extend({
      ...
      inArray: (e, t, n) => (null == t ? -1 : u.call(t, e, n)),
      merge: (e, t) => {
  ...
  var E = ((e) => {
    ...
    (n = oe.support = {}),
      ...
      (oe.contains = (e, t) => ((e.ownerDocument || e) !== d && p(e), x(e, t))),
      (oe.attr = (e, t) => {
        (e.ownerDocument || e) !== d && p(e);
    ...
    return (
      ...
      ue((e) => null == e.getAttribute("disabled")) ||
        le(P, (e, t, n) => {
          var r;
          if (!n)
            return !0 === e[t]
  ...
  w.each(
    {
      ...
      parents: (e) => k(e, "parentNode"),
      parentsUntil: (e, t, n) => k(e, "parentNode", n),
      next: (e) => P(e, "nextSibling"),
      prev: (e) => P(e, "previousSibling"),
      nextAll: (e) => k(e, "nextSibling"),
      prevAll: (e) => k(e, "previousSibling"),
      nextUntil: (e, t, n) => k(e, "nextSibling", n),
      prevUntil: (e, t, n) => k(e, "previousSibling", n),
  ...
  w.extend({
    hasData: (e) => K.hasData(e) || J.hasData(e),
    data: (e, t, n) => K.access(e, t, n),
    removeData: (e, t) => {
      K.remove(e, t);
    },
    _data: (e, t, n) => J.access(e, t, n),
    _removeData: (e, t) => {
      J.remove(e, t);
    },
  }),
    ...
    w.fn.extend({
      ...
      promise: function (e, t) {
        ...
        while (a--) (n = J.get(this[a], e + "queueHooks")) && n.empty && (r++, n.empty.add(s));
  ...
  w.extend({
    htmlPrefilter: (e) => e.replace(Ne, "<$1></$2>"),
    clone: (e, t, n) => {
      var r,
        i,
        o,
  ...
  w.extend({
    ...
    ajaxSetup: (e, t) => (t ? zt(zt(e, w.ajaxSettings), t) : zt(w.ajaxSettings, e)),
    ajaxPrefilter: Ft(It),
    ajaxTransport: Ft(Wt),
    ajax: (t, n) => {
      ...
      var i,
        ...
        E = {
          ...
          getAllResponseHeaders: () => (c ? a : null),
    ...
    getJSON: (e, t, n) => w.get(e, t, n, "json"),
    getScript: (e, t) => w.get(e, void 0, t, "script"),
  }),
    w.each(["get", "post"], (e, t) => {
      w[t] = (e, n, r, i) => (
  ...
  (h.cors = !!Gt && "withCredentials" in Gt),
    ...
    w.ajaxSetup({
      ...
      converters: {
        "text script": (e) => (w.globalEval(e), e),
      },
    }),
  ...
  w.ajaxSetup({
    ...
    w.ajaxPrefilter("json jsonp", (t, n, r) => {
      ...
      if (s || "jsonp" === t.dataTypes[0])
        return (
          ...
          (t.converters["script json"] = () => (a || w.error(i + " was not called"), a[0])),
          (t.dataTypes[0] = "json"),
          (o = e[i]),
          (e[i] = () => {
            a = arguments;
      ...
      return (
        ...
        this.length > 0 &&
          w
            ...
            .done((e) => {
              (o = arguments), this.html(r ? w("<div>").append(w.parseHTML(e)).find(r) : e);
            })
            .always(
              n &&
                ((e, t) => {
    ...
    (w.expr.pseudos.animated = (e) => w.grep(w.timers, (t) => e === t.elem).length),
    (w.offset = {
      setOffset: (e, t, n) => {
        var r,
          i,
  ...
  var Jt = e.jQuery,
    Kt = e.$;
  return (
    (w.noConflict = (t) => (e.$ === w && (e.$ = Kt), t && e.jQuery === w && (e.jQuery = Jt), w)),
    t || (e.jQuery = e.$ = w),
    w
  );
});
