...
!((e, t) => {
  ...
  (w.fn = w.prototype =
    ...
    w.extend({
      ...
      trim: (e) => (null == e ? "" : (e + "").replace(C, "")),
      makeArray: (e, t) => {
        var n = t || [];
        return (
          null != e && (T(Object(e)) ? w.merge(n, "string" == typeof e ? [e] : e) : u.call(n, e)), n
        );
      },
      inArray: (e, t, n) => (null == t ? -1 : s.call(t, e, n)),
      merge: (e, t) => {
  ...
  function T(e) {
    var t = !!e && "length" in e && e.length,
      n = b(e);
    return (
      !g(e) && !v(e) && ("array" === n || 0 === t || ("number" == typeof t && t > 0 && t - 1 in e))
    );
  }
  var E = ((e) => {
    var t,
    ...
    function fe(e) {
      return (t) => "input" === t.nodeName.toLowerCase() && t.type === e;
    }
    function de(e) {
      return (t) => {
    ...
    (n = oe.support = {}),
        ...
        (e) => {
          ...
          return a !== p && 9 === a.nodeType && a.documentElement
            ? ((p = a),
              ...
              (n.attributes = se((e) => ((e.className = "i"), !e.getAttribute("className")))),
              (n.getElementsByTagName = se(
                (e) => (e.appendChild(p.createComment("")), !e.getElementsByTagName("*").length)
              )),
              (n.getElementsByClassName = G.test(p.getElementsByClassName)),
              (n.getById = se(
                (e) => (
                  (h.appendChild(e).id = x), !p.getElementsByName || !p.getElementsByName(x).length
                )
              )),
              n.getById
                ? ((r.filter.ID = (e) => {
      ...
      (oe.matches = (e, t) => oe(e, null, null, t)),
      (oe.matchesSelector = (e, t) => {
        if (
      ...
      (oe.contains = (e, t) => ((e.ownerDocument || e) !== p && d(e), b(e, t))),
      (oe.attr = (e, t) => {
        (e.ownerDocument || e) !== p && d(e);
                      ...
                      if (((h = [a ? v.firstChild : v.lastChild]), a && m)) {
                        ...
                        while ((d = (++p && d && d[g]) || (b = p = 0) || h.pop()))
                          if (
                            ...
                            ++b &&
                            (m &&
                              ((c = (f = d[x] || (d[x] = {}))[d.uniqueID] || (f[d.uniqueID] = {}))[
                                e
                              ] = [C, b]),
                            d === t)
                          )
          ...
          pseudos: {
            not: ue((e) => {
              ...
              return r[x]
                ...
                : (e, i, o) => ((t[0] = e), r(t, null, o, n), (t[0] = null), !n.pop());
            }),
            has: ue((e) => (t) => oe(e, t).length > 0),
            contains: ue(
              (e) => (
                (e = e.replace(Z, ee)),
                (t) => (t.textContent || t.innerText || i(t)).indexOf(e) > -1
              )
            ),
            lang: ue(
              (e) => (
            ...
            parent: (e) => !r.pseudos.empty(e),
            header: (e) => Y.test(e.nodeName),
    ...
    return (
      ...
      d(),
      (n.sortDetached = se((e) => 1 & e.compareDocumentPosition(p.createElement("fieldset")))),
      se((e) => ((e.innerHTML = "<a href='#'></a>"), "#" === e.firstChild.getAttribute("href"))) ||
      ...
      se((e) => null == e.getAttribute("disabled")) ||
        le(H, (e, t, n) => {
          var r;
          if (!n)
            return !0 === e[t]
  ...
  ((w.fn.init = function (e, t, n) {
    ...
    if (((n = n || j), "string" == typeof e)) {
      if (
        !(i =
          "<" === e[0] && ">" === e[e.length - 1] && e.length >= 3 ? [null, e, null] : q.exec(e)) ||
        (!i[1] && t)
      )
  ...
  w.each(
    {
      ...
      parents: (e) => N(e, "parentNode"),
      parentsUntil: (e, t, n) => N(e, "parentNode", n),
      next: (e) => H(e, "nextSibling"),
      prev: (e) => H(e, "previousSibling"),
      nextAll: (e) => N(e, "nextSibling"),
      prevAll: (e) => N(e, "previousSibling"),
      nextUntil: (e, t, n) => N(e, "nextSibling", n),
      prevUntil: (e, t, n) => N(e, "previousSibling", n),
      siblings: (e) => k((e.parentNode || {}).firstChild, e),
      children: (e) => k(e.firstChild),
      contents: (e) =>
        D(e, "iframe")
          ? e.contentDocument
  ...
  w.Callbacks = (e) => {
    ...
    var t,
      ...
      l = {
        ...
        has: (e) => (e ? w.inArray(e, o) > -1 : o.length > 0),
        empty: function () {
          return o && (o = []), this;
        },
        disable: function () {
  ...
  w.extend({
    Deferred: (t) => {
      var n = [
        ...
        i = {
                      ...
                      (l = e && ("object" == typeof e || "function" == typeof e) && e.then),
                        g(l)
                          ? i
                            ...
                            : (o++,
                              l.call(e, a(o, n, B, i), a(o, n, M, i), a(o, n, B, n.notifyWith)))
          ...
          promise: (e) => (null != e ? w.extend(e, i) : i),
        },
        o = {};
      return (
        w.each(n, (e, t) => {
    ...
    when: (e) => {
      ...
      if (
        t <= 1 &&
        (W(e, a.done(u(n)).resolve, a.reject, !t), "pending" === a.state() || g(i[n] && i[n].then))
      )
        return a.then();
  ...
  var _ = (e, t, n, r, i, o, a) => {
      ...
      if ("object" === b(n)) {
        ...
        ((i = !0),
        g(r) || (a = !0),
        l && (a ? (t.call(e, r), (t = null)) : ((l = t), (t = (e, t, n) => l.call(w(e), n)))),
        t)
      )
  ...
  var Y = (e) => 1 === e.nodeType || 9 === e.nodeType || !+e.nodeType;
  function G() {
  ...
  w.extend({
    hasData: (e) => J.hasData(e) || K.hasData(e),
    data: (e, t, n) => J.access(e, t, n),
    removeData: (e, t) => {
      J.remove(e, t);
    },
    _data: (e, t, n) => K.access(e, t, n),
    _removeData: (e, t) => {
      K.remove(e, t);
    },
  }),
    ...
    w.fn.extend({
      ...
      promise: function (e, t) {
        ...
        while (a--) (n = K.get(this[a], e + "queueHooks")) && n.empty && (r++, n.empty.add(u));
  ...
  function se(e, t, n, r) {
    ...
    if (c && c[3] !== l) {
      (s /= 2), (l = l || c[3]), (c = +s || 1);
      while (a--)
        w.style(e, t, c + l), (1 - o) * (1 - (o = u() / s || 0.5)) <= 0 && (a = 0), (c /= o);
  ...
  function be(e, t, n, r, i) {
    ...
    while ((o = d[p++]))
      if (r && w.inArray(o, r) > -1) i && i.push(o);
        ...
        ((l = w.contains(o.ownerDocument, o)), (a = ve(f.appendChild(o), "script")), l && ye(a), n)
      ) {
        c = 0;
  ...
  (w.event = {
      ...
      if (v) {
        n.handler && ((n = (o = n).handler), (i = o.selector)),
          ...
          (a = v.handle) ||
            (a = v.handle =
              (t) =>
                "undefined" != typeof w && w.event.triggered !== t.type
    ...
    remove: (e, t, n, r, i) => {
      ...
      if (v && (s = v.events)) {
        ...
        while (l--)
          if (
            ((u = Te.exec(t[l]) || []), (p = g = u[1]), (h = (u[2] || "").split(".").sort()), p)
          ) {
            (f = w.event.special[p] || {}),
    ...
    fix: (e) => (e[w.expando] ? e : new w.Event(e)),
    special: {
      load: { noBubble: !0 },
      focus: {
        trigger: function () {
  ...
  function Re(e, t, n, r) {
    ...
    if (
      ...
      for (s = (u = w.map(ve(i, "script"), Oe)).length; f < d; f++)
        (l = i),
          f !== p && ((l = w.clone(l, !0, !0)), s && w.merge(u, ve(l, "script"))),
          n.call(e[f], l, f);
      if (s)
  ...
  w.extend({
    htmlPrefilter: (e) => e.replace(De, "<$1></$2>"),
    clone: (e, t, n) => {
      var r,
        i,
        o,
  ...
  !(() => {
    ...
    c.style &&
      ...
      w.extend(h, {
        boxSizingReliable: () => (t(), o),
        pixelBoxStyles: () => (t(), u),
        pixelPosition: () => (t(), i),
        reliableMarginLeft: () => (t(), s),
        scrollboxSize: () => (t(), a),
      }));
  })();
  function Fe(e, t, n) {
  ...
  function Ze(e, t, n, r, i, o) {
    ...
    return (
      !r &&
        ...
        (s += Math.max(
          0,
          Math.ceil(e["offset" + t[0].toUpperCase() + t.slice(1)] - o - s - u - 0.5)
        )),
      s
    );
  }
  function et(e, t, n) {
    ...
    return (
      ...
      ("auto" === i || (!Number.parseFloat(i) && "inline" === w.css(e, "display", !1, r))) &&
        ((i = e["offset" + t[0].toUpperCase() + t.slice(1)]), (a = !0)),
      (i = Number.parseFloat(i) || 0) + Ze(e, t, n || (o ? "border" : "content"), a, r, i) + "px"
    );
  }
  w.extend({
    cssHooks: {
    ...
    (w.cssHooks.marginLeft = ze(h.reliableMarginLeft, (e, t) => {
      if (t)
        return (
          (Number.parseFloat(Fe(e, "marginLeft")) ||
  ...
  w.fn.extend({
    ...
    (tt = {
      set: (e, t, n) => (!1 === t ? w.removeAttr(e, n) : e.setAttribute(n, n), n),
    }),
        ...
        : g(e)
          ...
          : this.each(function () {
              ...
              if (r) {
                ...
                (void 0 !== e && "boolean" !== n) ||
                  ((t = at(this)) && K.set(this, "__className__", t),
                  this.setAttribute &&
                    this.setAttribute(
                      "class",
  ...
  w.fn.extend({
          ...
          this.each(function (n) {
            ...
            1 === this.nodeType &&
              (null == (i = r ? e.call(this, n, w(this).val()) : e)
                ...
                : "number" == typeof i
                  ? (i += "")
                  : Array.isArray(i) && (i = w.map(i, (e) => (null == e ? "" : e + ""))),
    ...
    w.each(["radio", "checkbox"], function () {
      (w.valHooks[this] = {
        ...
        h.checkOn ||
          (w.valHooks[this].get = (e) => (null === e.getAttribute("value") ? "on" : e.value));
    }),
  ...
  function gt(e, t, n, r) {
    ...
    if (Array.isArray(t))
      w.each(t, (t, i) => {
        n || ft.test(e)
          ? r(e, i)
          : gt(e + "[" + ("object" == typeof i && null != i ? t : "") + "]", i, n, r);
      });
  ...
  (w.param = (e, t) => {
    ...
    (w.expr.pseudos.hidden = (e) => !w.expr.pseudos.visible(e)),
    (w.expr.pseudos.visible = (e) =>
      ...
      setOffset: (e, t, n) => {
        ...
        "static" === c && (e.style.position = "relative"),
          ...
          (l = ("absolute" === c || "fixed" === c) && (o + s).indexOf("auto") > -1)
            ...
            : ((a = Number.parseFloat(o) || 0), (i = Number.parseFloat(s) || 0)),
    ...
    "function" == typeof define && define.amd && define("jquery", [], () => w);
  var vt = e.jQuery,
    yt = e.$;
  return (
    (w.noConflict = (t) => (e.$ === w && (e.$ = yt), t && e.jQuery === w && (e.jQuery = vt), w)),
    t || (e.jQuery = e.$ = w),
    w
  );
});
