...
!(function (e) {
  ...
  function n(e, r) {
    var n = (e.mask || e)
      ...
      a = (e.mask || e).split("#")[0],
      o = (r.mask || r).split("#")[0];
    return 0 === o.indexOf(a) ? -1 : 0 === a.indexOf(o) ? 1 : n.localeCompare(t);
  }
  ...
  return (
    (r.prototype.analyseMask = function (r, n, a) {
      function o(e, n, t) {
        ...
        for (var a = "", p = t[n] || t, i = e.length - 1; i >= 0; i--)
          (p[(a = (r = e[i].mask || e[i]).substr(0, 1))] = p[a] || []), p[a].unshift(r.substr(1)), e.splice(i, 1);
      ...
      return (
        a.phoneCodes &&
          (a.phoneCodes &&
            ...
            (o((r = r.substr(1, r.length - 2)).split(a.groupmarker.end + a.alternatormarker + a.groupmarker.start)),
            (r = p(s))),
          (r = r.replace(/9/g, "\\9"))),
        t.call(this, r, n, a)
      );
    ...
    r.extendAliases({
      abstractphone: {
        ...
        phoneCodes: [],
        mask: function (e) {
          return (e.definitions = { "#": r.prototype.definitions[9] }), e.phoneCodes.sort(n);
        },
        keepStatic: !0,
        onBeforeMask: function (e, r) {
          var n = e.replace(/^0{1,2}/, "").replace(/[\s]/g, "");
          return (n.indexOf(r.countrycode) > 1 || -1 === n.indexOf(r.countrycode)) && (n = "+" + r.countrycode + n), n;
        },
