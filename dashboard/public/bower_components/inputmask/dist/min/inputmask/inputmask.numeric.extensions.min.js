      ...
      numeric: {
        mask: (e) => {
          if (
            ...
            (e.integerDigits = Number.parseInt(e.integerDigits) + (0 === a ? i - 1 : i)),
        ...
        postValidation: (r, a, n) => {
          ...
          if (
            ...
            (c = c.replace(
              new RegExp("[-" + i.escapeRegex(n.negationSymbol.front) + "]", "g"),
              ""
            )),
            (c = c.replace(new RegExp(i.escapeRegex(n.negationSymbol.back) + "$"), "")),
            isNaN(n.placeholder) &&
              (c = c.replace(new RegExp(i.escapeRegex(n.placeholder), "g"), "")),
            c.length > 1 &&
            ...
            if (
              ...
              (c = i(
                ((e, i) => {
                  var t = "";
                  if (
                    ((t += "(" + i.groupSeparator + "*{" + i.groupSize + "}){*}"),
                    "" !== i.radixPoint)
                  ) {
        ...
        definitions: {
                ...
                if (
                  ...
                  var s = r.buffer.join(""),
                    g = (s = (s = s.replace(
                      ...
                      ""
                    )).replace(new RegExp(i.escapeRegex(o.negationSymbol.back) + "$"), "")).split(
                      o.radixPoint
                    );
                  ...
                  for (s === o.radixPoint && (s = c); null === s.match(i.escapeRegex(c) + "$"); )
                    c = c.slice(1);
                  l =
          ...
          "-": {
            validator: (e, i, t, r, a) => a.allowMinus && e === a.negationSymbol.back,
            cardinality: 1,
            placeholder: "",
          },
          ":": {
        ...
        onBeforeMask: (e, r) => {
          if (
            ...
            var a = e.split("."),
              n = "" !== r.groupSeparator ? Number.parseInt(r.groupSize) : 0;
            2 === a.length &&
          ...
          if (
            ...
            var l = e.split(r.radixPoint)[1].match(/\d*/)[0];
            if (Number.parseInt(r.digits) < l.toString().length) {
              var s = Math.pow(10, Number.parseInt(r.digits));
              (e = e.replace(i.escapeRegex(r.radixPoint), ".")),
                (e = (e = Math.round(Number.parseFloat(e) * s) / s)
                  .toString()
        ...
        canClearPosition: (e, i, t, r, a) => {
          ...
          return (
            !o || ("+" !== n.match.nativeDef && "-" !== n.match.nativeDef) || (a.isNegative = !1), o
          );
        },
        onKeyDown: function (t, r, a, n) {
          ...
          if (t.ctrlKey)
            switch (t.keyCode) {
              case i.keyCode.UP:
                o.val(Number.parseFloat(this.inputmask.unmaskedvalue()) + Number.parseInt(n.step)),
                  o.trigger("setvalue");
                break;
              case i.keyCode.DOWN:
                o.val(Number.parseFloat(this.inputmask.unmaskedvalue()) - Number.parseInt(n.step)),
