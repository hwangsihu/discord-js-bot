...
!(function (e) {
  "function" == typeof define && define.amd
    ...
    : "object" == typeof exports
      ? (module.exports = e(require("./dependencyLibs/inputmask.dependencyLib"), require("./inputmask")))
      ...
      numeric: {
        mask: function (e) {
          if (
            ...
            (e.integerDigits = parseInt(e.integerDigits) + (0 === a ? i - 1 : i)),
          ...
          if (
            ((n += r(e.prefix, e)),
            !0 === e.integerOptional ? (n += "~{1," + e.integerDigits + "}") : (n += "~{" + e.integerDigits + "}"),
            e.digits !== t)
          ) {
            ...
            isFinite(o[0] && o[1] && isFinite(o[1]))
              ...
              : (isNaN(e.digits) || parseInt(e.digits) > 0) &&
                (e.digitsOptional
                  ? (n += "[" + e.radixPointDefinitionSymbol + ";{1," + e.digits + "}]")
                  : (n += e.radixPointDefinitionSymbol + ";{" + e.digits + "}"));
          }
        ...
        preValidation: function (i, r, a, n, o) {
          if ("-" === a || a === o.negationSymbol.front)
            return (
              !0 === o.allowMinus &&
              ((o.isNegative = o.isNegative === t || !o.isNegative), "" === i.join("") || { caret: r, dopost: !0 })
            );
          if (!1 === n && a === o.radixPoint && o.digits !== t && (isNaN(o.digits) || parseInt(o.digits) > 0)) {
            var p = e.inArray(o.radixPoint, i);
            if (-1 !== p) return !0 === o.numericInput ? r === p : { caret: p + 1 };
          }
          return !0;
        },
        postValidation: function (r, a, n) {
          ...
          var g = s[l];
          if ((g === n.groupSeparator && (g = s[(l += 1)]), l === s.length - n.suffix.length - 1 && g === n.radixPoint))
            return a;
          g !== t &&
            g !== n.radixPoint &&
            ...
            l < n.prefix.length - 1 + (!1 === n.isNegative ? 1 : 0)
              ...
              : n.suffix.length > 0 &&
                l >= s.length - n.suffix.length - (!1 === n.isNegative ? 1 : 0) &&
                (o[l - (s.length - n.suffix.length - (!1 === n.isNegative ? 1 : 0))] = "?")),
            (p = p.join("")),
            (o = o.join(""));
          var c = s.join("").replace(p, "");
          if (
            ((c = c.replace(o, "")),
            (c = c.replace(new RegExp(i.escapeRegex(n.groupSeparator), "g"), "")),
            (c = c.replace(new RegExp("[-" + i.escapeRegex(n.negationSymbol.front) + "]", "g"), "")),
            (c = c.replace(new RegExp(i.escapeRegex(n.negationSymbol.back) + "$"), "")),
            isNaN(n.placeholder) && (c = c.replace(new RegExp(i.escapeRegex(n.placeholder), "g"), "")),
            c.length > 1 &&
              1 !== c.indexOf(n.radixPoint) &&
              ("0" === g && (c = c.replace(/^\?/g, "")), (c = c.replace(/^0/g, ""))),
            c.charAt(0) === n.radixPoint && "" !== n.radixPoint && !0 !== n.numericInput && (c = "0" + c),
            "" !== c)
          ) {
            if (
              ((c = c.split("")),
              (!n.digitsOptional || (n.enforceDigitsOnBlur && "blur" === a.event)) && isFinite(n.digits))
            ) {
              var d = e.inArray(n.radixPoint, c),
                u = e.inArray(n.radixPoint, s);
              -1 === d && (c.push(n.radixPoint), (d = c.length - 1));
              for (var x = 1; x <= n.digits; x++)
                (n.digitsOptional && (!n.enforceDigitsOnBlur || "blur" !== a.event)) ||
                (c[d + x] !== t && c[d + x] !== n.placeholder.charAt(0))
                  ? -1 !== u && s[u + x] !== t && (c[d + x] = c[d + x] || s[u + x])
                  : (c[d + x] = a.placeholder || n.placeholder.charAt(0));
            }
            if (!0 !== n.autoGroup || "" === n.groupSeparator || (g === n.radixPoint && a.pos === t && !a.dopost))
              c = c.join("");
            else {
              ...
              (c = i(
                (function (e, i) {
                  var t = "";
                  if (((t += "(" + i.groupSeparator + "*{" + i.groupSize + "}){*}"), "" !== i.radixPoint)) {
                    var r = e.join("").split(i.radixPoint);
                    r[1] && (t += i.radixPoint + "*{" + r[1].match(/^\d*\??\d*/)[0].length + "}");
                  }
                  return t;
                })(c, n),
          ...
          if (
            ...
            (c = p + c),
            (c += o),
            n.isNegative && ((c = n.negationSymbol.front + c), (c += n.negationSymbol.back)),
            (c = c.split("")),
            g !== t)
          )
            if (g !== n.radixPoint && g !== n.negationSymbol.front && g !== n.negationSymbol.back)
            ...
            switch (r.type) {
              ...
              case "checkval":
                ...
                if (
                  ...
                  if (
                    ((p = o.onUnMask(a.join(""), t, e.extend({}, o, { unmaskAsNumber: !0 }))),
                    null !== o.min && p < o.min)
                  )
                    return (
                ...
                return o.postValidation(a, { caret: n, placeholder: "0", event: "blur" }, o);
              case "_checkval":
                return { caret: n };
            }
        },
        regex: {
          integerPart: function (e, t) {
            return t
              ...
              : new RegExp("[" + i.escapeRegex(e.negationSymbol.front) + "+]?\\d+");
          },
          integerNPart: function (e) {
            return new RegExp("[\\d" + i.escapeRegex(e.groupSeparator) + i.escapeRegex(e.placeholder.charAt(0)) + "]+");
          },
        },
        definitions: {
          "~": {
            validator: function (e, r, a, n, o, p) {
              var l = n
                ? new RegExp("[0-9" + i.escapeRegex(o.groupSeparator) + "]").test(e)
                : new RegExp("[0-9]").test(e);
              if (!0 === l) {
                if (!0 !== o.numericInput && r.validPositions[a] !== t && "~" === r.validPositions[a].match.def && !p) {
                  var s = r.buffer.join(""),
                    g = (s = (s = s.replace(
                      new RegExp("[-" + i.escapeRegex(o.negationSymbol.front) + "]", "g"),
                      ""
                    )).replace(new RegExp(i.escapeRegex(o.negationSymbol.back) + "$"), "")).split(o.radixPoint);
                  g.length > 1 && (g[1] = g[1].replace(/0/g, o.placeholder.charAt(0))),
                    "0" === g[0] && (g[0] = g[0].replace(/0/g, o.placeholder.charAt(0))),
                    (s = g[0] + o.radixPoint + g[1] || "");
                  var c = r._buffer.join("");
                  for (s === o.radixPoint && (s = c); null === s.match(i.escapeRegex(c) + "$"); ) c = c.slice(1);
                  l = (s = (s = s.replace(c, "")).split(""))[a] === t ? { pos: a, remove: a } : { pos: a };
                }
              } else
                n || e !== o.radixPoint || r.validPositions[a - 1] !== t || ((r.buffer[a] = "0"), (l = { pos: a + 1 }));
              return l;
            },
            cardinality: 1,
          },
        ...
        onUnMask: function (e, t, r) {
          ...
          return (
            ...
            (a = a.replace(new RegExp(i.escapeRegex(r.groupSeparator), "g"), "")),
            "" !== r.placeholder.charAt(0) && (a = a.replace(new RegExp(r.placeholder.charAt(0), "g"), "0")),
            r.unmaskAsNumber
              ? ("" !== r.radixPoint &&
                  -1 !== a.indexOf(r.radixPoint) &&
                  (a = a.replace(i.escapeRegex.call(this, r.radixPoint), ".")),
                (a = a.replace(new RegExp("^" + i.escapeRegex(r.negationSymbol.front)), "-")),
                (a = a.replace(new RegExp(i.escapeRegex(r.negationSymbol.back) + "$"), "")),
                Number(a))
              : a
          );
        },
        isComplete: function (e, t) {
          ...
          return (
            ...
            (a = a.replace(new RegExp(i.escapeRegex(t.groupSeparator), "g"), "")),
            "," === t.radixPoint && (a = a.replace(i.escapeRegex(t.radixPoint), ".")),
            isFinite(a)
          );
        },
        onBeforeMask: function (e, r) {
          if (
            ((r.isNegative = t),
            (e =
              e.toString().charAt(e.length - 1) === r.radixPoint ? e.toString().substr(0, e.length - 1) : e.toString()),
            "" !== r.radixPoint && isFinite(e))
          ) {
            var a = e.split("."),
              n = "" !== r.groupSeparator ? parseInt(r.groupSize) : 0;
            2 === a.length &&
              (a[0].length > n || a[1].length > n || (a[0].length <= n && a[1].length < n)) &&
          ...
          if (
                ...
                ? p.length > o.length
                  ...
                  : o.length > p.length
                    ...
                    : e.indexOf(".") < e.indexOf(",")
                      ? e.replace(/\./g, "")
                      : e.replace(/,/g, "")
                : e.replace(new RegExp(i.escapeRegex(r.groupSeparator), "g"), "")),
            0 === r.digits &&
              (-1 !== e.indexOf(".")
                ? (e = e.substring(0, e.indexOf(".")))
                : -1 !== e.indexOf(",") && (e = e.substring(0, e.indexOf(",")))),
            "" !== r.radixPoint && isFinite(r.digits) && -1 !== e.indexOf(r.radixPoint))
          ) {
            ...
            if (parseInt(r.digits) < l.toString().length) {
              ...
              (e = e.replace(i.escapeRegex(r.radixPoint), ".")),
                (e = (e = Math.round(parseFloat(e) * s) / s).toString().replace(".", r.radixPoint));
            }
          }
          return e;
        },
        canClearPosition: function (e, i, t, r, a) {
          var n = e.validPositions[i],
            o =
              ...
              (null !== e.validPositions[i].match.fn && !1 === a.decimalProtect) ||
              (n.input === a.radixPoint && e.validPositions[i + 1] && null === e.validPositions[i + 1].match.fn) ||
              isFinite(n.input) ||
              i === t ||
              n.input === a.groupSeparator ||
              n.input === a.negationSymbol.front ||
              n.input === a.negationSymbol.back;
          return !o || ("+" !== n.match.nativeDef && "-" !== n.match.nativeDef) || (a.isNegative = !1), o;
        },
