  ...
  (e, r) => (
    r.extendAliases({
      Regex: {
        ...
        isComplete: (e, r) => new RegExp(r.regex, r.casing ? "i" : "").test(e.join("")),
        definitions: {
          r: {
            validator: (r, t, a, i, n) => {
              function s(e, r) {
                ...
                (() => {
                  ...
                  for (n.regexTokens = []; (e = n.tokenizer.exec(n.regex)); )
                    switch ((r = e[0]).charAt(0)) {
                      ...
                      case ")":
                        (h = a.pop()),
                          a.length > 0 ? a[a.length - 1].matches.push(h) : t.matches.push(h);
                        break;
                      case "{":
                      case "+":
                      case "*":
                        var i = new s(!1, !0),
                          ...
                          p = isNaN(u[0]) ? u[0] : Number.parseInt(u[0]),
                          c = 1 === u.length ? p : isNaN(u[1]) ? u[1] : Number.parseInt(u[1]);
                        if (((i.quantifier = { min: p, max: c }), a.length > 0)) {
                          var f = a[a.length - 1].matches;
                          (e = f.pop()).isGroup || ((h = new s(!0)).matches.push(e), (e = h)),
                            f.push(e),
                            f.push(i);
                        } else
