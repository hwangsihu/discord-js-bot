...
!((e) => {
  ...
  function o(t, n) {
      ...
      return (
        a.prototype.masksCache[u] === i || !0 === n
          ? ((c = {
            ...
            !0 !== n &&
              ((a.prototype.masksCache[u] = c), (c = e.extend(!0, {}, a.prototype.masksCache[u]))))
    ...
    if ((e.isFunction(t.mask) && (t.mask = t.mask(t)), e.isArray(t.mask))) {
      if (t.mask.length > 1) {
        ...
        return (
          e.each(t.numericInput ? t.mask.reverse() : t.mask, (n, a) => {
  ...
  function s(r, o, l) {
      ...
      do {
        !0 === e && m().validPositions[c]
          ...
          : ((r = (o = y(c, a, c - 1)).match),
            ...
            (!1 === l.jitMasking ||
              c < u ||
              ("number" == typeof l.jitMasking && isFinite(l.jitMasking) && l.jitMasking > c)) &&
        ...
        if ((o < s && (o = s + 1), m().validPositions[o] === i && O(o))) o++;
          ...
          !1 === u && c[s] && c[s].match.def === f.match.def
            ? ((m().validPositions[s] = e.extend(!0, {}, c[s])),
              ...
              o++)
            : P(s, f.match.def)
              ? !1 !== M(s, f.input || G(o), !0) && (delete m().validPositions[o], o++, (u = !0))
              : O(o) || (o++, s--),
            s++;
        }
      }
    ...
    function k(e, t) {
      for (
        var n,
          ...
          s = o.alternation !== i ? o.locator[o.alternation].toString().split(",") : [],
          c = 0;
        c < a.length &&
        (!(
          (n = a[c]).match &&
        ...
        function f(o, c, v) {
          ...
          function k(t, n, a) {
            ...
            if (m().validPositions[t - 1] && a && m().tests[t])
              for (
                var s = m().validPositions[t - 1].locator, l = m().tests[t][0].locator, c = 0;
                c < a;
                c++
              )
            ...
            return (
              (m().tests[t] || m().validPositions[t]) &&
                e.each(m().tests[t] || [m().validPositions[t]], (e, t) => {
            ...
            if (o.isGroup && v !== o) {
              ...
              if (-1 === _ || "string" == typeof _) {
                ...
                for (var S = 0; S < O.length; S++) {
                  if (
                    ((x = Number.parseInt(O[S])),
                    (p = []),
                    (a = k(u, x, A) || M.slice()),
                    !0 !== (o = f(P.matches[x] || n.matches[x], [x].concat(c), v) || o) &&
                      o !== i &&
                      O[O.length - 1] < P.matches.length)
                  ) {
                    var D = e.inArray(o, n.matches) + 1;
                    n.matches.length > D &&
                      (o = f(n.matches[D], [D].concat(c.slice(1, c.length)), v)) &&
                      (O.push(D.toString()),
                      e.each(p, (e, t) => {
                      ...
                      if (
                        ...
                        if (
                          ((e, t) =>
                            ...
                            e.match.nativeDef === t.match.def)(T, B)
                        ) {
                          (G = !0),
                            T.alternation === B.alternation &&
                              ...
                              ((B.locator[B.alternation] =
                                B.locator[B.alternation] + "," + T.locator[T.alternation]),
                              (B.alternation = T.alternation)),
                            T.match.nativeDef === B.match.def &&
                              ((T.locator[T.alternation] = B.locator[B.alternation]),
                        ...
                        if (
                          ((e, n) =>
                            null === e.match.fn &&
                            null !== n.match.fn &&
                            n.match.fn.test(e.match.def, m(), t, !1, l, !1))(T, B) ||
                          ((e, n) =>
                            null !== e.match.fn &&
                            null !== n.match.fn &&
                            n.match.fn.test(e.match.def.replace(/[\[\]]/g, ""), m(), t, !1, l, !1))(
                            T,
                            B
                          )
                        ) {
                          T.alternation === B.alternation &&
                            -1 ===
                              T.locator[T.alternation]
                                .toString()
                                .indexOf(B.locator[B.alternation].toString().split("")[0]) &&
                            ((T.na = T.na || T.locator[T.alternation].toString()),
                            -1 === T.na.indexOf(T.locator[T.alternation].toString().split("")[0]) &&
                              (T.na =
                                T.na + "," + T.locator[B.alternation].toString().split("")[0]),
                            (G = !0),
                            (T.locator[T.alternation] =
                      ...
                      for (var o = 0; o < r.length; o++)
                        -1 !== e.inArray(r[o], O) &&
                          (t.locator[a] !== i
                            ...
                            : (t.locator[a] = Number.parseInt(r[o])),
                          (t.alternation = a));
              ...
              for (
                ...
                F < (isNaN(I.quantifier.max) ? F + 1 : I.quantifier.max) && u <= t;
                F++
              ) {
    ...
    function C() {
      return (
        m()._buffer === i &&
          ((m()._buffer = h(!1, 1)), m().buffer === i && (m().buffer = m()._buffer.slice())),
        m()._buffer
      );
    }
    function A(e) {
    ...
    function w(t, n, a) {
      for (
        var r, o = l.greedy ? n : n.slice(0, 1), s = !1, c = a !== i ? a.split(",") : [], u = 0;
        u < c.length;
        u++
      )
    ...
    function M(t, n, r, o, s, c) {
          ...
          e.each(E(n), (c, f) => {
            ...
            if (
              ...
              if (
                ...
                if ((_(!0 === w ? w : w.start, w.end, C), s.pos === i && s.c === i))
                  return (s.pos = v()), !1;
              ...
              return (
                (!0 === s || s.pos !== i || s.c !== i) &&
                (c > 0 && d(!0),
                p(E, e.extend({}, f, { input: x(P, h, E) }), o, u(t)) || (s = !1),
                !1)
              );
            }
          }),
          ...
          for (o = u = t; o <= c; o++) {
            ...
            if (y !== i)
              for (
                ...
                ((null === y.match.fn &&
                  p[o] &&
                  (!0 === p[o].match.optionalQuantifier || !0 === p[o].match.optionality)) ||
                  null != y.match.fn);
              ) {
      ...
      function h(t) {
        ...
        for (n++; n < t; n++)
          m().validPositions[n] === i &&
            ...
            ("" === (r = E(n, y(n - 1).locator, n - 1).slice())[r.length - 1].match.def && r.pop(),
            (a = k(r)) &&
              ...
              !1 !==
                (C = f(
                  n,
                  G(n, a.match, !0) ||
                    (null == a.match.fn ? a.match.def : "" !== G(n) ? G(n) : A()[n]),
                  !0
                )) &&
        ...
        !1 === C &&
          ...
          (C = ((t, n, a) => {
            ...
            if (s !== i) {
              ...
              e.each(E(g, A ? A.locator : i, g - 1), (r, c) => {
                ...
                for (var u = 0; u < h.length; u++) {
                  ...
                  if (
                    ...
                    for (
                      m().validPositions[g].locator[s] = Number.parseInt(h[u]),
                        null == c.match.fn
                          ? (C.input !== c.match.def &&
                              ((_ = !0), !0 !== C.generatedInput && b.push(C.input)),
                            A++,
                            (m().validPositions[g].generatedInput = !/[0-9a-bA-Z]/.test(
                              c.match.def
                            )),
                    ...
                    if (y) {
                      ...
                      var O = v(t) + 1;
                      for (f = g + 1; f < v() + 1; f++)
                        ((p = m().validPositions[f]) === i || null == p.match.fn) &&
                          f < t + (A - E) &&
                          A++;
      ...
      return (
        C && C.pos === i && (C.pos = b),
        (!1 !== C && !0 !== c) || (d(!0), (m().validPositions = e.extend(!0, {}, D))),
        C
      );
    }
    function O(e, t) {
    ...
    function S(e, t) {
      ...
      for (
        ...
        ++i < n &&
        ((!0 === t && (!0 !== b(i).match.newBlockMarker || !O(i))) || (!0 !== t && !O(i)));
      );
      return i;
    }
    function D(e, t) {
      ...
      while (
        ...
        ((!0 === t && !0 !== b(i).match.newBlockMarker) ||
          (!0 !== t &&
            !O(i) &&
            ((n = E(i)).length < 2 || (2 === n.length && "" === n[1].match.def))))
      );
      return i;
    }
    function j(e) {
              ...
              if (!1 !== g && !o && e.isFunction(l.onBeforeWrite)) {
                ...
                if (
                  ...
                  _(!0 === E ? E : E.start, E.end, g.buffer),
                    d(!0),
                    g.caret && ((m().p = g.caret), (g.forwardPosition = g.caret));
                }
              }
            }
        }),
    ...
    function I(e, a, r, o) {
      ...
      if (a === i)
        return (
          e.setSelectionRange
            ...
            : t.getSelection
              ? ((u = t.getSelection().getRangeAt(0)).commonAncestorContainer.parentNode !== e &&
      ...
      if ((a.begin !== i && ((r = a.end), (a = a.begin)), "number" == typeof a)) {
        ...
        if (
          ...
          u.setStart(
            e.firstChild,
            a < e.inputmask._valueGet().length ? a : e.inputmask._valueGet().length
          ),
            u.setEnd(
              e.firstChild,
    ...
    function F(t) {
      ...
      for (n = s + 1; n < r.length; n++)
        (u = (a = y(n, u, n - 1)).locator.slice()), (l[n] = e.extend(!0, {}, a));
          ...
          (f &&
            ((f !== l[n].locator[c.alternation] && null != a.match.fn) ||
              (null === a.match.fn &&
                ...
                w(a.locator[c.alternation].toString().split(","), f.toString().split(",")) &&
                "" !== E(n)[0].def)))) &&
        r[n] === G(n, a.match);
        n--
      )
    ...
    function N(e) {
      for (
        ...
        ((!0 !== t.match.optionalQuantifier && !0 !== t.match.newBlockMarker) ||
          (n + 1 === a &&
            "" === (r !== i ? y(n + 1, r.locator.slice(""), r) : b(n + 1)).match.def));
      )
        n++;
      while (
    ...
    function K(t, n, r, o, s) {
      ...
      if (u < r.begin) m().p = S(u);
        ...
        while (m().p < u && m().validPositions[m().p] === i) m().p++;
    }
    function U(i) {
      function a(e) {
        var t,
      ...
      (o.style.width = r.width),
        ...
        e(i).on("click", (e) => (I(i, a(e.clientX)), ne.clickEvent.call(i, [e]))),
        e(i).on("keydown", (e) => {
          e.shiftKey ||
            !1 === l.insertMode ||
            setTimeout(() => {
    ...
    function V(e, t, a) {
      function r() {
        p || (null !== s.fn && c.input !== i)
          ? p && ((null !== s.fn && c.input !== i) || "" === s.def) && ((p = !1), (f += "</span>"))
      ...
      ne = {
        keydownEvent: function (t) {
          ...
          if (
            ...
            t.preventDefault(),
              K(this, o, s),
              T(this, A(!0), m().p, t, this.inputmask._valueGet() !== A().join("")),
            ...
            l.insertMode || c !== m().maskLength || t.shiftKey || c--,
              I(this, t.shiftKey ? s.begin : c, c, !0);
          } else
            (o === a.keyCode.HOME && !t.shiftKey) || o === a.keyCode.PAGE_UP
              ? (t.preventDefault(), I(this, 0, t.shiftKey ? s.begin : 0, !0))
              : ((l.undoOnEscape && o === a.keyCode.ESCAPE) || (90 === o && t.ctrlKey)) &&
                  !0 !== t.altKey
                ? (L(this, !0, !1, H.split("")), r.trigger("click"))
                : o !== a.keyCode.INSERT || t.shiftKey || t.ctrlKey
                  ? !0 === l.tabThrough && o === a.keyCode.TAB
                    ? (!0 === t.shiftKey
                      ...
                      s.begin < m().maskLength && (t.preventDefault(), I(this, s.begin, s.end)))
                    : t.shiftKey ||
                      (!1 === l.insertMode &&
                        (o === a.keyCode.RIGHT
                          ? setTimeout(() => {
                          ...
                          : o === a.keyCode.LEFT &&
                            setTimeout(() => {
                              var e = I(this);
                              I(this, z ? e.begin + 1 : e.begin - 1);
                            }, 0)))
                  : ((l.insertMode = !l.insertMode),
                    I(this, l.insertMode || s.begin !== m().maskLength ? s.begin : s.begin - 1));
          l.onKeyDown.call(this, t, A(), I(this).begin, l), (Y = -1 !== e.inArray(o, l.ignorables));
        },
        keypressEvent: function (t, n, r, o, s) {
          ...
          if (f) {
            ...
            var p,
              h = n ? { begin: s, end: s } : I(this),
              v = String.fromCharCode(f);
            m().writeOutBuffer = !0;
            var g = M(h, v, o);
            if (
              (!1 !== g &&
                (d(!0), (p = g.caret !== i ? g.caret : n ? g.pos + 1 : S(g.pos)), (m().p = p)),
              !1 !== r &&
                (setTimeout(() => {
                  l.onKeyValidation.call(this, f, g, l);
                }, 0),
                m().writeOutBuffer && !1 !== g))
            ) {
              var k = A();
              T(this, k, l.numericInput && g.caret === i ? D(p) : p, t, !0 !== n),
                !0 !== n &&
                  setTimeout(() => {
        ...
        pasteEvent: function (n) {
          ...
          if (
            (u === (z ? C().reverse() : C()).slice(0, c.begin).join("") && (u = ""),
          ...
          return (
            L(this, !1, !1, z ? p.split("").reverse() : p.toString().split("")),
            T(this, A(), S(v()), n, H !== A().join("")),
          ...
          if (A().join("") !== i) {
            ...
            if (
              ...
              ((t, n, i) => {
                if (
                  ("." === n.charAt(i.begin - 1) &&
                    "" !== l.radixPoint &&
                    (((n = n.split(""))[i.begin - 1] = l.radixPoint.charAt(0)), (n = n.join(""))),
              ...
              return !1;
            if (
              ((i = i.replace(new RegExp("(" + a.escapeRegex(C().join("")) + ")*"), "")),
              !1 ===
                ((t, n, i) => {
                  if (u) {
                    ...
                    if (1 === a.length) {
                      ...
                      return (
                        ...
                        ne.keypressEvent.call(
                          ...
                          !0,
                          !1,
                          m().validPositions[i.begin - 1] ? i.begin : i.begin - 1
                        ),
                        !1
                      );
                    }
              ...
              return !1;
            r.begin > i.length && (I(this, i.length), (r = I(this)));
            var o = A().join(""),
            ...
            c !== p &&
              ...
              d.length > 0
                ? e.each(d.split(""), (t, i) => {
                    var a = new e.Event("keypress");
                    (a.which = i.charCodeAt(0)), (Y = !1), ne.keypressEvent.call(this, a);
                  })
                : (h.begin === h.end - 1 && I(this, D(h.begin + 1), h.end),
                  (t.keyCode = a.keyCode.DELETE),
                  ne.keydownEvent.call(this, t)),
              t.preventDefault();
          }
        },
        ...
        focusEvent: function (e) {
          ...
          l.showMaskOnFocus &&
            ...
            !0 === l.positionCaretOnTab &&
              !1 === ee &&
              "" !== n &&
              (T(this, A(), I(this)), ne.clickEvent.apply(this, [e, !0])),
            (H = A().join(""));
        },
                ...
                switch (l.positionCaretOnClick) {
                  ...
                  default:
                    var s = e.begin,
                      c = v(s, !0),
                      u = S(c);
                    if (s < u) I(this, O(s, !0) || O(s - 1, !0) ? s : S(s));
                    else {
        ...
        cutEvent: function (i) {
          ...
          c.setData("text", z ? u.reverse().join("") : u.join("")),
            ...
            K(this, a.keyCode.DELETE, s),
            T(this, A(), m().p, i, H !== A().join("")),
        ...
        blurEvent: function (t) {
          ...
          if (this.inputmask) {
            var r = this.inputmask._valueGet(),
              o = A().slice();
            "" !== r &&
              (l.clearMaskOnLostFocus && (-1 === v() && r === C().join("") ? (o = []) : N(o)),
              !1 === R(o) &&
                (setTimeout(() => {
                  n.trigger("incomplete");
                }, 0),
                l.clearIncomplete && (d(), (o = l.clearMaskOnLostFocus ? [] : C().slice()))),
              T(this, o, i, t)),
    ...
    a.prototype.positionColorMask = (e, t) => {
    ...
    if (r !== i)
      switch (r.action) {
                          ...
                          ? this.inputmask.opts.autoUnmask
                            ...
                            : -1 !== v() || !0 !== a.nullable
                              ? n.activeElement === this && a.clearMaskOnLostFocus
                                ? (z ? N(A().slice()).reverse() : N(A().slice())).join("")
                                : s.call(this)
                              : ""
                          : s.call(this);
                      }
            ...
            if (
              ...
              p &&
                ($.hasOwnProperty("inputmode") &&
                  (($.inputmode = l.inputmode), $.setAttribute("inputmode", l.inputmode)),
                "rtfm" === l.androidHack && (!0 !== l.colorMask && U($), ($.type = "password"))),
              !0 === a &&
                ...
                p || !0 === l.inputEventOnly
                  ...
                  : (te.on($, "keydown", ne.keydownEvent), te.on($, "keypress", ne.keypressEvent)),
              ...
              var r = e.isFunction(l.onBeforeMask)
                ? l.onBeforeMask.call(Z, $.inputmask._valueGet(!0), l) || $.inputmask._valueGet(!0)
                : $.inputmask._valueGet(!0);
        ...
        case "format":
          return (
            (ie = (
              e.isFunction(l.onBeforeMask) ? l.onBeforeMask.call(Z, r.value, l) || r.value : r.value
            ).split("")),
        ...
        case "remove":
          if ($ && $.inputmask) {
            ...
            Object.getOwnPropertyDescriptor && Object.getPrototypeOf
              ? Object.getOwnPropertyDescriptor(Object.getPrototypeOf($), "value") &&
  ...
  return (
    (a.prototype = {
      ...
      mask: function (l) {
        function c(n, a, o, s) {
          ...
          if (!0 === a.importDataAttributes) {
            var c,
              ...
              h = n.getAttribute(s);
            if (
              (h && "" !== h && ((h = h.replace(/'/g, '"')), (u = JSON.parse("{" + h + "}"))), u)
            ) {
              f = i;
              for (p in u)
        ...
        return (
          "string" == typeof l && (l = n.getElementById(l) || n.querySelectorAll(l)),
          (l = l.nodeName ? [l] : l),
          e.each(l, (t, n) => {
            var r = e.extend(!0, {}, this.opts);
            c(n, r, e.extend(!0, {}, this.userOptions), this.dataAttribute);
            var l = o(r, this.noMasksCache);
            l !== i &&
      ...
      analyseMask: (t, n, r) => {
        ...
        function l(t) {
          t &&
            t.matches &&
            e.each(t.matches, (e, a) => {
              var o = t.matches[e + 1];
              (o === i || o.matches === i || !1 === o.isQuantifier) &&
                a &&
                a.isGroup &&
                ((a.isGroup = !1),
                n || (s(a, r.groupmarker.start, 0), !0 !== a.openGroup && s(a, r.groupmarker.end))),
                l(a);
            });
        }
        function c() {
            ...
            switch (p.charAt(0)) {
                  ...
                  if (E.length > 0) {
                    if (((m = E[E.length - 1]).matches.push(h), m.isAlternator)) {
                      ...
                      for (var A = 0; A < d.matches.length; A++)
                        (d.matches[A].isGroup = !1), (d.matches[A].alternatorGroup = !1);
                      E.length > 0 ? (m = E[E.length - 1]).matches.push(d) : P.matches.push(d);
                    }
              ...
              case r.quantifiermarker.start:
                var _ = new o(!1, !1, !0),
                  ...
                  w = isNaN(x[0]) ? x[0] : Number.parseInt(x[0]),
                  M = 1 === x.length ? w : isNaN(x[1]) ? x[1] : Number.parseInt(x[1]);
                if (
                  (("*" !== M && "+" !== M) || (w = "*" === M ? 0 : 1),
                  ...
                  (f = O.pop()).isGroup || ((g = new o(!0)).matches.push(f), (f = g)),
                    O.push(f),
                    O.push(_);
                } else
              ...
              case r.alternatormarker:
                if (E.length > 0) {
                  ...
                  v =
                    m.openGroup && (S.matches === i || (!1 === S.isGroup && !1 === S.isAlternator))
                      ? E.pop()
                      : m.matches.pop();
        ...
        while (E.length > 0) (h = E.pop()), P.matches.push(h);
    ...
    (a.extendDefinitions = (t) => {
      e.extend(!0, a.prototype.definitions, t);
    }),
    (a.extendAliases = (t) => {
      e.extend(!0, a.prototype.aliases, t);
    }),
    (a.format = (e, t, n) => a(t).format(e, n)),
    (a.unmask = (e, t) => a(t).unmaskedvalue(e)),
    (a.isValid = (e, t) => a(t).isValid(e)),
    (a.remove = (t) => {
      e.each(t, (e, t) => {
