...
!(function (e) {
      ...
      return (
        a.prototype.masksCache[u] === i || !0 === n
          ? ((c = {
            ...
            !0 !== n && ((a.prototype.masksCache[u] = c), (c = e.extend(!0, {}, a.prototype.masksCache[u]))))
  ...
  function s(r, o, l) {
      ...
      for (
        ...
        (!(
          ...
          (o.alternation === i ||
            ...
            (n.locator[o.alternation] !== i && w(n.locator[o.alternation].toString().split(","), s)))
        ) ||
                        ...
                        if (
                          ...
                          (G = !0),
                            T.alternation === B.alternation &&
                              -1 === B.locator[B.alternation].toString().indexOf(T.locator[T.alternation]) &&
                              ((B.locator[B.alternation] = B.locator[B.alternation] + "," + T.locator[T.alternation]),
                              (B.alternation = T.alternation)),
                            T.match.nativeDef === B.match.def &&
                              ((T.locator[T.alternation] = B.locator[B.alternation]), E.splice(E.indexOf(B), 1, T));
                          break;
                        }
                        ...
                        if (
                          ...
                          T.alternation === B.alternation &&
                            ...
                            -1 === T.na.indexOf(T.locator[T.alternation].toString().split("")[0]) &&
                              (T.na = T.na + "," + T.locator[B.alternation].toString().split("")[0]),
                            (G = !0),
                            (T.locator[T.alternation] =
                              B.locator[B.alternation].toString().split("")[0] + "," + T.locator[T.alternation]),
    ...
    function M(t, n, r, o, s, c) {
        ...
        return (
          e.each(E(n), function (c, f) {
            ...
            if (
              ...
              } else if (!0 !== s && s.pos !== i && s.pos !== n && ((E = s.pos), _(n, E, A().slice()), E !== n))
                return (s = e.extend(s, M(E, P, !0))), !1;
              return (
                (!0 === s || s.pos !== i || s.c !== i) &&
                (c > 0 && d(!0), p(E, e.extend({}, f, { input: x(P, h, E) }), o, u(t)) || (s = !1), !1)
              );
            }
          }),
          s
          ...
          m().validPositions[n] === i &&
            ...
            (a = k(r)) &&
              (a.match.def === l.radixPointDefinitionSymbol ||
                !O(n, !0) ||
                (e.inArray(l.radixPoint, A()) < n && a.match.fn && a.match.fn.test(G(n), m(), n, !1, l))) &&
              !1 !==
                (C = f(n, G(n, a.match, !0) || (null == a.match.fn ? a.match.def : "" !== G(n) ? G(n) : A()[n]), !0)) &&
      ...
      if (
        (e.isFunction(l.preValidation) && !r && !0 !== o && !0 !== c && (C = l.preValidation(A(), b, n, u(t), l)),
        !0 === C)
      ) {
        if (
          (h(b),
          u(t) && (K(i, a.keyCode.DELETE, t, !0, !0), (b = m().p)),
          b < m().maskLength && (W === i || b < W) && ((C = f(b, n, r)), (!r || !0 === o) && !1 === C && !0 !== c))
        ) {
                          ...
                          "" === l[l.length - 1].match.def && l.pop(),
                            e.each(l, function (e, t) {
                              for (var n = 0; n < o; n++) {
                                if (
                                  t.locator[n] === i ||
                                  !w(t.locator[n].toString().split(","), r[n].toString().split(","), t.na)
                                ) {
                                  var a = r[n],
                                    s = c.locator[n],
                                    l = t.locator[n];
                            ...
                            ((c = e.extend({}, c, { input: G(s, c.match, !0) || c.match.def })).generatedInput = !0),
                            p(s, c, !0),
                            (m().validPositions[n] = i),
                            f(n, a.input, !0);
                        }
            ...
            if (s !== i) {
              ...
              e.each(E(g, A ? A.locator : i, g - 1), function (r, c) {
                ...
                for (var u = 0; u < h.length; u++) {
                  ...
                  if (
                    P < h[u] &&
                    (c.na === i || -1 === e.inArray(h[u], c.na.split(",")) || -1 === e.inArray(P.toString(), h))
                  ) {
                    ...
                    for (
                      m().validPositions[g].locator[s] = parseInt(h[u]),
                        null == c.match.fn
                          ? (C.input !== c.match.def && ((_ = !0), !0 !== C.generatedInput && b.push(C.input)),
                            A++,
                      ...
                      (p = m().validPositions[f]) && !0 !== p.generatedInput && /[0-9a-bA-Z]/.test(p.input)
                        ? b.push(p.input)
                        : f < t && E++,
    ...
    function S(e, t) {
      ...
      for (
        ...
        ++i < n && ((!0 === t && (!0 !== b(i).match.newBlockMarker || !O(i))) || (!0 !== t && !O(i)));
      );
      return i;
    }
    function D(e, t) {
      ...
      for (
        ...
        ((!0 === t && !0 !== b(i).match.newBlockMarker) ||
          (!0 !== t && !O(i) && ((n = E(i)).length < 2 || (2 === n.length && "" === n[1].match.def))));
      );
      return i;
    }
    function j(e) {
          ...
          if (o.length > 1 + ("" === o[o.length - 1].match.def ? 1 : 0))
            for (var c = 0; c < o.length; c++)
              if (
                ...
                (null === o[c].match.fn || r === i || !1 !== o[c].match.fn.test(r.match.def, m(), t, !0, l)) &&
                (s.push(o[c]), null === o[c].match.fn && (r = o[c]), s.length > 1 && /[0-9a-bA-Z]/.test(s[0].match.def))
              )
    ...
    function L(t, r, o, s, c) {
      function u(e, t) {
        return (
          -1 !== C().slice(e, S(e)).join("").indexOf(t) && !O(e) && b(e).match.nativeDef === t.charAt(t.length - 1)
        );
      }
      var f = s.slice(),
        p = "",
    ...
    function I(e, a, r, o) {
      function s(e) {
        return (
          !0 === o || !z || "number" != typeof e || (l.greedy && "" === l.placeholder) || (e = A().join("").length - e),
          e
        );
      }
      var u;
      ...
      if ((a.begin !== i && ((r = a.end), (a = a.begin)), "number" == typeof a)) {
        ...
        if (
          ((e.scrollLeft = f > e.scrollWidth ? f : 0), c || !1 !== l.insertMode || a !== r || r++, e.setSelectionRange)
        )
    ...
    function N(e) {
      for (
        ...
        ((!0 !== t.match.optionalQuantifier && !0 !== t.match.newBlockMarker) ||
          (n + 1 === a && "" === (r !== i ? y(n + 1, r.locator.slice(""), r) : b(n + 1)).match.def));
      )
        n++;
    ...
    function R(t) {
      ...
      if (a.def === i || a.def.newBlockMarker || a.def.optionality || a.def.optionalQuantifier) {
        ...
        for (var o = 0; o <= r; o++) {
          var s = y(o).match;
          if (
            (null !== s.fn && m().validPositions[o] === i && !0 !== s.optionality && !0 !== s.optionalQuantifier) ||
            (null === s.fn && t[o] !== G(o, s))
          ) {
            n = !1;
            break;
    ...
    function K(t, n, r, o, s) {
      if (
        (l.numericInput || z) &&
        (n === a.keyCode.BACKSPACE ? (n = a.keyCode.DELETE) : n === a.keyCode.DELETE && (n = a.keyCode.BACKSPACE), z)
      ) {
        var c = r.end;
      ...
      n === a.keyCode.BACKSPACE && (r.end - r.begin < 1 || !1 === l.insertMode)
        ? ((r.begin = D(r.begin)),
          m().validPositions[r.begin] !== i && m().validPositions[r.begin].input === l.groupSeparator && r.begin--)
        : n === a.keyCode.DELETE &&
          r.begin === r.end &&
          ((r.end =
            O(r.end, !0) && m().validPositions[r.end] && m().validPositions[r.end].input !== l.radixPoint
              ? r.end + 1
              : S(r.end) + 1),
        ...
        !0 !== o &&
          (function () {
            if (l.keepStatic) {
              for (
                var n = [], a = v(-1, !0), r = e.extend(!0, {}, m().validPositions), o = m().validPositions[a];
                a >= 0;
                a--
              ) {
      ...
      if (q !== i) {
        ...
        if ((t === i ? (t = I(e)) : t.begin === i && (t = { begin: t, end: t }), !0 !== a)) {
          ...
          do {
            o(),
              m().validPositions[h]
                ? ((c = m().validPositions[h]), (s = c.match), (u = c.locator.slice()), r(), (f += d[h]))
                : ((c = y(h, u, h - 1)),
                  (s = c.match),
                  (u = c.locator.slice()),
                  (!1 === l.jitMasking ||
                    h < g ||
                    ("number" == typeof l.jitMasking && isFinite(l.jitMasking) && l.jitMasking > h)) &&
                    (r(), (f += G(h, s)))),
              h++;
      ...
      ne = {
        keydownEvent: function (t) {
          ...
          if (
            ...
            (o === a.keyCode.HOME && !t.shiftKey) || o === a.keyCode.PAGE_UP
              ...
              : ((l.undoOnEscape && o === a.keyCode.ESCAPE) || (90 === o && t.ctrlKey)) && !0 !== t.altKey
                  ...
                  ? !0 === l.tabThrough && o === a.keyCode.TAB
                    ? (!0 === t.shiftKey
                        ? (null === b(s.begin).match.fn && (s.begin = S(s.begin)),
                          (s.end = D(s.begin, !0)),
                          (s.begin = D(s.end, !0)))
                        : ((s.begin = S(s.begin, !0)), (s.end = S(s.begin, !0)), s.end < m().maskLength && s.end--),
                      s.begin < m().maskLength && (t.preventDefault(), I(i, s.begin, s.end)))
                    : t.shiftKey ||
                      (!1 === l.insertMode &&
                        (o === a.keyCode.RIGHT
                          ? setTimeout(function () {
        ...
        keypressEvent: function (t, n, r, o, s) {
          ...
          if (f) {
            ...
            var g = M(h, v, o);
            if (
              (!1 !== g && (d(!0), (p = g.caret !== i ? g.caret : n ? g.pos + 1 : S(g.pos)), (m().p = p)),
              !1 !== r &&
                (setTimeout(function () {
            ...
            if (
              ...
              (function (t, n, i) {
                if (
                  ...
                  return (
                    (a.which = l.radixPoint.charCodeAt(0)), ne.keypressEvent.call(t, a, !0, !0, !1, i.begin - 1), !1
                  );
                }
              })(n, i, r)
            )
        ...
        focusEvent: function (e) {
          ...
          l.showMaskOnFocus &&
            ...
            (t.inputmask._valueGet() !== A().join("") ? T(t, A(), S(v())) : !1 === ee && I(t, S(v()))),
            !0 === l.positionCaretOnTab && !1 === ee && "" !== n && (T(t, A(), I(t)), ne.clickEvent.apply(t, [e, !0])),
            (H = A().join(""));
        },
    ...
    if (r !== i)
      switch (r.action) {
                      ...
                      if (!t.inputmask.__valueGet) {
                        ...
                        (t.inputmask._valueGet = function (e) {
                          ...
                          (t.inputmask._valueSet = function (e, t) {
                            l.call(
                              this.el,
                              null === e || e === i ? "" : !0 !== t && z ? e.split("").reverse().join("") : e
                            );
                          }),
                          s === i &&
                            ((s = function () {
                                ...
                                e.valHooks[t] = {
                                  get: function (e) {
                                    if (e.inputmask) {
                                      ...
                                      var t = n(e);
                                      return -1 !== v(i, i, e.inputmask.maskset.validPositions) || !0 !== a.nullable
                                        ? t
                                        : "";
                                    }
                                    return n(e);
        ...
        case "format":
          return (
            (ie = (e.isFunction(l.onBeforeMask) ? l.onBeforeMask.call(Z, r.value, l) || r.value : r.value).split("")),
        ...
        function c(n, a, o, s) {
          function l(e, a) {
            null !== (a = a !== i ? a : n.getAttribute(s + "-" + e)) &&
              ("string" == typeof a &&
                (0 === e.indexOf("on") ? (a = t[a]) : "false" === a ? (a = !1) : "true" === a && (a = !0)),
              (o[e] = a));
          }
          ...
          t &&
            ...
            e.each(t.matches, function (e, a) {
              ...
              (o === i || o.matches === i || !1 === o.isQuantifier) &&
                a &&
                a.isGroup &&
                ((a.isGroup = !1), n || (s(a, r.groupmarker.start, 0), !0 !== a.openGroup && s(a, r.groupmarker.end))),
                l(a);
            });
        }
        function c() {
            ...
            switch (p.charAt(0)) {
              ...
              case r.quantifiermarker.start:
                ...
                if (
                  ...
                  (f = P.matches.pop()).isGroup ||
                    (n && null === f.fn && "." === f.def && (f.fn = new RegExp(f.def, r.casing ? "i" : "")),
              ...
              case r.alternatormarker:
                ...
                if (v.isAlternator) E.push(v);
                  ...
                  (v.alternatorGroup ? ((d = E.pop()), (v.alternatorGroup = !1)) : (d = new o(!1, !1, !1, !0)),
                  d.matches.push(v),
                  E.push(d),
                  v.openGroup)
                ) {
