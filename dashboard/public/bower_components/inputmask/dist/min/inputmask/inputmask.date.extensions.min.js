  ...
  return (
    a.extendAliases({
      "dd/mm/yyyy": {
        ...
        isInYearRange: (e, a, r) => {
          if (isNaN(e)) return !1;
          var t = Number.parseInt(e.concat(a.toString().slice(e.length))),
            n = Number.parseInt(e.concat(r.toString().slice(e.length)));
          return (!isNaN(t) && a <= t && t <= r) || (!isNaN(n) && a <= n && n <= r);
        },
        determinebaseyear: (e, a, r) => {
        ...
        onKeyDown: function (r, t, n, y) {
          ...
          if (r.ctrlKey && r.keyCode === a.keyCode.RIGHT) {
            var s = new Date();
            i.val(
              s.getDate().toString() + (s.getMonth() + 1).toString() + s.getFullYear().toString()
            ),
              i.trigger("setvalue");
          }
        },
          ...
          1: {
            validator: (e, a, r, t, n) => {
              ...
              return t ||
                ...
                ? y
                : ((a.buffer[r - 1] = "0"),
                  { refreshFromBuffer: { start: r - 1, end: r }, pos: r, c: e.charAt(0) });
            },
            cardinality: 2,
            prevalidator: [
              {
            ...
            prevalidator: [
                ...
                validator: (e, a, r, t, n) => {
                  ...
                  if (!t && !y) {
                    ...
                    if (
                      ...
                      return (
                        (a.buffer[r++] = i.charAt(0)), (a.buffer[r++] = i.charAt(1)), { pos: r }
                      );
                  }
                  return y;
                },
              ...
              },
              {
                validator: (e, a, r, t, n) => {
                  ...
                  if (!t && !y) {
                    var i = n
                      .determinebaseyear(n.yearrange.minyear, n.yearrange.maxyear, e)
                      .toString()
                      .slice(0, 2);
                    if (
                      (y = n.isInYearRange(
      ...
      "mm/dd/yyyy": {
        ...
        onKeyDown: function (r, t, n, y) {
          ...
          if (r.ctrlKey && r.keyCode === a.keyCode.RIGHT) {
            var s = new Date();
            i.val(
              (s.getMonth() + 1).toString() + s.getDate().toString() + s.getFullYear().toString()
            ),
              i.trigger("setvalue");
          }
        },
      ...
      "yyyy/mm/dd": {
        ...
        onKeyDown: function (r, t, n, y) {
          ...
          if (r.ctrlKey && r.keyCode === a.keyCode.RIGHT) {
            var s = new Date();
            i.val(
              s.getFullYear().toString() + (s.getMonth() + 1).toString() + s.getDate().toString()
            ),
              i.trigger("setvalue");
          }
        },
      ...
      datetime: {
        ...
        definitions: {
          h: {
            validator: (e, a, r, t, n) => {
              if ("24" === n.hourFormat && 24 === Number.parseInt(e, 10))
                return (
                  (a.buffer[r - 1] = "0"),
                  (a.buffer[r] = "0"),
          ...
          t: {
            validator: (e, a, r, t, n) => n.regex.ampm.test(e + "m"),
            casing: "lower",
            cardinality: 1,
          },
        },
