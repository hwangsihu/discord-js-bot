    ...
    !(function (o) {
      ...
      function s(t, n) {
        function r(t, r, o) {
          ...
          if (
            ((null !== t && "" !== t) ||
              ((s = null !== o.regex) ? (t = (t = o.regex).replace(/^(\^)(.*)(\$)$/, "$2")) : ((s = !0), (t = ".*"))),
          ...
          return (
            i.prototype.masksCache[u] === a || !0 === n
              ? ((c = {
                ...
                !0 !== n && ((i.prototype.masksCache[u] = c), (c = e.extend(!0, {}, i.prototype.masksCache[u]))))
      ...
      function l(r, s, c) {
          ...
          do {
            !0 === e && h().validPositions[l]
              ...
              : ((r = (o = b(l, i, l - 1)).match),
                ...
                (!1 === c.jitMasking ||
                  l < u ||
                  ("number" == typeof c.jitMasking && isFinite(c.jitMasking) && c.jitMasking > l)) &&
            ...
            if ((o < s && (o = s + 1), h().validPositions[o] === a && M(o))) o++;
              ...
              !1 === u && l[s] && l[s].match.def === p.match.def
                ? ((h().validPositions[s] = e.extend(!0, {}, l[s])),
                  ...
                  o++)
                : P(s, p.match.def)
                  ? !1 !== R(s, p.input || I(o), !0) && (delete h().validPositions[o], o++, (u = !0))
                  : M(o) || (o++, s--),
                s++;
            }
          }
          ...
          for (
            ...
            (!(
              ...
              (o.alternation === a ||
                ...
                (n.locator[o.alternation] !== a && O(n.locator[o.alternation].toString().split(","), s)))
            ) ||
              ...
              if (o.matches !== a) {
                if (o.isGroup && g !== o) {
                  ...
                  if (-1 === A || "string" == typeof A) {
                    ...
                    for (var M = 0; M < R.length; M++) {
                      if (
                        ...
                        (f = []),
                        (i = y(u, E, w) || O.slice()),
                        !0 !== (o = p(x.matches[E] || n.matches[E], [E].concat(l), g) || o) &&
                          o !== a &&
                          R[R.length - 1] < x.matches.length)
                      ) {
                        var _ = e.inArray(o, n.matches) + 1;
                        n.matches.length > _ &&
                          (o = p(n.matches[_], [_].concat(l.slice(1, l.length)), g)) &&
                          (R.push(_.toString()),
                            ...
                            if (
                              ...
                              (N = !0),
                                j.alternation === F.alternation &&
                                  -1 === F.locator[F.alternation].toString().indexOf(j.locator[j.alternation]) &&
                                  ((F.locator[F.alternation] =
                                    F.locator[F.alternation] + "," + j.locator[j.alternation]),
                                  (F.alternation = j.alternation)),
                                j.match.nativeDef === F.match.def &&
                                  ((j.locator[j.alternation] = F.locator[F.alternation]), P.splice(P.indexOf(F), 1, j));
                              break;
                            }
                            ...
                            if (
                              ...
                              (function (e, n) {
                                return (
                                  null !== e.match.fn &&
                                  null !== n.match.fn &&
                                  n.match.fn.test(e.match.def.replace(/[\[\]]/g, ""), h(), t, !1, c, !1)
                                );
                              })(j, F)
                            ) {
                              j.alternation === F.alternation &&
                                -1 ===
                                  j.locator[j.alternation]
                                    .toString()
                                    .indexOf(F.locator[F.alternation].toString().split("")[0]) &&
                                ((j.na = j.na || j.locator[j.alternation].toString()),
                                -1 === j.na.indexOf(j.locator[j.alternation].toString().split("")[0]) &&
                                  (j.na = j.na + "," + j.locator[F.alternation].toString().split("")[0]),
                                (N = !0),
                                (j.locator[j.alternation] =
                                  F.locator[F.alternation].toString().split("")[0] + "," + j.locator[j.alternation]),
                  ...
                  for (
                    ...
                    G < (isNaN(T.quantifier.max) ? G + 1 : T.quantifier.max) && u <= t;
                    G++
                  ) {
              ...
              g !== a &&
                ...
                ((p = (function (t) {
                  ...
                  return (
                    ...
                    t.length > 0 &&
                      (t[0].alternation === a
                        ? 0 === (n = k(t.slice()).locator.slice()).length && (n = t[0].locator.slice())
        ...
        function w() {
          return (
            h()._buffer === a && ((h()._buffer = m(!1, 1)), h().buffer === a && (h().buffer = h()._buffer.slice())),
            h()._buffer
          );
        }
        function A(e) {
        ...
        function C(t, n, a) {
          switch (c.casing || n.casing) {
            ...
            case "title":
              ...
              t =
                0 === a || (r && r.input === String.fromCharCode(i.keyCode.SPACE)) ? t.toUpperCase() : t.toLowerCase();
              break;
            default:
        ...
        function O(t, n, i) {
          for (
            var r, o = c.greedy ? n : n.slice(0, 1), s = !1, l = i !== a ? i.split(",") : [], u = 0;
            u < l.length;
            u++
          )
        ...
        function R(t, n, r, o, s, l) {
            ...
            return (
              e.each(S(n), function (l, p) {
                ...
                if (
                  ...
                  } else if (!0 !== s && s.pos !== a && s.pos !== n && ((P = s.pos), E(n, P, A().slice()), P !== n))
                    return (s = e.extend(s, R(P, x, !0))), !1;
                  return (
                    (!0 === s || s.pos !== a || s.c !== a) &&
                    (l > 0 && g(!0), f(P, e.extend({}, p, { input: C(x, d, P) }), o, u(t)) || (s = !1), !1)
                  );
                }
              }),
              s
              ...
              for (o = u = t; o <= l; o++) {
                ...
                if (k !== a)
                  for (
                    ...
                    ((null === k.match.fn &&
                      f[o] &&
                      (!0 === f[o].match.optionalQuantifier || !0 === f[o].match.optionality)) ||
                      null != k.match.fn);
                  ) {
          ...
          function d(t) {
            ...
            for (n++; n < t; n++)
              h().validPositions[n] === a &&
                ...
                ("" === (r = S(n, b(n - 1).locator, n - 1).slice())[r.length - 1].match.def && r.pop(),
                (i = k(r)) &&
                  (i.match.def === c.radixPointDefinitionSymbol ||
                    !M(n, !0) ||
                    (e.inArray(c.radixPoint, A()) < n && i.match.fn && i.match.fn.test(I(n), h(), n, !1, c))) &&
                  !1 !==
                    (x = p(
                      n,
                      I(n, i.match, !0) || (null == i.match.fn ? i.match.def : "" !== I(n) ? I(n) : A()[n]),
                      !0
                    )) &&
          ...
          if (
            (e.isFunction(c.preValidation) && !r && !0 !== o && !0 !== l && (x = c.preValidation(A(), m, n, u(t), c)),
            !0 === x)
          ) {
            if (
              (d(m),
                              ...
                              "" === l[l.length - 1].match.def && l.pop(),
                                e.each(l, function (e, t) {
                                  for (var n = 0; n < o; n++) {
                                    if (
                                      t.locator[n] === a ||
                                      !O(t.locator[n].toString().split(","), r[n].toString().split(","), t.na)
                                    ) {
                                      var i = r[n],
                                        s = c.locator[n],
                                        l = t.locator[n];
                                ...
                                ((c = e.extend({}, c, { input: I(s, c.match, !0) || c.match.def })).generatedInput =
                                  !0),
                                f(s, c, !0),
                                (h().validPositions[n] = a),
                                p(n, i.input, !0);
                ...
                if (s !== a) {
                  ...
                  e.each(S(m, w ? w.locator : a, m - 1), function (r, l) {
                    ...
                    for (var u = 0; u < d.length; u++) {
                      ...
                      if (
                        x < d[u] &&
                        (l.na === a || -1 === e.inArray(d[u], l.na.split(",")) || -1 === e.inArray(x.toString(), d))
                      ) {
                        ...
                        for (
                          h().validPositions[m].locator[s] = parseInt(d[u]),
                            null == l.match.fn
                              ? (P.input !== l.match.def && ((A = !0), !0 !== P.generatedInput && b.push(P.input)),
                                w++,
                                (h().validPositions[m].generatedInput = !/[0-9a-bA-Z]/.test(l.match.def)),
                          ...
                          (f = h().validPositions[p]) && !0 !== f.generatedInput && /[0-9a-bA-Z]/.test(f.input)
                            ? b.push(f.input)
                            : p < t && S++,
        ...
        function _(e, t) {
          ...
          for (
            ...
            ++a < n && ((!0 === t && (!0 !== x(a).match.newBlockMarker || !M(a))) || (!0 !== t && !M(a)));
          );
          return a;
        }
        function D(e, t) {
          ...
          for (
            ...
            ((!0 === t && !0 !== x(a).match.newBlockMarker) ||
              (!0 !== t && !M(a) && ((n = S(a)).length < 2 || (2 === n.length && "" === n[1].match.def))));
          );
          return a;
        }
        function j(e) {
              ...
              if (o.length > 1 + ("" === o[o.length - 1].match.def ? 1 : 0))
                for (var l = 0; l < o.length; l++)
                  if (
                    ...
                    (null === o[l].match.fn || r === a || !1 !== o[l].match.fn.test(r.match.def, h(), t, !0, c)) &&
                    (s.push(o[l]),
        ...
        function F(t, r, o, s, l) {
          function u(e, t) {
            return (
              -1 !== w().slice(e, _(e)).join("").indexOf(t) && !M(e) && x(e).match.nativeDef === t.charAt(t.length - 1)
            );
          }
          var p = s.slice(),
            f = "",
          ...
          if (
            ...
            e.each(p, function (n, i) {
              if (i !== a)
                if (h().validPositions[n] === a && p[n] === I(n) && M(n, !0) && !1 === R(n, p[n], !0, a, a, !0))
                  h().p++;
                else {
                  ...
                  if (!1 !== m && !o && e.isFunction(c.onBeforeWrite)) {
                    var x = m;
                    if (
                      ((m = c.onBeforeWrite.call(W, r, A(), m.forwardPosition, c)),
                      (m = e.extend(x, m)) && m.refreshFromBuffer)
                    ) {
                      var P = m.refreshFromBuffer;
                      E(!0 === P ? P : P.start, P.end, m.buffer),
                        g(!0),
                        m.caret && ((h().p = m.caret), (m.forwardPosition = m.caret));
                    }
                  }
                }
            }),
            ...
            var P = a;
            n.activeElement === t && m && (P = c.numericInput ? D(m.forwardPosition) : m.forwardPosition),
              N(t, A(), P, l || new e.Event("checkval"), l && "input" === l.type);
          }
        }
        function T(t) {
          if (t) {
        ...
        function G(e, i, r, o) {
          ...
          if (i === a)
            return (
              e.setSelectionRange
                ...
                : t.getSelection
                  ? ((l = t.getSelection().getRangeAt(0)).commonAncestorContainer.parentNode !== e &&
                    ...
                    (r =
                      (i =
                        ...
                        (l = n.selection.createRange())
                          .duplicate()
                          .moveStart("character", -e.inputmask._valueGet().length)) + l.text.length),
              { begin: s(i), end: s(r) }
            );
          if ((i.begin !== a && ((r = i.end), (i = i.begin)), "number" == typeof i)) {
            ...
            if (
              ...
              l.setStart(e.firstChild, i < e.inputmask._valueGet().length ? i : e.inputmask._valueGet().length),
              ...
              (p &&
                ((p !== l[n].locator[c.alternation] && null != i.match.fn) ||
                  (null === i.match.fn &&
                    ...
                    O(i.locator[c.alternation].toString().split(","), p.toString().split(",")) &&
                    "" !== S(n)[0].def)))) &&
            r[n] === I(n, i.match);
            n--
          )
        ...
        function L(e) {
          for (
            ...
            ((!0 !== t.match.optionalQuantifier && !0 !== t.match.newBlockMarker) ||
              (n + 1 === i && "" === (r !== a ? b(n + 1, r.locator.slice(""), r) : x(n + 1)).match.def));
          )
            n++;
          for (
            ;
            (t = h().validPositions[n - 1]) && t && t.match.optionality && t.input === c.skipOptionalPartCharacter;
          )
            n--;
          return e.splice(n), e;
        }
        function U(t) {
          ...
          if (i.def === a || i.def.newBlockMarker || i.def.optionality || i.def.optionalQuantifier) {
            ...
            for (var o = 0; o <= r; o++) {
              var s = b(o).match;
              if (
                (null !== s.fn && h().validPositions[o] === a && !0 !== s.optionality && !0 !== s.optionalQuantifier) ||
                (null === s.fn && t[o] !== I(o, s))
              ) {
                n = !1;
                break;
        ...
        function V(t, n, r, o, s) {
          if (
            (c.numericInput || Z) &&
            (n === i.keyCode.BACKSPACE ? (n = i.keyCode.DELETE) : n === i.keyCode.DELETE && (n = i.keyCode.BACKSPACE),
            Z)
          ) {
            var l = r.end;
          ...
          n === i.keyCode.BACKSPACE && (r.end - r.begin < 1 || !1 === c.insertMode)
            ? ((r.begin = D(r.begin)),
              h().validPositions[r.begin] !== a && h().validPositions[r.begin].input === c.groupSeparator && r.begin--)
            : n === i.keyCode.DELETE &&
              r.begin === r.end &&
              ((r.end =
                M(r.end, !0) && h().validPositions[r.end] && h().validPositions[r.end].input !== c.radixPoint
                  ? r.end + 1
                  : _(r.end) + 1),
              h().validPositions[r.begin] !== a && h().validPositions[r.begin].input === c.groupSeparator && r.end++),
            y(r.begin, r.end, !1, o),
            !0 !== o &&
              (function () {
                if (c.keepStatic) {
                  for (
                    var n = [], i = v(-1, !0), r = e.extend(!0, {}, h().validPositions), o = h().validPositions[i];
                    i >= 0;
                    i--
                  ) {
                    ...
                    if (s) {
                      if (
                        ...
                        s.alternation !== a && s.locator[s.alternation] !== o.locator[s.alternation])
                      )
                        break;
                      o = s;
                    }
        ...
        function H(e, t, i) {
          function r() {
            f || (null !== s.fn && l.input !== a)
              ? f && ((null !== s.fn && l.input !== a) || "" === s.def) && ((f = !1), (p += "</span>"))
              : ((f = !0), (p += "<span class='im-static'>"));
          }
          function o(a) {
            (!0 !== a && d !== t.begin) ||
              n.activeElement !== e ||
              (p += "<span class='im-caret' style='border-right-width: 1px;border-right-style: solid;'></span>");
          }
          var s,
            l,
            u,
          ...
          if ($ !== a) {
            ...
            if ((t === a ? (t = G(e)) : t.begin === a && (t = { begin: t, end: t }), !0 !== i)) {
              ...
              do {
                o(),
                  h().validPositions[d]
                    ? ((l = h().validPositions[d]), (s = l.match), (u = l.locator.slice()), r(), (p += m[d]))
                    : ((l = b(d, u, d - 1)),
                      (s = l.match),
                      (u = l.locator.slice()),
                      (!1 === c.jitMasking ||
                        d < g ||
                        ("number" == typeof c.jitMasking && isFinite(c.jitMasking) && c.jitMasking > d)) &&
                        (r(), (p += I(d, s)))),
                  d++;
          ...
          ae = {
            keydownEvent: function (t) {
              ...
              if (
                ...
                t.preventDefault(),
                  V(a, o, s),
                  N(a, A(!0), h().p, t, a.inputmask._valueGet() !== A().join("")),
                ...
                (o === i.keyCode.HOME && !t.shiftKey) || o === i.keyCode.PAGE_UP
                  ...
                  : ((c.undoOnEscape && o === i.keyCode.ESCAPE) || (90 === o && t.ctrlKey)) && !0 !== t.altKey
                    ? (F(a, !0, !1, z.split("")), r.trigger("click"))
                    : o !== i.keyCode.INSERT || t.shiftKey || t.ctrlKey
                      ? !0 === c.tabThrough && o === i.keyCode.TAB
                        ? (!0 === t.shiftKey
                            ? (null === x(s.begin).match.fn && (s.begin = _(s.begin)),
                              (s.end = D(s.begin, !0)),
                              (s.begin = D(s.end, !0)))
                            : ((s.begin = _(s.begin, !0)), (s.end = _(s.begin, !0)), s.end < h().maskLength && s.end--),
                          s.begin < h().maskLength && (t.preventDefault(), G(a, s.begin, s.end)))
                        : t.shiftKey ||
                          (!1 === c.insertMode &&
                            (o === i.keyCode.RIGHT
                              ? setTimeout(function () {
                      ...
                      : ((c.insertMode = !c.insertMode),
                        G(a, c.insertMode || s.begin !== h().maskLength ? s.begin : s.begin - 1));
            ...
            keypressEvent: function (t, n, r, o, s) {
              ...
              if (p) {
                ...
                var v = R(d, m, o);
                if (
                  (!1 !== v && (g(!0), (f = v.caret !== a ? v.caret : n ? v.pos + 1 : _(v.pos)), (h().p = f)),
                  !1 !== r &&
                    (setTimeout(function () {
            ...
            pasteEvent: function (n) {
              ...
              if (
                (u === (Z ? w().reverse() : w()).slice(0, l.begin).join("") && (u = ""),
                p === (Z ? w().reverse() : w()).slice(l.end).join("") && (p = ""),
                Z && ((a = u), (u = p), (p = a)),
              ...
              return (
                F(i, !1, !1, Z ? f.split("").reverse() : f.toString().split("")),
                ...
                if (
                  ...
                  (function (t, n, a) {
                    if (
                      ("." === n.charAt(a.begin - 1) &&
                        "" !== c.radixPoint &&
                        (((n = n.split(""))[a.begin - 1] = c.radixPoint.charAt(0)), (n = n.join(""))),
                      n.charAt(a.begin - 1) === c.radixPoint && n.length > A().length)
                    ) {
                      var i = new e.Event("keypress");
                      return (
                        (i.which = c.radixPoint.charCodeAt(0)), ae.keypressEvent.call(t, i, !0, !0, !1, a.begin - 1), !1
                      );
                    }
                  })(n, a, r)
                )
            ...
            setValueEvent: function (t) {
              ...
              e.isFunction(c.onBeforeMask) && (a = c.onBeforeMask.call(W, a, c) || a),
                (a = a.split("")),
            ...
            focusEvent: function (e) {
              ...
              c.showMaskOnFocus &&
                ...
                (t.inputmask._valueGet() !== A().join("") ? N(t, A(), _(v())) : !1 === te && G(t, _(v()))),
            ...
            clickEvent: function (t, i) {
              ...
              setTimeout(function () {
                if (n.activeElement === o) {
                  var e = G(o);
                  if ((i && (Z ? (e.end = e.begin) : (e.begin = e.end)), e.begin === e.end))
            ...
            blurEvent: function (t) {
              ...
              if (i.inputmask) {
                var r = i.inputmask._valueGet(),
                  o = A().slice();
                "" !== r &&
                  (c.clearMaskOnLostFocus && (-1 === v() && r === w().join("") ? (o = []) : L(o)),
                  !1 === U(o) &&
                    (setTimeout(function () {
                      n.trigger("incomplete");
                    }, 0),
                    c.clearIncomplete && (g(), (o = c.clearMaskOnLostFocus ? [] : w().slice()))),
                  N(i, o, a, t)),
            ...
            mouseenterEvent: function (e) {
              var t = this;
              (te = !0),
                n.activeElement !== t && c.showMaskOnHover && t.inputmask._valueGet() !== A().join("") && N(t, A());
            },
          ...
          switch (r.action) {
            ...
            case "unmaskedvalue":
              return (
                (Y !== a && r.value === a) ||
                  ((ie = r.value),
                  (ie = (e.isFunction(c.onBeforeMask) ? c.onBeforeMask.call(W, ie, c) || ie : ie).split("")),
                  F(a, !1, !1, Z ? ie.reverse() : ie),
                  e.isFunction(c.onBeforeWrite) && c.onBeforeWrite.call(W, a, A(), 0, c)),
                T(Y)
              );
            case "mask":
              !(function (t) {
                              ...
                              ? this.inputmask.opts.autoUnmask
                                ...
                                : -1 !== v() || !0 !== i.nullable
                                  ? n.activeElement === this && i.clearMaskOnLostFocus
                                    ? (Z ? L(A().slice()).reverse() : L(A().slice())).join("")
                                    : l.call(this)
                                  : ""
                              : l.call(this);
                          }
                          ...
                          if (!t.inputmask.__valueGet) {
                            ...
                            (t.inputmask._valueGet = function (e) {
                              ...
                              (t.inputmask._valueSet = function (e, t) {
                                c.call(
                                  this.el,
                                  null === e || e === a ? "" : !0 !== t && Z ? e.split("").reverse().join("") : e
                                );
                              }),
                              l === a &&
                                ((l = function () {
                                    ...
                                    e.valHooks[t] = {
                                      get: function (e) {
                                        if (e.inputmask) {
                                          ...
                                          var t = n(e);
                                          return -1 !== v(a, a, e.inputmask.maskset.validPositions) || !0 !== i.nullable
                                            ? t
                                            : "";
                                        }
                                        return n(e);
                ...
                if (
                  ...
                  d &&
                    (Y.hasOwnProperty("inputmode") &&
                      ((Y.inputmode = c.inputmode), Y.setAttribute("inputmode", c.inputmode)),
                    "rtfm" === c.androidHack && (!0 !== c.colorMask && K(Y), (Y.type = "password"))),
                  !0 === i &&
                    ...
                    d || !0 === c.inputEventOnly
                      ...
                      : (ne.on(Y, "keydown", ae.keydownEvent), ne.on(Y, "keypress", ae.keypressEvent)),
                  ...
                  (z = w().join("")),
                  "" !== Y.inputmask._valueGet(!0) || !1 === c.clearMaskOnLostFocus || n.activeElement === Y)
                ) {
                  var r = e.isFunction(c.onBeforeMask)
                    ? c.onBeforeMask.call(W, Y.inputmask._valueGet(!0), c) || Y.inputmask._valueGet(!0)
                    : Y.inputmask._valueGet(!0);
                  "" !== r && F(Y, !0, !1, Z ? r.split("").reverse() : r.split(""));
                  var s = A().slice();
                  (z = s.join("")),
                    !1 === U(s) && c.clearIncomplete && g(),
                    c.clearMaskOnLostFocus && n.activeElement !== Y && (-1 === v() ? (s = []) : L(s)),
                    N(Y, s),
            ...
            case "format":
              return (
                (ie = (e.isFunction(c.onBeforeMask) ? c.onBeforeMask.call(W, r.value, c) || r.value : r.value).split(
                  ""
                )),
      ...
      return (
        (i.prototype = {
          ...
          mask: function (o) {
            function c(n, i, o, s) {
                ...
                var l,
                  ...
                  f = function (e, i) {
                    null !== (i = i !== a ? i : n.getAttribute(s + "-" + e)) &&
                      ("string" == typeof i &&
                        (0 === e.indexOf("on") ? (i = t[i]) : "false" === i ? (i = !1) : "true" === i && (i = !0)),
                      (o[e] = i));
                  },
                  d = n.getAttribute(s);
                if (
                  (d && "" !== d && ((d = d.replace(new RegExp("'", "g"), '"')), (c = JSON.parse("{" + d + "}"))), c)
                ) {
                  u = a;
                  for (p in c)
              ...
              return (
                ...
                ("rtl" === n.dir || i.numericInput) && ((n.dir = "ltr"), n.removeAttribute("dir"), (i.isRTL = !0)),
                i
              );
            }
            var u = this;
            return (
              ...
              e.each(o, function (t, n) {
                ...
                o !== a &&
                  (n.inputmask !== a && ((n.inputmask.opts.autoUnmask = !0), n.inputmask.remove()),
          ...
          getemptymask: function () {
            return (
              (this.maskset = this.maskset || s(this.opts, this.noMasksCache)), l.call(this, { action: "getemptymask" })
            );
          },
          ...
          getmetadata: function () {
            return (
              (this.maskset = this.maskset || s(this.opts, this.noMasksCache)), l.call(this, { action: "getmetadata" })
            );
          },
          isValid: function (e) {
            return (
              ...
              t &&
                ...
                e.each(t.matches, function (e, i) {
                  ...
                  (o === a || o.matches === a || !1 === o.isQuantifier) &&
                    ...
                    i.isGroup &&
                    ((i.isGroup = !1),
                    n || (s(i, r.groupmarker.start, 0), !0 !== i.openGroup && s(i, r.groupmarker.end))),
                    l(i);
                });
            }
            function c() {
                ...
                switch (f.charAt(0)) {
                  ...
                  case r.quantifiermarker.start:
                    ...
                    if (
                      ...
                      (p = x.matches.pop()).isGroup ||
                        (n && null === p.fn && "." === p.def && (p.fn = new RegExp(p.def, r.casing ? "i" : "")),
                  ...
                  case r.alternatormarker:
                    if (P.length > 0) {
                      ...
                      g =
                        m.openGroup && (M.matches === a || (!1 === M.isGroup && !1 === M.isAlternator))
                          ? P.pop()
                          : m.matches.pop();
                    } else g = x.matches.pop();
                    if (g.isAlternator) P.push(g);
                    else if (
                      (g.alternatorGroup ? ((h = P.pop()), (g.alternatorGroup = !1)) : (h = new o(!1, !1, !1, !0)),
                      h.matches.push(g),
                      P.push(h),
                      g.openGroup)
                    ) {
  ...
  function (e, t) {
    e.exports = function (e) {
      ...
      return e.replace(/url\s*\(((?:[^)(]|\((?:[^)(]+|\([^)(]*\))*\))*)\)/gi, function (e, t) {
        ...
        var r;
        return (
          (r = 0 === i.indexOf("//") ? i : 0 === i.indexOf("/") ? n + i : a + i.replace(/^\.\//, "")),
        ...
        t.extendAliases({
          "dd/mm/yyyy": {
            ...
            onKeyDown: function (n, a, i, r) {
              ...
              if (n.ctrlKey && n.keyCode === t.keyCode.RIGHT) {
                var s = new Date();
                o.val(s.getDate().toString() + (s.getMonth() + 1).toString() + s.getFullYear().toString()),
                  o.trigger("setvalue");
              }
            },
                ...
                prevalidator: [
                  {
                    validator: function (e, t, n, a, i) {
                      ...
                      if (!a && !r) {
                        var o = i
                          .determinebaseyear(i.yearrange.minyear, i.yearrange.maxyear, e + "0")
                          .toString()
                          .slice(0, 1);
                        if ((r = i.isInYearRange(o + e, i.yearrange.minyear, i.yearrange.maxyear)))
                        ...
                        if (
                          ((o = i
                            ...
                            .toString()
                            .slice(0, 2)),
                          (r = i.isInYearRange(o + e, i.yearrange.minyear, i.yearrange.maxyear)))
                        )
                          return (t.buffer[n++] = o.charAt(0)), (t.buffer[n++] = o.charAt(1)), { pos: n };
                      }
                      return r;
                    },
                    cardinality: 1,
                  },
                  {
                    validator: function (e, t, n, a, i) {
                      ...
                      if (!a && !r) {
                        ...
                        if ((r = i.isInYearRange(e[0] + o[1] + e[1], i.yearrange.minyear, i.yearrange.maxyear)))
          ...
          "mm/dd/yyyy": {
            ...
            onKeyDown: function (n, a, i, r) {
              ...
              if (n.ctrlKey && n.keyCode === t.keyCode.RIGHT) {
                var s = new Date();
                o.val((s.getMonth() + 1).toString() + s.getDate().toString() + s.getFullYear().toString()),
                  o.trigger("setvalue");
              }
            },
          },
          "yyyy/mm/dd": {
            ...
            onKeyDown: function (n, a, i, r) {
              ...
              if (n.ctrlKey && n.keyCode === t.keyCode.RIGHT) {
                var s = new Date();
                o.val(s.getFullYear().toString() + (s.getMonth() + 1).toString() + s.getDate().toString()),
                  o.trigger("setvalue");
              }
            },
          },
                ...
                validator: function (e, t, n, a, i) {
                  ...
                  if (
                    ...
                    return (
                      ...
                      (t.buffer[n] = e.charAt(0)),
                      n++,
                      { refreshFromBuffer: { start: n - 2, end: n }, pos: n, c: i.timeseparator }
                    );
                  if (r && "24" !== i.hourFormat && i.regex.hrs24.test(e)) {
                    ...
                    return (
                      ...
                      (o -= 12) < 10
                        ...
                        : ((t.buffer[n] = o.toString().charAt(1)), (t.buffer[n - 1] = o.toString().charAt(0))),
          ...
          numeric: {
            ...
            preValidation: function (t, a, i, r, o) {
              if ("-" === i || i === o.negationSymbol.front)
                return (
                  !0 === o.allowMinus &&
                  ((o.isNegative = o.isNegative === n || !o.isNegative), "" === t.join("") || { caret: a, dopost: !0 })
                );
            ...
            postValidation: function (a, i, r) {
              ...
              if (
                ...
                if (
                  ((p = p.split("")),
                  (!r.digitsOptional || (r.enforceDigitsOnBlur && "blur" === i.event)) && isFinite(r.digits))
                ) {
                ...
                if (!0 !== r.autoGroup || "" === r.groupSeparator || (u === r.radixPoint && i.pos === n && !i.dopost))
                  p = p.join("");
                else {
              ...
              if (
                ...
                if (u !== r.radixPoint && u !== r.negationSymbol.front && u !== r.negationSymbol.back)
                ...
                switch (a.type) {
                  ...
                  case "checkval":
                    ...
                    if (
                      ...
                      if (
                        ((s = o.onUnMask(i.join(""), n, e.extend({}, o, { unmaskAsNumber: !0 }))),
                        null !== o.min && s < o.min)
                      )
                        return (
                    ...
                    if (
                      ...
                      var c = a.buffer.join(""),
                        u = (c = (c = c.replace(
                          ...
                          ""
                        )).replace(new RegExp(t.escapeRegex(o.negationSymbol.back) + "$"), "")).split(o.radixPoint);
            ...
            onUnMask: function (e, n, a) {
              ...
              return (
                ...
                (i = i.replace(new RegExp(t.escapeRegex(a.groupSeparator), "g"), "")),
                "" !== a.placeholder.charAt(0) && (i = i.replace(new RegExp(a.placeholder.charAt(0), "g"), "0")),
                a.unmaskAsNumber
                  ? ("" !== a.radixPoint &&
                      -1 !== i.indexOf(a.radixPoint) &&
                      (i = i.replace(t.escapeRegex.call(this, a.radixPoint), ".")),
                    (i = i.replace(new RegExp("^" + t.escapeRegex(a.negationSymbol.front)), "-")),
                    (i = i.replace(new RegExp(t.escapeRegex(a.negationSymbol.back) + "$"), "")),
                    Number(i))
                  : i
              );
            },
            isComplete: function (e, n) {
              ...
              return (
                ...
                (i = i.replace(new RegExp(t.escapeRegex(n.groupSeparator), "g"), "")),
            ...
            onBeforeMask: function (e, a) {
              if (
                ...
                2 === i.length &&
                  (i[0].length > r || i[1].length > r || (i[0].length <= r && i[1].length < r)) &&
              ...
              if (
                ...
                if (parseInt(a.digits) < l.toString().length) {
                  ...
                  (e = e.replace(t.escapeRegex(a.radixPoint), ".")),
                    (e = (e = Math.round(parseFloat(e) * c) / c).toString().replace(".", a.radixPoint));
                }
              }
              return e;
            },
            canClearPosition: function (e, t, n, a, i) {
              var r = e.validPositions[t],
                o =
                  ...
                  (r.input === i.radixPoint && e.validPositions[t + 1] && null === e.validPositions[t + 1].match.fn) ||
                  isFinite(r.input) ||
                  t === n ||
              ...
              e.isArray(t[r])
                ? 1 === t[r].length
                  ...
                  : a.push(
                      r +
                        i.groupmarker.start +
                        t[r].join(i.groupmarker.end + i.alternatormarker + i.groupmarker.start) +
                        i.groupmarker.end
                    )
                : a.push(r + o(t[r]));
            return (
              1 === a.length
                ...
                : (n +=
                    i.groupmarker.start +
                    a.join(i.groupmarker.end + i.alternatormarker + i.groupmarker.start) +
                    i.groupmarker.end),
              n
            );
          }
          ...
          return (
            i.phoneCodes &&
              (i.phoneCodes &&
                ...
                (r((t = t.substr(1, t.length - 2)).split(i.groupmarker.end + i.alternatormarker + i.groupmarker.start)),
                (t = o(s))),
              (t = t.replace(/9/g, "\\9"))),
            a.call(this, t, n, i)
          );
        ...
        t.extendAliases({
          abstractphone: {
            ...
            onBeforeMask: function (e, t) {
              ...
              return (
                (n.indexOf(t.countrycode) > 1 || -1 === n.indexOf(t.countrycode)) && (n = "+" + t.countrycode + n), n
              );
            },
            onUnMask: function (e, t, n) {
              return e.replace(/[()#-]/g, "");
                        ...
                        switch ((t = e[0]).charAt(0)) {
                          ...
                          case "*":
                            ...
                            if (((i.quantifier = { min: l, max: u }), a.length > 0)) {
                              ...
                              (e = n.matches.pop()).isGroup || ((c = new o(!0)).matches.push(e), (e = c)),
                                n.matches.push(e),
                                n.matches.push(i);
                            break;
                          default:
