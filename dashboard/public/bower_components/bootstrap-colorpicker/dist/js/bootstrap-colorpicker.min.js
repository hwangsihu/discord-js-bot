...
!((a, b) => {
  ...
  (b.webColors = {
    ...
    (b.prototype = {
      ...
      _sanitizeNumber: (a) =>
        "number" == typeof a
          ...
          : isNaN(a) || null === a || "" === a || void 0 === a
            ...
            : "" === a
              ? 0
              : "undefined" != typeof a.toLowerCase
                ? (a.match(/^\./) && (a = "0" + a), Math.ceil(100 * Number.parseFloat(a)) / 100)
                : 1,
      isTransparent: (a) =>
        !(!a || !("string" == typeof a || a instanceof String)) &&
        ((a = a.toLowerCase().trim()),
        "transparent" === a || a.match(/#?00000000/) || a.match(/(rgba|hsla)\(0,0,0,0?\.?0\)/)),
      rgbaIsTransparent: (a) => 0 === a.r && 0 === a.g && 0 === a.b && 0 === a.a,
      setColor: function (a) {
        if ((a = a.toLowerCase().trim())) {
          if (this.isTransparent(a)) return (this.value = { h: 0, s: 0, b: 0, a: 0 }), !0;
          var b = this.parse(a);
          b
            ? ((this.value = this.value = { h: b.h, s: b.s, b: b.b, a: b.a }),
              this.origFormat || (this.origFormat = b.format))
      ...
      setAlpha: function (a) {
        this.value.a = Math.round((Number.parseInt(100 * (1 - a), 10) / 100) * 100) / 100;
      },
      toRGB: function (a, b, c, d) {
        0 === arguments.length &&
          ((a = this.value.h), (b = this.value.s), (c = this.value.b), (d = this.value.a)),
          (a *= 360);
        var e, f, g, h, i;
        return (
          (a = (a % 360) / 60),
          ...
          (f += [h, i, i, h, 0, 0][a]),
          (g += [0, 0, h, i, i, h][a]),
          { r: Math.round(255 * e), g: Math.round(255 * f), b: Math.round(255 * g), a: d }
        );
      },
      toHex: function (a, b, c, d, e) {
        arguments.length <= 1 &&
          ((b = this.value.h), (c = this.value.s), (d = this.value.b), (e = this.value.a));
        var f = "#",
        ...
        var h =
          ...
          (
            (1 << 24) +
            (Number.parseInt(g.r) << 16) +
            (Number.parseInt(g.g) << 8) +
            Number.parseInt(g.b)
          )
            .toString(16)
            .slice(1);
      ...
      toAlias: function (a, b, c, d) {
        var e,
          f = 0 === arguments.length ? this.toHex(!0) : this.toHex(!0, a, b, c, d),
      ...
      RGBtoHSB: function (a, b, c, d) {
        ...
        return (
          ...
          (h = g - Math.min(a, b, c)),
          (e =
            0 === h ? null : g === a ? (b - c) / h : g === b ? (c - a) / h + 2 : (a - b) / h + 4),
          (e = (((e + 360) % 6) * 60) / 360),
          (f = 0 === h ? 0 : h / g),
      ...
      parse: function (b) {
        ...
        return (
          ...
          a.each(this.stringParsers, (a, h) => {
            var i = h.re.exec(b);
            return (
              (c = i && h.parse.apply(this, [i])),
              !c ||
                ((f = {}),
                (d = g ? "alias" : h.format ? h.format : this.getValidFallbackFormat()),
                (f = d.match(/hsla?/)
                  ? this.RGBtoHSB.apply(this, this.HSLtoRGB.apply(this, c))
                  : this.RGBtoHSB.apply(this, c)),
      ...
      getValidFallbackFormat: function () {
        ...
        return this.origFormat && a.indexOf(this.origFormat) !== -1
          ? this.origFormat
          : this.fallbackFormat && a.indexOf(this.fallbackFormat) !== -1
            ? this.fallbackFormat
            : "rgba";
      },
        ...
        switch (c) {
          ...
          case "alias":
            return (
              (e = this.toAlias()),
              e === !1
                ? this.toString(a, this.getValidFallbackFormat())
                : d && !(e in b.webColors) && e in this.predefinedColors
                  ? this.predefinedColors[e]
                  : e
            );
          default:
            return e;
      ...
      stringParsers: [
        {
          ...
          format: "rgb",
          parse: (a) => [a[1], a[2], a[3], 1],
        },
        {
          re: /rgb\(\s*(\d*(?:\.\d+)?)\%\s*,\s*(\d*(?:\.\d+)?)\%\s*,\s*(\d*(?:\.\d+)?)\%\s*?\)/,
          format: "rgb",
          parse: (a) => [2.55 * a[1], 2.55 * a[2], 2.55 * a[3], 1],
        },
        {
          re: /rgba\(\s*(\d{1,3})\s*,\s*(\d{1,3})\s*,\s*(\d{1,3})\s*(?:,\s*(\d*(?:\.\d+)?)\s*)?\)/,
          format: "rgba",
          parse: (a) => [a[1], a[2], a[3], a[4]],
        },
        {
          re: /rgba\(\s*(\d*(?:\.\d+)?)\%\s*,\s*(\d*(?:\.\d+)?)\%\s*,\s*(\d*(?:\.\d+)?)\%\s*(?:,\s*(\d*(?:\.\d+)?)\s*)?\)/,
          format: "rgba",
          parse: (a) => [2.55 * a[1], 2.55 * a[2], 2.55 * a[3], a[4]],
        },
        {
          re: /hsl\(\s*(\d*(?:\.\d+)?)\s*,\s*(\d*(?:\.\d+)?)\%\s*,\s*(\d*(?:\.\d+)?)\%\s*?\)/,
          format: "hsl",
          parse: (a) => [a[1] / 360, a[2] / 100, a[3] / 100, a[4]],
        },
        {
        ...
        },
        {
          ...
          format: "hex",
          parse: (a) => [
            Number.parseInt(a[1] + a[1], 16),
            Number.parseInt(a[2] + a[2], 16),
            Number.parseInt(a[3] + a[3], 16),
            1,
          ],
        },
      ],
  ...
  var c = {
    ...
    d = function (b, d) {
      (this.element = a(b).addClass("colorpicker-element")),
        ...
        this.options.color !== !1 && (this.updateInput(this.color), this.updateData(this.color)),
        (this.disabled = !1);
      var e = (this.picker = a(this.options.template));
      if (
        (this.options.customClass && e.addClass(this.options.customClass),
        this.options.inline
          ? e.addClass("colorpicker-inline colorpicker-visible")
          : e.addClass("colorpicker-hidden"),
        ...
        g.length > 0 &&
          (a.each(this.options.colorSelectors, (b, c) => {
            var d = a("<i />")
            ...
            d.on("mousedown.colorpicker touchstart.colorpicker", function (b) {
              b.preventDefault(),
                f.setValue(
                  "alias" === f.format ? a(this).data("alias") : a(this).css("background-color")
                );
            }),
              g.append(d);
          }),
      ...
      e.on(
        ...
        e
          ...
          .on("mousedown.colorpicker touchstart.colorpicker", a.proxy(this.mousedown, this)),
        e.appendTo(this.container ? this.container : a("body")),
        this.input !== !1 &&
          (this.input.on({ "keyup.colorpicker": a.proxy(this.keyup, this) }),
          this.input.on({ "input.colorpicker": a.proxy(this.change, this) }),
          this.component === !1 &&
  ...
  (d.Color = b),
    (d.prototype = {
      ...
      show: function (b) {
        this.isDisabled() ||
          ...
          !b ||
            ...
            (b.stopPropagation && b.preventDefault && (b.stopPropagation(), b.preventDefault())),
          (!this.component && this.input) ||
            this.options.inline !== !1 ||
            a(window.document).on({ "mousedown.colorpicker": a.proxy(this.hide, this) }),
      ...
      hide: function (b) {
        return (
          ("undefined" == typeof b ||
            !b.target ||
            !(
              a(b.currentTarget).parents(".colorpicker").length > 0 ||
              a(b.target).parents(".colorpicker").length > 0
            )) &&
          (this.picker.addClass("colorpicker-hidden").removeClass("colorpicker-visible"),
          a(window).off("resize.colorpicker", this.reposition),
          a(window.document).off({ "mousedown.colorpicker": this.hide }),
          this.update(),
          void this.element.trigger({ type: "hidePicker", color: this.color }))
        );
      },
      ...
      updateInput: function (a) {
        return (
          (a = a || this.color.toString(!1, this.format)),
          this.input !== !1 && (this.input.prop("value", a), this.input.trigger("change")),
          a
        );
      },
        ...
        if (0 !== c.length)
          return (
            ...
            this.picker
              ...
              .css("backgroundColor", this.color.toHex(!0, this.color.value.h, 1, 1, 1)),
      ...
      updateComponent: function (a) {
        var b;
        if (
          ((b = "undefined" != typeof a ? this.createColor(a) : this.color), this.component !== !1)
        ) {
          var c = this.component.find("i").eq(0);
          c.length > 0
            ? c.css({ backgroundColor: b.toString(!0, this.format) })
            : this.component.css({ backgroundColor: b.toString(!0, this.format) });
        }
      ...
      setValue: function (a) {
        (this.color = this.createColor(a)),
          this.update(!0),
          this.element.trigger({ type: "changeColor", color: this.color, value: a });
      },
      ...
      disable: function () {
        return (
          ...
          (this.disabled = !0),
          this.element.trigger({ type: "disable", color: this.color, value: this.getValue() }),
          !0
        );
      },
      enable: function () {
        return (
          ...
          (this.disabled = !1),
          this.element.trigger({ type: "enable", color: this.color, value: this.getValue() }),
          !0
        );
      },
      currentSlider: null,
        ...
        var b = Math.max(
          ...
          c = Math.max(
            ...
            Math.min(
              ...
              this.currentSlider.top + ((a.pageY || this.mousePointer.top) - this.mousePointer.top)
            )
          );
        return (
          ...
          this.currentSlider.callTop &&
            this.color[this.currentSlider.callTop].call(this.color, c / this.currentSlider.maxTop),
          this.options.format !== !1 ||
