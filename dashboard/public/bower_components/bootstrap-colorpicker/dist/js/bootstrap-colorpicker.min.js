    ...
    (b.prototype = {
          ...
          : isNaN(a) || null === a || "" === a || void 0 === a
            ...
            : "" === a
              ...
              : "undefined" != typeof a.toLowerCase
                ? (a.match(/^\./) && (a = "0" + a), Math.ceil(100 * parseFloat(a)) / 100)
                : 1;
      },
      ...
      toString: function (a, c, d) {
        ...
        switch (c) {
          case "rgb":
            return (
              (e = this.toRGB()), this.rgbaIsTransparent(e) ? "transparent" : "rgb(" + e.r + "," + e.g + "," + e.b + ")"
            );
          case "rgba":
    ...
    d = function (b, d) {
      ...
      e.on(
        ...
        this.input !== !1 &&
          ...
          this.component === !1 && this.element.on({ "focus.colorpicker": a.proxy(this.show, this) }),
          this.options.inline === !1 && this.element.on({ "focusout.colorpicker": a.proxy(this.hide, this) })),
    ...
    (d.prototype = {
      ...
      hide: function (b) {
        return (
          ("undefined" == typeof b ||
            !b.target ||
            !(
              a(b.currentTarget).parents(".colorpicker").length > 0 || a(b.target).parents(".colorpicker").length > 0
            )) &&
      ...
      update: function (a) {
        ...
        return (
          (this.getValue(!1) === !1 && a !== !0) ||
            ((b = this.updateComponent()), this.updateInput(b), this.updateData(b), this.updatePicker()),
          b
        );
      },
      setValue: function (a) {
      ...
      mousedown: function (b) {
        !b.pageX &&
          ...
          ((b.pageX = b.originalEvent.touches[0].pageX), (b.pageY = b.originalEvent.touches[0].pageY)),
          b.stopPropagation(),
          b.preventDefault();
        var c = a(b.target),
          d = c.closest("div"),
      ...
      mousemove: function (a) {
        !a.pageX &&
          ...
          ((a.pageX = a.originalEvent.touches[0].pageX), (a.pageY = a.originalEvent.touches[0].pageY)),
          a.stopPropagation(),
          a.preventDefault();
        var b = Math.max(
            0,
            Math.min(
              ...
              this.currentSlider.left + ((a.pageX || this.mousePointer.left) - this.mousePointer.left)
            )
          ),
          c = Math.max(
            0,
        ...
        return (
          ...
          this.currentSlider.callLeft &&
            this.color[this.currentSlider.callLeft].call(this.color, b / this.currentSlider.maxLeft),
          this.currentSlider.callTop &&
            this.color[this.currentSlider.callTop].call(this.color, c / this.currentSlider.maxTop),
          this.options.format !== !1 ||
            ("setAlpha" !== this.currentSlider.callTop && "setAlpha" !== this.currentSlider.callLeft) ||
      ...
      keyup: function (a) {
        38 === a.keyCode
          ? (this.color.value.a < 1 && (this.color.value.a = Math.round(100 * (this.color.value.a + 0.01)) / 100),
            this.update(!0))
          : 40 === a.keyCode &&
            (this.color.value.a > 0 && (this.color.value.a = Math.round(100 * (this.color.value.a - 0.01)) / 100),
            this.update(!0)),
          this.element.trigger({ type: "changeColor", color: this.color, value: this.input.val() });
      },
    }),
