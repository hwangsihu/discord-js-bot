...
((h) => {
  "function" === typeof define && define.amd
    ? define(["jquery"], (E) => h(E, window, document))
  ...
  function ib(a, b, c, d, e, f) {
    var g,
      j = !1;
    c !== k && ((g = c), (j = !0));
    while (d !== e) a.hasOwnProperty(d) && ((g = j ? b(g, a[d], d, a) : a[d]), (j = !0), (d += f));
    return g;
  }
  function Ea(a, b) {
  ...
  function ka(a, b, c) {
    ...
    var g = b.mData,
      ...
      c = (a) => "string" === typeof a && -1 !== a.indexOf("@");
  ...
  function Ja(a) {
    return h.map(a.match(/(\\.|[^\.])+/g) || [""], (a) => a.replace(/\\\./g, "."));
  }
  function S(a) {
  ...
  function da(a, b, c, d) {
    var e = a.aoData[b],
      f,
      g = (c, d) => {
        while (c.childNodes.length) c.removeChild(c.firstChild);
  ...
  function fa(a, b, c) {
    ...
    if (b) {
      ...
      for (e = g.length; d < e; d++) {
        if ((a = g[d].nTr)) while ((f = a.firstChild)) a.removeChild(f);
        f = 0;
        for (b = g[d].length; f < b; f++)
          if (((m = i = 1), j[d][f] === k)) {
            a.appendChild(g[d][f].cell);
            for (j[d][f] = 1; g[d + i] !== k && g[d][f].cell == g[d + i][f].cell; ) (j[d + i][f] = 1), i++;
            while (g[d][f + m] !== k && g[d][f].cell == g[d][f + m].cell) {
  ...
  function wb(a, b) {
    ...
    oa(a);
    a._iRecordsTotal = Number.parseInt(e, 10);
    a._iRecordsDisplay = Number.parseInt(f, 10);
    d = 0;
  ...
  function qb(a) {
    var b = a.oClasses,
      ...
      b = h("<div/>", { id: f.f ? null : c + "_filter", class: b.sFilter }).append(h("<label/>").append(j)),
      f = function () {
    ...
    h(a.nTable).on("search.dt.DT", (b, c) => {
      if (a === c)
        try {
  ...
  function tb(a) {
    var b = a.sTableId,
      c = a.aanFeatures.i,
      d = h("<div/>", { class: a.oClasses.sInfo, id: c ? null  : b + "_info" });
    c ||
  ...
  function pb(a) {
    ...
    h(a.nTable).on("length.dt.DT", (b, c, d) => {
  ...
  function rb(a) {
    return h("<div/>", { id: a.aanFeatures.r ? null : a.sTableId + "_processing", class: a.oClasses.sProcessing })
    ...
    i = h("<div/>", { class: f.sScrollWrapper })
      .append(
        h("<div/>", { class: f.sScrollHead })
          .css({ overflow: "hidden", position: "relative", border: 0, width: d ? (d ? v(d) : null) : "100%" })
          .append(
      ...
      .append(
        h("<div/>", { class: f.sScrollBody })
          .css({ position: "relative", overflow: "auto", width: d ? v(d)  : null })
          .append(b)
      );
    l &&
      i.append(
        h("<div/>", { class: f.sScrollFoot })
          .css({ overflow: "hidden", border: 0, width: d ? (d ? v(d) : null) : "100%" })
          .append(
  ...
  function xa(a) {
    if (a.oFeatures.bStateSave && !a.bDestroying) {
      var b = {
        ...
        columns: h.map(a.aoColumns, (b, d) => ({ visible: b.bVisible, search: Bb(a.aoPreSearchCols[d]) })),
      };
  ...
  function r(a, b, c, d) {
    var e = [];
    b &&
      (e = h.map(a[b].slice().reverse(), (b) => b.fn.apply(a.oInstance, d)));
    ...
    h.each(
      {
        num: (b) => za(b, a),
        "num-fmt": (b) => za(b, a, Ya),
        "html-num": (b) => za(b, a, Aa),
        "html-num-fmt": (b) => za(b, a, Aa, Ya),
      },
      (b, c) => {
  ...
  var n = function (a) {
      ...
      this.each(function () {
        ...
        if ("table" != this.nodeName.toLowerCase())
          ...
          jb(p, g.aoColumnDefs, t, (a, b) => {
            ka(p, a, b);
          });
          if (x.length) {
            var w = (a, b) => a.getAttribute("data-" + b) !== null ? b : null;
            h(x[0])
              .children("th, td")
              .each((a, b) => {
                var c = p.aoColumns[a];
    ...
    $a = (a, b, c) => 
      ...
      b && d && (a = Pb(a, b));
      c && d && (a = a.replace(Ya, ""));
      return !isNaN(Number.parseFloat(a)) && isFinite(a);,
    Qb = (a, b, c) => M(a) ? !0 : (M(a) || "string" === typeof a) ? $a(a.replace(Aa, ""), b, c) ? !0 : null : null,
    D = (a, b, c) => 
      var d = [],
        e = 0,
        f = a.length;
    ...
    Ba = (a, b) => {
      ...
      if ("current" == d) {
        ...
        if ("none" == j) f = e.slice();
            ...
            f = h.map(e, (a) => i.hasOwnProperty(a) ? null : a);
          }
  ...
  o("row.add()", function (a) {
    ...
    var b = this.iterator("table", (b) => a.nodeName && "TR" === a.nodeName.toUpperCase() ? na(b, a)[0] : O(b, a));
    return this.row(b[0]);
  });
  var db = (a, b) => {
      var c = a.context;
        ...
        (c) => {
          ...
          return ab(
            ...
            (a) => {
              ...
              if (typeof a === "function") {
                var e = Ba(c, f);
                return h.map(g, (b, f) => a(f, Vb(c, f, 0, 0, e), i[f]) ? f : null);
              }
              ...
              if (k)
                switch (k[2]) {
                  case "visIdx":
                  case "visible":
                    b = Number.parseInt(k[1], 10);
                    if (b < 0) {
                      var n = h.map(g, (a, b) => a.bVisible ? b : null);
                      return [n[n.length + b]];
                    }
                    return [aa(c, b)];
                  case "name":
                    return h.map(j, (a, b) => a === k[1] ? b : null);
                  default:
                    return [];
                }
  ...
  u("columns().cache()", "column().cache()", function (a) {
    return this.iterator(
      "column-rows",
      (b, c, d, e, f) => ja(b.aoData, f, "search" === a ? "_aFilterData" : "_aSortData", c),
      1
    );
  });
  u("columns().nodes()", "column().nodes()", function () {
    return this.iterator(
      "column-rows",
      (a, b, c, d, e) => ja(a.aoData, e, "anCells", b),
      1
    );
  });
  u("columns().visible()", "column().visible()", function (a, b) {
    var c = this.iterator("column", (b, c) => {
      ...
      return this.iterator("table", (b) => {
        ...
        return ab(
          ...
          (a) => {
            ...
            c = i
              .filter(a)
              .map((a, b) => ({ row: b._DT_CellIndex.row, column: b._DT_CellIndex.column }))
              .toArray();
  ...
  u("cells().nodes()", "cell().node()", function () {
    return this.iterator(
      "cell",
      (a, b, c) => (a = a.aoData[b]) && a.anCells ? a.anCells[c] : k,
      1
    );
  });
  ...
  u("cells().indexes()", "cell().index()", function () {
    return this.iterator(
      "cell",
      (a, b, c) => ({ row: b, column: c, columnVisible: ba(a, c) }),
      1
    );
  });
  u("cells().invalidate()", "cell().invalidate()", function (a) {
    return this.iterator("cell", (b, c, d) => {
      da(b, c, a, d);
    });
  });
  ...
  o(["columns().order()", "column().order()"], function (a) {
    return this.iterator("table", (c, d) => {
      var e = [];
      h.each(this[d], (b, c) => {
        e.push([c, a]);
      });
  ...
  u("columns().search()", "column().search()", function (a, b, c, d) {
    return this.iterator("column", (e, f) => {
  ...
  n.versionCheck = n.fnVersionCheck = (a) => {
    for (var b = n.version.split("."), a = a.split("."), c, d, e = 0, f = a.length; e < f; e++)
      if (((c = Number.parseInt(b[e], 10) || 0), (d = Number.parseInt(a[e], 10) || 0), c !== d)) return c > d;
    return !0;
  };
  n.isDataTable = n.fnIsDataTable = (a) => {
    var b = h(a).get(0),
      c = !1;
    if (a instanceof n.Api) return !0;
    h.each(n.settings, (a, e) => {
  ...
  n.tables = n.fnTables = (a) => {
    var b = !1;
    h.isPlainObject(a) && ((b = a.api), (a = a.visible));
    var c = h.map(n.settings, (b) => {
  ...
  h.each(["on", "one", "off"], (a, b) => {
    o(b + "()", function () {
      var a = Array.prototype.slice.call(arguments);
      a[0] = h
        .map(a[0].split(/\s/), (a) => a.match(/\.dt\b/) ? a : a + ".dt")
        .join(" ");
  ...
  o("data()", function () {
    return this.iterator("table", (a) => D(a.aoData, "_aData")).flatten();
  });
  ...
  h.each(["column", "row", "cell"], (a, b) => {
    o(b + "s().every()", function (a) {
      var d = this.selector.opts;
      return this.iterator(b, (f, g, h, i, m) => {
        a.call(this[b](g, "cell" === b ? h : d, "cell" === b ? d : k), g, h, i, m);
      });
    });
  });
  ...
  h.extend(Lb, {
    ...
    numbers: (a, b) => [ia(a, b)],
    simple_numbers: (a, b) => ["previous", ia(a, b), "next"],
    full_numbers: (a, b) => ["first", "previous", ia(a, b), "next", "last"],
    first_last_numbers: (a, b) => ["first", ia(a, b), "last"],
    _numbers: ia,
    numbers_length: 7,
  });
  ...
  h.extend(n.ext.type.detect, [
    ...
    (a) => M(a) || ("string" === typeof a && -1 !== a.indexOf("<")) ? "html" : null,
  ]);
  h.extend(n.ext.type.search, {
    html: (a) => M(a) ? a : "string" === typeof a ? a.replace(Nb, " ").replace(Aa, "") : "",
    string: (a) => M(a) ? a : "string" === typeof a ? a.replace(Nb, " ") : a,
  });
  var za = (a, b, c, d) => {
    if (0 !== a && (!a || "-" === a)) return Number.NEGATIVE_INFINITY;
    b && (a = Pb(a, b));
  ...
  h.extend(x.type.order, {
    ...
    "html-pre": (a) => M(a) ? "" : a.replace ? a.replace(/<.*?>/g, "").toLowerCase() : a + "",
    "string-pre": (a) => M(a) ? "" : "string" === typeof a ? a.toLowerCase() : a.toString ? a.toString() : "",
    "string-asc": (a, b) => a < b ? -1 : a > b ? 1 : 0,
    "string-desc": (a, b) => a < b ? 1 : a > b ? -1 : 0,
  });
  Da("");
  h.extend(!0, n.ext.renderer, {
    header: {
  ...
  var eb = (a) => "string" === typeof a ? a.replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;") : a;
  n.render = {
    number: (a, b, c, d, e) => ({
        display: (f) => {
          if ("number" !== typeof f && "string" !== typeof f) return f;
          var g = 0 > f ? "-" : "",
            h = Number.parseFloat(f);
          if (isNaN(h)) return eb(f);
          h = h.toFixed(c);
          f = Math.abs(h);
          h = Number.parseInt(f, 10);
          f = c ? b + (f - h).toFixed(c).substring(2) : "";
          return g + (d || "") + h.toString().replace(/\B(?=(\d{3})+(?!\d))/g, a) + f + (e || "");
        },
      }),
    text: () => ({ display: eb, filter: eb }),
  };
  h.extend(n.ext.internal, {
    ...
    _fnAddData: O,
    _fnAddTr: na,
    _fnNodeToDataIndex: (a, b) => b._DT_RowIndex !== k ? b._DT_RowIndex : null,
    _fnNodeToColumnIndex: (a, b, c) => h.inArray(c, a.aoData[b].anCells),
    _fnGetCellData: B,
    _fnSetCellData: kb,
