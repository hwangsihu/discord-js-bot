...
((ga) => {
  ...
  function Y(b, c, d, g) {
    c &&
      D(c, (c, e) => {
        if (d || !x(b, e))
          !g || "object" !== typeof c || !c || L(c) || K(c) || c instanceof RegExp
            ? (b[e] = c)
            : (b[e] || (b[e] = {}), Y(b[e], c, d, g));
      });
    return b;
  ...
  function ma(b) {
    ...
    function d(a) {
      E &&
        y(document.getElementsByTagName("script"), (n) => {
          if (
    ...
    var aa,
      ...
      T = 1;
    R = {
      require: (a) => (a.require ? a.require : (a.require = l.makeRequire(a.map))),
      exports: (a) => {
        a.usingExports = !0;
        if (a.map.isDefine)
          ...
          if (!this.inited) x(l.defQueueMap, c) || this.fetch();
            ...
            if (1 > this.depCount && !this.defined) {
              if (K(k)) {
                ...
                this.map.isDefine &&
                  void 0 === h &&
                  ((b = this.module) ? (h = b.exports) : this.usingExports && (h = this.exports));
                if (a)
                  return (
        ...
        w(
          ...
          z(this, function (h) {
            ...
            if (this.map.unnormalized) {
              if (
                (h.normalize && (M = h.normalize(M, (a) => c(a, r, !0)) || ""),
                ...
                w(
                  ...
                  z(this, function (a) {
                    ...
                    this.init([], () => a, null, { enabled: !0, ignore: !0 });
                  })
                ),
                (h = e(t, f.id)))
              ) {
                ...
                : ((k = z(this, function (a) {
                  ...
                  (k.fromText = z(this, function (h, c) {
                    ...
                    try {
                      ...
                      return A(
                        F("fromtexteval", "fromText eval for " + b + " failed: " + e, e, [b])
                      );
                    }
                    M && (S = !0);
                    this.depMaps.push(f);
  ...
  function pa() {
    ...
    X(document.getElementsByTagName("script"), (b) => {
  ...
  if ("undefined" === typeof define) {
    ...
    g({});
    y(["toUrl", "undef", "defined", "specified"], (b) => {
      g[b] = () => {
        var c = J._;
    ...
    g.load = (b, c, d) => {
      ...
      if (ja)
        try {
          setTimeout(() => {}, 0), importScripts(d), b.completeLoad(c);
        } catch (q) {
