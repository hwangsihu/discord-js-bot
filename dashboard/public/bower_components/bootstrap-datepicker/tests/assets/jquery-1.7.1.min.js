              ...
              if ((a = arguments[j]) != null)
                for (c in a) {
                  ...
                  l && f && (e.isPlainObject(f) || (g = e.isArray(f)))
                    ? (g ? ((g = !1), (h = d && e.isArray(d) ? d : [])) : (h = d && e.isPlainObject(d) ? d : {}),
                      (i[c] = e.extend(l, h, f)))
                    : f !== b && (i[c] = f);
                }
            return i;
        ...
        e.extend({
          ...
          map: function (a, c, d) {
            var f,
              ...
              k =
                a instanceof e ||
                (j !== b && typeof j == "number" && ((j > 0 && a[0] && a[j - 1]) || j === 0 || e.isArray(a)));
  ...
  f.Callbacks = function (a) {
    ...
    var c = [],
      ...
      n = function (b, f) {
        ...
        (i = !1),
          c &&
            (a.once ? (e === !0 ? o.disable() : (c = [])) : d && d.length && ((e = d.shift()), o.fireWith(e[0], e[1])));
      },
      o = {
        add: function () {
          if (c) {
      ...
      !q.addEventListener &&
        ...
        a.getComputedStyle &&
          ...
          (b.reliableMarginRight =
            (parseInt((a.getComputedStyle(j, null) || { marginRight: 0 }).marginRight, 10) || 0) === 0));
      if (q.attachEvent)
      ...
      promise: function (a, c) {
        ...
        while (g--)
          if (
            (l =
              f.data(e[g], i, b, !0) ||
              ((f.data(e[g], j, b, !0) || f.data(e[g], k, b, !0)) && f.data(e[g], i, f.Callbacks("once memory"), !0)))
          )
            h++, l.add(m);
        m();
        return d.promise();
        ...
        h.promise(v),
          ...
          d.crossDomain == null &&
            ...
            (d.crossDomain = !(
              ...
              (r[1] == bW[1] &&
                r[2] == bW[2] &&
                (r[3] || (r[1] === "http:" ? 80 : 443)) == (bW[3] || (bW[1] === "http:" ? 80 : 443)))
            ))),
    ...
    f.ajaxPrefilter("json jsonp", function (b, c, d) {
      ...
      if (b.dataTypes[0] === "jsonp" || (b.jsonp !== !1 && (ce.test(b.url) || (e && ce.test(b.data))))) {
        ...
        b.jsonp !== !1 &&
          ((j = j.replace(ce, l)),
          b.url === j &&
            (e && (k = k.replace(ce, l)), b.data === k && (j += (/\?/.test(j) ? "&" : "?") + b.jsonp + "=" + h))),
          (b.url = j),
          (b.data = k),
          (a[h] = function (a) {
            g = [a];
            ...
            send: function (e, g) {
              ...
              h.send((c.hasContent && c.data) || null),
                ...
                !c.async || h.readyState === 4
                  ? d()
                  : ((i = ++cg), cf && (ch || ((ch = {}), f(a).unload(cf)), (ch[i] = d)), (h.onreadystatechange = d));
            },
            abort: function () {
              d && d(0, 1);
            },
              ...
              : ((k = co.exec(h)),
                ...
                k
                  ? ((m = parseFloat(k[2])),
                    ...
                    n !== "px" &&
                      (f.style(this, i, (m || 1) + n), (l = ((m || 1) / j.cur()) * l), f.style(this, i, l + n)),
                    k[1] && (m = (k[1] === "-=" ? -1 : 1) * m + l),
                    j.custom(l, m, n))
                  : j.custom(l, h, ""));
        return !0;
