...
((a, b) => {
  ...
  function bC(a, b, c) {
    ...
    if (d > 0) {
      if (c !== "border")
        for (; g < h; g++)
          c || (d -= Number.parseFloat(f.css(a, "padding" + e[g])) || 0),
            c === "margin"
              ? (d += Number.parseFloat(f.css(a, c + e[g])) || 0)
              : (d -= Number.parseFloat(f.css(a, "border" + e[g] + "Width")) || 0);
      return d + "px";
    }
    d = bz(a, b, b);
    ...
    if (c)
      for (; g < h; g++)
        (d += Number.parseFloat(f.css(a, "padding" + e[g])) || 0),
          c !== "padding" && (d += Number.parseFloat(f.css(a, "border" + e[g] + "Width")) || 0),
          c === "margin" && (d += Number.parseFloat(f.css(a, c + e[g])) || 0);
    return d + "px";
  }
  function bp(a, b) {
    b.src
  ...
  function T(a, b, c) {
    ...
    if (b.nodeType) return f.grep(a, (a, d) => (a === b) === c);
    if (typeof b == "string") {
      var d = f.grep(a, (a) => a.nodeType === 1);
      if (O.test(b)) return f.filter(b, d, !c);
      b = f.filter(b, d);
    }
    return f.grep(a, (a, d) => f.inArray(a, b) >= 0 === c);
  }
  function S(a) {
      ...
      (e.fn = e.prototype =
        {
          ...
          map: function (a) {
            return this.pushStack(e.map(this, (b, c) => a.call(b, c, b)));
          },
          end: function () {
        ...
        e.extend({
          ...
          isFunction: (a) => e.type(a) === "function",
          isArray: Array.isArray || ((a) => e.type(a) === "array"),
          isWindow: (a) => a && typeof a == "object" && "setInterval" in a,
          isNumeric: (a) => !isNaN(Number.parseFloat(a)) && isFinite(a),
          type: (a) => (a == null ? String(a) : I[C.call(a)] || "object"),
          isPlainObject: (a) => {
          ...
          camelCase: (a) => a.replace(w, "ms-").replace(v, x),
          nodeName: (a, b) => a.nodeName && a.nodeName.toUpperCase() === b.toUpperCase(),
          each: (a, c, d) => {
            var f,
              g = 0,
              h = a.length,
            ...
            if (d) {
              ...
              } else while (g < h) if (c.apply(a[g++], d) === !1) break;
            } else if (i) {
              for (f in a) if (c.call(a[f], f, a[f]) === !1) break;
            } else while (g < h) if (c.call(a[g], g, a[g++]) === !1) break;
            return a;
          },
          trim: G
            ? (a) => (a == null ? "" : G.call(a))
            : (a) => (a == null ? "" : (a + "").replace(k, "").replace(l, "")),
          makeArray: (a, b) => {
            var c = b || [];
            if (a != null) {
              var d = e.type(a);
          ...
          proxy: (a, c) => {
            ...
            var f = F.call(arguments, 2),
              g = () => a.apply(c, f.concat(F.call(arguments)));
      ...
      !q.addEventListener &&
        ...
        a.getComputedStyle &&
          ...
          (b.reliableMarginRight =
            (Number.parseInt((a.getComputedStyle(j, null) || { marginRight: 0 }).marginRight, 10) ||
              0) === 0));
      if (q.attachEvent)
      ...
      promise: function (a, c) {
        ...
        while (g--)
          if (
            (l =
              f.data(this[g], i, b, !0) ||
              ((f.data(this[g], j, b, !0) || f.data(this[g], k, b, !0)) &&
                f.data(this[g], i, f.Callbacks("once memory"), !0)))
          )
            h++, l.add(m);
        m();
        return d.promise();
  ...
  f.fn.extend({
          ...
          if (this.nodeType === 1) {
            e ? (h = a.call(this, d, g.val())) : (h = a),
              h == null
                ...
                : typeof h == "number"
                  ? (h += "")
                  : f.isArray(h) && (h = f.map(h, (a) => (a == null ? "" : a + ""))),
    ...
    f.support.hrefNormalized ||
      f.each(["href", "src", "width", "height"], (a, c) => {
    ...
    f.support.style ||
      (f.attrHooks.style = {
        get: (a) => a.style.cssText.toLowerCase() || b,
        set: (a, b) => (a.style.cssText = "" + b),
      }),
    ...
    f.support.checkOn ||
      f.each(["radio", "checkbox"], function () {
        f.valHooks[this] = {
          get: (a) => (a.getAttribute("value") === null ? "on" : a.value),
        };
      }),
    f.each(["radio", "checkbox"], function () {
  ...
  var z = /^(?:textarea|input|select)$/i,
    ...
    I = (a) => (f.event.special.hover ? a : a.replace(B, "mouseenter$1 mouseleave$1"));
  (f.event = {
    add: (a, c, d, e, g) => {
      ...
      if (!(a.nodeType === 3 || a.nodeType === 8 || !c || !d || !(h = f._data(a)))) {
        d.handler && ((p = d), (d = p.handler)),
          ...
          i ||
            ((h.handle = i =
              (a) =>
                typeof f != "undefined" && (!a || f.event.triggered !== a.type)
    ...
    f.each({ mouseenter: "mouseover", mouseleave: "mouseout" }, (a, b) => {
      f.event.special[a] = {
        delegateType: b,
        bindType: b,
        handle: function (a) {
    ...
    f.support.focusinBubbles ||
      f.each({ focus: "focusin", blur: "focusout" }, (a, b) => {
        var d = 0,
          e = (a) => {
    ...
    (() => {
      ...
      (m.uniqueSort = (a) => {
        ...
        (m.matches = (a, b) => m(a, null, null, b)),
        (m.matchesSelector = (a, b) => m(b, null, null, [a]).length > 0),
        (m.find = (a, b, c) => {
          var d, e, f, g, h, i;
          if (!a) return [];
      ...
      var n = (m.getText = (a) => {
        ...
        o = (m.selectors = {
          ...
          preFilter: {
            ...
            ID: (a) => a[1].replace(j, ""),
            TAG: (a, b) => a[1].replace(j, "").toLowerCase(),
            CHILD: (a) => {
              if (a[1] === "nth") {
          ...
          filters: {
            enabled: (a) => a.disabled === !1 && a.type !== "hidden",
            disabled: (a) => a.disabled === !0,
            checked: (a) => a.checked === !0,
            selected: (a) => {
              a.parentNode && a.parentNode.selectedIndex;
              return a.selected === !0;
            },
            parent: (a) => !!a.firstChild,
            empty: (a) => !a.firstChild,
            has: (a, b, c) => !!m(c[3], a).length,
            header: (a) => /h\d/i.test(a.nodeName),
            text: (a) => {
            ...
            radio: (a) => a.nodeName.toLowerCase() === "input" && "radio" === a.type,
            checkbox: (a) => a.nodeName.toLowerCase() === "input" && "checkbox" === a.type,
            file: (a) => a.nodeName.toLowerCase() === "input" && "file" === a.type,
            password: (a) => a.nodeName.toLowerCase() === "input" && "password" === a.type,
            submit: (a) => {
              var b = a.nodeName.toLowerCase();
              return (b === "input" || b === "button") && "submit" === a.type;
            },
            image: (a) => a.nodeName.toLowerCase() === "input" && "image" === a.type,
            reset: (a) => {
              var b = a.nodeName.toLowerCase();
            ...
            input: (a) => /input|select|textarea|button/i.test(a.nodeName),
            focus: (a) => a === a.ownerDocument.activeElement,
          },
          setFilters: {
            first: (a, b) => b === 0,
            last: (a, b, c, d) => b === d.length - 1,
            even: (a, b) => b % 2 === 0,
            odd: (a, b) => b % 2 === 1,
            lt: (a, b, c) => b < c[3] - 0,
            gt: (a, b, c) => b > c[3] - 0,
          ...
          filter: {
            ...
            ID: (a, b) => a.nodeType === 1 && a.getAttribute("id") === b,
            TAG: (a, b) =>
              (b === "*" && a.nodeType === 1) || (!!a.nodeName && a.nodeName.toLowerCase() === b),
            CLASS: (a, b) => (" " + (a.className || a.getAttribute("class")) + " ").indexOf(b) > -1,
            ATTR: (a, b) => {
              var c = b[1],
                d = m.attr
                  ? m.attr(a, c)
      ...
      c.documentElement.compareDocumentPosition
        ...
        (() => {
          ...
          a.appendChild(c.createComment("")),
            ...
            a.firstChild &&
              ...
              (o.attrHandle.href = (a) => a.getAttribute("href", 2)),
            (a = null);
        })(),
        c.querySelectorAll &&
          (() => {
        ...
        c.documentElement.contains
          ? (m.contains = (a, b) => a !== b && (a.contains ? a.contains(b) : !0))
          : c.documentElement.compareDocumentPosition
            ? (m.contains = (a, b) => !!(a.compareDocumentPosition(b) & 16))
            : (m.contains = () => !1),
        (m.isXML = (a) => {
    ...
    f.each(
      {
        ...
        parents: (a) => f.dir(a, "parentNode"),
        parentsUntil: (a, b, c) => f.dir(a, "parentNode", c),
        next: (a) => f.nth(a, 2, "nextSibling"),
        prev: (a) => f.nth(a, 2, "previousSibling"),
        nextAll: (a) => f.dir(a, "nextSibling"),
        prevAll: (a) => f.dir(a, "previousSibling"),
        nextUntil: (a, b, c) => f.dir(a, "nextSibling", c),
        prevUntil: (a, b, c) => f.dir(a, "previousSibling", c),
        siblings: (a) => f.sibling(a.parentNode.firstChild, a),
        children: (a) => f.sibling(a.firstChild),
        contents: (a) =>
          f.nodeName(a, "iframe")
  ...
  (f.fn.css = function (a, c) {
    ...
    return f.access(this, a, c, !0, (a, c, d) => (d !== b ? f.style(a, c, d) : f.css(a, c)));
  }),
    f.extend({
      cssHooks: {
        opacity: {
      ...
      style: (a, c, d, e) => {
        if (!!a && a.nodeType !== 3 && a.nodeType !== 8 && !!a.style) {
          ...
          (h = typeof d),
            h === "string" &&
              (g = bv.exec(d)) &&
              ((d = +(g[1] + 1) * +g[2] + Number.parseFloat(f.css(a, c))), (h = "number"));
    ...
    f.support.opacity ||
      (f.cssHooks.opacity = {
        get: (a, b) =>
          br.test((b && a.currentStyle ? a.currentStyle.filter : a.style.filter) || "")
    ...
    f.expr &&
      ...
      (f.expr.filters.visible = (a) => !f.expr.filters.hidden(a)));
  var bD = /%20/g,
    bE = /\[\]$/,
    bF = /\r?\n/g,
    bG = /#.*$/,
  ...
  (bW = bR.exec(bV.toLowerCase()) || []),
          ...
          complete: (a, b, c) => {
            (c = a.responseText),
              a.isResolved() &&
                ...
                this.html(g ? f("<div>").append(c.replace(bN, "")).find(g) : c)),
              d && this.each(d, [c, b, a]);
          },
        });
        return this;
        ...
        return this.map(function () {
          ...
          .map(function (a, b) {
            ...
            return c == null
              ? null
              : f.isArray(c)
                ? f.map(c, (a, c) => ({ name: b.name, value: a.replace(bF, "\r\n") }))
    ...
    f.extend({
      getScript: (a, c) => f.get(a, b, c, "script"),
      getJSON: (a, b, c) => f.get(a, b, c, "json"),
      ajaxSetup: (a, b) => {
      ...
      ajax: (a, c) => {
        ...
        var d = f.ajaxSetup({}, c),
          ...
          v = {
            ...
            getAllResponseHeaders: () => (s === 2 ? n : null),
            getResponseHeader: (a) => {
              var c;
              if (s === 2) {
                if (!o) {
  ...
  f.fn.extend({
    ...
    f.extend({
      ...
      easing: {
        linear: (a, b, c, d) => c + d * a,
        swing: (a, b, c, d) => (-Math.cos(a * Math.PI) / 2 + 0.5) * d + c,
      },
      timers: [],
      fx: function (a, b, c) {
    ...
    (f.fx.prototype = {
      ...
      cur: function () {
        ...
        return isNaN((a = Number.parseFloat(b))) ? (!b || b === "auto" ? 0 : b) : a;
      },
      custom: function (a, c, d) {
        ...
        (this.startTime = cr || cs()),
          ...
          (h.saveState = () => {
            this.options.hide &&
              f._data(this.elem, "fxshow" + this.prop) === b &&
              f._data(this.elem, "fxshow" + this.prop, this.start);
          }),
      ...
      step: function (a) {
        ...
        i.duration == Number.POSITIVE_INFINITY
          ? (this.now = e)
          : ((c = e - this.startTime),
    ...
    f.expr &&
      f.expr.filters &&
      (f.expr.filters.animated = (a) => f.grep(f.timers, (b) => a === b.elem).length);
  var cw = /^t(?:able|d|h)$/i,
    cx = /^(?:body|html)$/i;
  "getBoundingClientRect" in c.documentElement
          ...
          (c = j ? j.getComputedStyle(b, null) : b.currentStyle),
            ...
            b === d &&
              ...
              f.support.doesNotAddBorder &&
                ...
                ((l += Number.parseFloat(c.borderTopWidth) || 0),
                (m += Number.parseFloat(c.borderLeftWidth) || 0)),
              (e = d),
              (d = b.offsetParent)),
    ...
    (f.offset = {
      bodyOffset: (a) => {
        ...
        f.support.doesNotIncludeMarginInBodyOffset &&
          ((b += Number.parseFloat(f.css(a, "marginTop")) || 0),
          (c += Number.parseFloat(f.css(a, "marginLeft")) || 0));
        return { top: b, left: c };
      },
      setOffset: (a, b, c) => {
        ...
        j
          ...
          : ((m = Number.parseFloat(h) || 0), (n = Number.parseFloat(i) || 0)),
    ...
    f.fn.extend({
      position: function () {
        ...
        (c.top -= Number.parseFloat(f.css(a, "marginTop")) || 0),
          (c.left -= Number.parseFloat(f.css(a, "marginLeft")) || 0),
          (d.top += Number.parseFloat(f.css(b[0], "borderTopWidth")) || 0),
          (d.left += Number.parseFloat(f.css(b[0], "borderLeftWidth")) || 0);
    ...
    f.each(["Height", "Width"], (a, c) => {
      var d = c.toLowerCase();
      (f.fn["inner" + c] = function () {
        var a = this[0];
        return a ? (a.style ? Number.parseFloat(f.css(a, d, "padding")) : this[d]()) : null;
      }),
        (f.fn["outer" + c] = function (a) {
          var b = this[0];
          return b
            ? b.style
              ? Number.parseFloat(f.css(b, d, a ? "margin" : "border"))
              : this[d]()
            : null;
        }),
        (f.fn[d] = function (a) {
    ...
    (a.jQuery = a.$ = f),
    typeof define == "function" && define.amd && define.amd.jQuery && define("jquery", [], () => f);
})(window);
