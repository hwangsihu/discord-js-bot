  ...
  k.prototype = {
    ...
    _process_options: function (b) {
      ...
      q[f] || ((f = f.split("-")[0]), q[f] || (f = o.language)),
        ...
        e.multidate !== !0 &&
          ((e.multidate = Number(e.multidate) || !1), e.multidate !== !1 && (e.multidate = Math.max(0, e.multidate))),
    ...
    _utc_to_local: function (a) {
      ...
      return (
        b.getTimezoneOffset() !== a.getTimezoneOffset() && (b = new Date(a.getTime() + 6e4 * b.getTimezoneOffset())), b
      );
    },
          ...
          (b = 37 === a.keyCode || 38 === a.keyCode ? -1 : 1),
            0 === this.viewMode
              ...
              : 1 === this.viewMode
                ...
                : 2 === this.viewMode &&
                  ((38 !== a.keyCode && 40 !== a.keyCode) || (b *= 4), (c = this.moveAvailableDate(e, b, "moveYear"))),
