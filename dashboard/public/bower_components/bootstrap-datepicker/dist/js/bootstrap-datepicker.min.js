...
!((a) => {
  ...
  k.prototype = {
    ...
    _resolveDaysOfWeek: (b) => (a.isArray(b) || (b = b.split(/[,\s]*/)), a.map(b, Number)),
    _check_template: (c) => {
      try {
        if (c === b || "" === c) return !1;
    ...
    _local_to_utc: (a) => a && new Date(a.getTime() - 6e4 * a.getTimezoneOffset()),
    _zero_time: (a) => a && new Date(a.getFullYear(), a.getMonth(), a.getDate()),
    _zero_utc_time: (a) => a && c(a.getUTCFullYear(), a.getUTCMonth(), a.getUTCDate()),
    getDates: function () {
    ...
    getFormattedDate: function (c) {
      ...
      return a.map(this.dates, (a) => r.formatDate(a, c, d)).join(this.o.multidateSeparator);
    },
    ...
    place: function () {
      ...
      if (
        ...
        "top" === q ? (o -= c + Number.parseInt(this.picker.css("padding-top"))) : (o += l),
        this.o.rtl)
      ) {
        var r = f - (n + m);
    ...
    setRange: function (b) {
      b && b.length ? (this.range = a.map(b, (a) => a.valueOf())) : delete this.range, this.fill();
    },
      ...
      if (!isNaN(g) && !isNaN(h)) {
        this.picker
          ...
          this.picker
            ...
            .css(
              "display",
              this.o.todayBtn === !0 || "linked" === this.o.todayBtn ? "table-cell" : "none"
            ),
          this.picker
            .find("tfoot .clear")
            .text(n)
        ...
        for (var u, v, w = []; p.valueOf() < t; ) {
          if (
            ((u = p.getUTCDay()), u === this.o.weekStart && (w.push("<tr>"), this.o.calendarWeeks))
          ) {
    ...
    moveMonth: function (a, b) {
      ...
      var c,
        ...
        i = Math.abs(b);
      if (((b = b > 0 ? 1 : -1), 1 === i))
        (d = b === -1 ? () => e.getUTCMonth() === h : () => e.getUTCMonth() !== c),
          (c = h + b),
          e.setUTCMonth(c),
          (c = (c + 12) % 12);
      else {
        for (var j = 0; j < i; j++) e = this.moveMonth(e, b);
        (c = e.getUTCMonth()), e.setUTCDate(f), (d = () => c !== e.getUTCMonth());
      }
    ...
    dateIsDisabled: function (b) {
      return (
        this.weekOfDateIsDisabled(b) || a.grep(this.o.datesDisabled, (a) => e(b, a)).length > 0
      );
    },
  ...
  l.prototype = {
    updateDates: function () {
      (this.dates = a.map(this.pickers, (a) => a.getUTCDate())), this.updateRanges();
    },
        ...
        if (d !== b) {
          ...
          if (g !== -1) {
            if (
              ...
              while (h >= 0 && e < this.dates[h]) this.pickers[h--].setUTCDate(e);
            else if (e > this.dates[i])
              while (i < j && e > this.dates[i]) this.pickers[i++].setUTCDate(e);
