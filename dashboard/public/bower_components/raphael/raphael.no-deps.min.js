      ...
      (i = [r(2)]),
        (n = ((t) => {
          function e(r) {
            ...
            if (e.is(r, Q)) return e._engine.create[F](e, r.splice(0, 3 + e.is(r[0], $))).add(r);
          ...
          function n(t, e, r) {
            function n() {
              ...
              return o[T](s)
                ? (i(l, s), r ? r(o[s]) : o[s])
                : (l.length >= 1e3 && delete o[l.shift()], l.push(s), (o[s] = t[F](e, a)), r ? r(o[s]) : o[s]);
            }
            return n;
          }
          function a() {
          ...
          function u(t, e, r, i, n, a, s, o) {
            if (!(Y(t, r) < G(n, s) || G(t, r) > Y(n, s) || Y(e, i) < G(a, o) || G(e, i) > Y(a, o))) {
          ...
          function p(t, r, i) {
            ...
            for (x = 0; x < c + 1; x++)
              (v = e.findDotsAtSegment.apply(e, r.concat(x / c))), p.push({ x: v.x, y: v.y, t: x / c });
            for (x = 0; x < h; x++)
              for (var y = 0; y < c; y++) {
                var m = f[x],
                  b = f[x + 1],
                ...
                if (C) {
                  ...
                  S >= 0 &&
                    ...
                    T >= 0 &&
                    T <= 1.001 &&
                    (i ? g++ : g.push({ x: C.x, y: C.y, t1: G(S, 1), t2: G(T, 1) }));
                }
              }
            return g;
          }
          function d(t, r, i) {
            ...
            for (var n, a, s, o, l, h, u, c, f, d, g = i ? 0 : [], x = 0, v = t.length; x < v; x++) {
              var y = t[x];
                  ...
                  if ("M" == _[0]) (s = u = _[1]), (o = c = _[2]);
                    ...
                    if (i) g += w;
                      ...
                      for (var k = 0, B = w.length; k < B; k++)
                        (w[k].segment1 = x), (w[k].segment2 = m), (w[k].bez1 = f), (w[k].bez2 = d);
                      g = g.concat(w);
                    }
                  }
                }
            ...
            if (a)
              for (w = 0, B = Me.length; w < B; w++) {
                ...
                if (_.el.id == i.id && _.anim == r) {
                  _.percent != n ? (Me.splice(w, 1), (u = 1)) : (h = _), i.attr(_.totalOrigin);
                  break;
                }
              }
            else a = +m;
              ...
              if (h) (h.initstatus = a), (h.start = new Date() - h.ms * a);
                ...
                for (var C in l)
                  if (l[T](C) && (pt[T](C) || i.paper.customAttributes[T](C)))
                    switch (((v[C] = i.attr(C)), null == v[C] && (v[C] = ft[C]), (m[C] = l[C]), pt[C])) {
                      case $:
                        b[C] = (m[C] - v[C]) / x;
                        break;
                      case "colour":
                      ...
                      case "path":
                        var A = Qt(v[C], m[C]),
                          M = A[1];
                        for (v[C] = A[0], b[C] = [], w = 0, B = v[C].length; w < B; w++) {
                          b[C][w] = [0];
                          for (var N = 1, E = v[C][w].length; N < E; N++) b[C][w][N] = (M[w][N] - v[C][w][N]) / x;
                        }
                        break;
                      case "transform":
                        var L = i._,
                        ...
                        if (F)
                          for (
                            v[C] = F.from, m[C] = F.to, b[C] = [], b[C].real = !0, w = 0, B = v[C].length;
                            w < B;
                            w++
                          )
                            for (b[C][w] = [v[C][w][0]], N = 1, E = v[C][w].length; N < E; N++)
                      ...
                      case "csv":
                        var j = q(l[C])[I](k),
                          D = q(v[C])[I](k);
                        if ("clip-rect" == C)
                          for (v[C] = D, b[C] = [], w = D.length; w--; ) b[C][w] = (j[w] - v[C][w]) / x;
                        m[C] = j;
                        break;
                      default:
                        for (j = [][P](l[C]), D = [][P](v[C]), b[C] = [], w = i.paper.customAttributes[C].length; w--; )
                          b[C][w] = ((j[w] || 0) - (D[w] || 0)) / x;
                    }
                var V = l.easing,
                ...
                if (
                  ...
                  Me.push(_),
                  a && !h && !u && ((_.stop = !0), (_.start = new Date() - x * a), 1 == Me.length))
                )
                  return Ee();
                u && (_.start = new Date() - _.ms * a), 1 == Me.length && Ne(Ee);
              }
              t("raphael.anim.start." + i.id, i, r);
            }
          }
          function _(t) {
            for (var e = 0; e < Me.length; e++) Me[e].el.paper == t && Me.splice(e--, 1);
          }
          ...
          var w,
            ...
            M = { was: Object.prototype[T].call(A.win, "Raphael"), is: A.win.Raphael },
            N = function () {
            ...
            F = "apply",
            P = "concat",
            z = "ontouchstart" in A.win || (A.win.DocumentTouch && A.doc instanceof DocumentTouch),
            R = "",
            j = " ",
            q = String,
            I = "split",
          ...
          (e.svg = !(e.vml = "VML" == e.type)),
            ...
            (e.angle = (t, r, i, n, a, s) => {
              if (null == a) {
                var o = t - i,
                  l = r - n;
                return o || l ? (180 + (180 * W.atan2(-l, -o)) / U + 360) % 360 : 0;
              }
              return e.angle(t, r, a, s) - e.angle(i, n, a, s);
            }),
            (e.rad = (t) => ((t % 360) * U) / 180),
            (e.deg = (t) => Math.round((((180 * t) / U) % 360) * 1e3) / 1e3),
            (e.snapTo = (t, r, i) => {
          ...
          var Ft = (e.createUUID = ((t, e) => () => "xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(t, e).toUpperCase())(/[xy]/g, (t) => {
            var e = (16 * W.random()) | 0,
              r = "x" == t ? e : (3 & e) | 8;
          ...
          var Pt = (t) => {
              if (e.vml) {
                ...
                (l.title = "Raphaël Colour Picker"),
                  ...
                  (Pt = n((t) => ((l.style.color = t), A.doc.defaultView.getComputedStyle(l, R).getPropertyValue("color"))));
              }
              return Pt(t);
            },
            zt = function () {
          ...
          (e.getRGB = n((t) => {
            if (!t || (t = q(t)).indexOf("-") + 1) return { r: -1, g: -1, b: -1, hex: "none", error: 1, toString: a };
            ...
            (e.hsb = n((t, r, i) => e.hsb2rgb(t, r, i).hex)),
            (e.hsl = n((t, r, i) => e.hsl2rgb(t, r, i).hex)),
            (e.rgb = n((t, e, r) => {
              function i(t) {
                return (t + 0.5) | 0;
              }
            ...
            (e.getColor = function (t) {
              ...
              return (
                (e.h += 0.075),
                e.h > 1 && ((e.h = 0), (e.s -= 0.2), e.s <= 0 && (this.getColor.start = { h: 0, s: 1, b: e.b })),
                r.hex
              );
            }),
                ...
                n.length ||
                  q(t).replace(yt, (t, e, r) => {
                    ...
                    if (
                      ...
                      n.push([e][P](a));
                    else while (a.length >= i[s] && (n.push([e][P](a.splice(0, i[s]))), i[s]));
                  }),
          ...
          (e.findDotsAtSegment = (t, e, r, i, n, a, s, o, l) => {
            var h = 1 - l,
              u = X(h, 3),
              c = X(h, 2),
              f = l * l,
            ...
            return (
              (x > y || v < m) && (B += 180),
              { x: d, y: g, m: { x: x, y: v }, n: { x: y, y: m }, start: { x: b, y: _ }, end: { x: w, y: k }, alpha: B }
            );
          }),
            (e.bezierBBox = (t, r, i, n, a, s, o, l) => {
            ...
            (e.isPointInsideBBox = (t, e, r) => e >= t.x && e <= t.x2 && r >= t.y && r <= t.y2),
            (e.isBBoxIntersect = (t, r) => {
            ...
            (e.pathIntersection = (t, e) => d(t, e)),
            (e.pathIntersectionNumber = (t, e) => d(t, e, 1)),
            (e.isPointInsidePath = (t, r, i) => {
              var n = e.pathBBox(t);
              return (
          ...
          var Ot = (e.pathBBox = (t) => {
              ...
              var c = G[F](0, a),
                ...
                g = p - c,
                x = d - f,
                v = { x: c, y: f, x2: p, y2: d, width: g, height: x, cx: c + g / 2, cy: f + x / 2 };
              return (e.bbox = r(v)), v;
            }),
            Wt = (t) => {
              var i = r(t);
            ...
            Gt = (e._pathToAbsolute = (t) => {
              ...
              for (
                var u = 3 == t.length && "M" == t[0][0] && "R" == t[1][0].toUpperCase() && "Z" == t[2][0].toUpperCase(),
                  c,
                  f,
                  p = h,
                  d = t.length;
                ...
                if ((i.push((c = [])), (f = t[p]), f[0] != ct.call(f[0])))
                  switch (((c[0] = ct.call(f[0])), c[0])) {
                    ...
                    case "H":
                      ...
                      break;
                    case "R":
                      for (var g = [n, a][P](f.slice(1)), x = 2, v = g.length; x < v; x++)
                        (g[x] = +g[x] + n), (g[++x] = +g[x] + a);
                      i.pop(), (i = i[P](s(g, u)));
                      break;
                    case "M":
                      (o = +f[1] + n), (l = +f[2] + a);
                    default:
                      for (x = 1, v = f.length; x < v; x++) c[x] = +f[x] + (x % 2 ? n : a);
                  }
                else if ("R" == f[0])
                  (g = [n, a][P](f.slice(1))), i.pop(), (i = i[P](s(g, u))), (c = ["R"][P](f.slice(-2)));
            ...
            Ht = (t, e, r, i) => [t, e, r, i, r, i],
            Xt = (t, e, r, i, n, a) => {
              var s = 1 / 3,
                o = 2 / 3;
              return [s * t + o * r, s * e + o * i, s * n + o * r, s * a + o * i, n, a];
            },
            Ut = (t, e, r, i, a, s, o, l, h, u) => {
              var c = (120 * U) / 180,
                f = (U / 180) * (+a || 0),
                p = [],
                d,
              ...
              if (u) (S = u[0]), (T = u[1]), (B = u[2]), (C = u[3]);
                ...
                var _ = r * r,
                  w = i * i,
                  k = (s == o ? -1 : 1) * W.sqrt(H((_ * w - _ * m * m - w * y * y) / (_ * m * m + w * y * y))),
                  B = (k * r * m) / i + (t + l) / 2,
                  C = (k * -i * y) / r + (e + h) / 2,
              ...
              var L = W.cos(S),
                ...
                Y = [l + q * R, h - D * z],
                G = [l, h];
              if (((O[0] = 2 * V[0] - O[0]), (O[1] = 2 * V[1] - O[1]), u)) return [O, Y, G][P](p);
              p = [O, Y, G][P](p).join()[I](",");
            ...
            Zt = n((t, e, r, i, n, a, s, o) => {
              ...
              return (
                ...
                c > 0 && c < 1 && ((g = $t(t, e, r, i, n, a, s, o, c)), d.push(g.x), p.push(g.y)),
                f > 0 && f < 1 && ((g = $t(t, e, r, i, n, a, s, o, f)), d.push(g.x), p.push(g.y)),
                { min: { x: G[F](0, d), y: G[F](0, p) }, max: { x: Y[F](0, d), y: Y[F](0, p) } }
              );
            }),
            Qt = (e._path2curve = n(
              (t, e) => {
                    ...
                    o = (t, e, r) => {
                      ...
                      switch ((!(t[0] in a) && (e.qx = e.qy = null), t[0])) {
                        ...
                        case "A":
                          ...
                          break;
                        case "S":
                          "C" == r || "S" == r ? ((i = 2 * e.x - e.bx), (n = 2 * e.y - e.by)) : ((i = e.x), (n = e.y)),
                            (t = ["C", i, n][P](t.slice(1)));
                          break;
                        case "T":
                          "Q" == r || "T" == r
            ...
            ae = (e.transformPath = (t, e) => Nt(t, ne(t, e))),
            se = (e._extractTransform = (t, r) => {
                    ...
                    : "r" == x
                      ...
                      : "s" == x
                        ? 2 == d || 3 == d
                          ...
                          : 5 == d &&
                            (v
                              ? ((_ = y.x(p[3], p[4])), (w = y.y(p[3], p[4])), u.scale(p[1], p[2], _, w))
                              : u.scale(p[1], p[2], p[3], p[4]),
                            (o *= p[1]),
                            (l *= p[2]))
                        : "m" == x && 7 == d && u.add(p[1], p[2], p[3], p[4], p[5], p[6]),
                    (h.dirtyT = 1),
                    (t.matrix = u);
                }
              (t.matrix = u),
                ...
                (h.dx = a = u.e),
                (h.dy = s = u.f),
                1 == o && 1 == l && !n && h.bbox ? ((h.bbox.x += +a), (h.bbox.y += +s)) : (h.dirtyT = 1);
            }),
            oe = (t) => {
              var e = t[0];
            ...
            le = (e._equaliseTransform = (t, r) => {
              (r = q(r).replace(/\.{3}|\u2026/g, t)),
                (t = e.parseTransformString(t) || []),
                (r = e.parseTransformString(r) || []);
              for (var i = Y(t.length, r.length), n = [], a = [], s = 0, o, l, h, u; s < i; s++) {
                if (
                  ((h = t[s] || oe(r[s])),
                  (u = r[s] || oe(h)),
                  h[0] != u[0] ||
                  ...
                  return;
                for (n[s] = [], a[s] = [], o = 0, l = Y(h.length, u.length); o < l; o++)
                  o in h && (n[s][o] = h[o]), o in u && (a[s][o] = u[o]);
              }
              return { from: n, to: a };
            });
          (e._getContainer = (t, r, i, n) => {
            var a;
            if (((a = null != n || e.is(t, "object") ? t : A.doc.getElementById(t)), null != a))
              return a.tagName
                ? null == r
                  ? {
                      container: a,
            ...
            (e._engine = {}),
            (e.path2curve = Qt),
            (e.matrix = (t, e, r, i, n, a) => new g(t, e, r, i, n, a)),
            ((t) => {
              function r(t) {
              ...
              (t.add = function (t, e, r, i, n, a) {
                ...
                (t.invert = function () {
                  var 
                    e = this.a * this.d - this.b * this.c;
                  return new g(
                    this.d / e,
                    -this.b / e,
                    -this.c / e,
                    this.a / e,
                    (this.c * this.f - this.d * this.e) / e,
                    (this.b * this.e - this.a * this.f) / e
                  );
                }),
                (t.clone = function () {
                ...
                (t.split = function () {
                  ...
                  return (
                    s < 0
                      ? ((t.rotate = e.deg(W.acos(s))), a < 0 && (t.rotate = 360 - t.rotate))
            ...
            var he = function () {
              ...
              de = (() => A.doc.addEventListener
                  ? ((t, e, r, i) => {
                      ...
                      return () => (t.removeEventListener(e, n, !1), z && V[e] && t.removeEventListener(V[e], a, !1), !0);
                    })
                  : A.doc.attachEvent
                    ? ((t, e, r, i) => {
                        var n = (t) => {
              ...
              xe = (e) => {
                for (
                  ...
                  A.win.opera && p.removeChild(u),
                    ...
                    (u.style.display = d),
                    A.win.opera && (f ? p.insertBefore(u, f) : p.appendChild(u)),
          ...
          (ye.drag = function (r, i, n, a, s, o) {
            ...
            (ye.undrag = function () {
              for (var r = be.length; r--; )
                be[r].el == this &&
                  (this.unmousedown(be[r].start), be.splice(r, 1), t.unbind("raphael.drag.*." + this.id));
          ...
          (E.getElementByPoint = function (t, e) {
            ...
            if (!n) return null;
            while (n.parentNode && n != i.parentNode && !n.raphael) n = n.parentNode;
            ...
            (ye.getBBox = function (t) {
              ...
              return t
                ...
                : ((e.dirty || e.dirtyT || !e.bbox) &&
                    ((!e.dirty && this.realPath) || ((e.bboxwt = 0), (this.realPath = Mt[this.type](this))),
                ...
                for (var s, o, l, h, u = "", c = {}, f, p = 0, d = 0, g = i.length; d < g; d++) {
                  if (((l = i[d]), "M" == l[0])) (s = +l[1]), (o = +l[2]);
                    ...
                    if (((h = ke(s, o, l[1], l[2], l[3], l[4], l[5], l[6])), p + h > n)) {
                      ...
                      if (!t && !r)
                        return (
                          (f = ke(s, o, l[1], l[2], l[3], l[4], l[5], l[6], n - p)), { x: f.x, y: f.y, alpha: f.alpha }
                        );
                    }
                    (p += h), (s = +l[5]), (o = +l[6]);
                  }
          ...
          var Ae = (e.easing_formulas = {
            ...
            elastic: (t) => t == !!t ? t : X(2, -10 * t) * W.sin(((t - 0.075) * (2 * U)) / 0.3) + 1,
            bounce: (t) => {
              var e = 7.5625,
                r = 2.75,
                i;
          ...
          (ye.animateWith = function (t, r, i, n, a, s) {
            ...
            (ye.animate = function (t, r, i, n) {
              ...
              return b(s, this, s.percents[0], null, this.attr()), this;
            }),
            ...
            (ye.pause = function (e) {
              for (var r = 0; r < Me.length; r++)
                Me[r].el.id != this.id ||
                  (e && Me[r].anim != e) ||
                  (t("raphael.anim.pause." + this.id, this, Me[r].anim) !== !1 && (Me[r].paused = !0));
              return this;
            }),
            ...
            (ye.stop = function (e) {
              for (var r = 0; r < Me.length; r++)
                Me[r].el.id != this.id ||
                  (e && Me[r].anim != e) ||
                  (t("raphael.anim.stop." + this.id, this, Me[r].anim) !== !1 && Me.splice(r--, 1));
              return this;
            }),
            t.on("raphael.remove", _),
            t.on("raphael.clear", _),
            (ye.toString = () => "Raphaël’s object");
          var Fe = function (t) {
              if (((this.items = []), (this.length = 0), (this.type = "set"), t))
                for (var e = 0, r = t.length; e < r; e++)
                  !t[e] ||
                    (t[e].constructor != ye.constructor && t[e].constructor != Fe) ||
          ...
          return (
            ...
            (Pe.splice = function (t, e, r) {
              (t = t < 0 ? Y(this.length + t, 0) : t), (e = Y(0, G(this.length - t, e)));
              var i = [],
                n = [],
                a = [],
                s;
                    ...
                    if (
                      ((e.glyphs[n] = {
                        ...
                        d:
                          a.d &&
                          "M" +
                            a.d.replace(/[mlcxtrv]/g, (t) => { l: "L", c: "C", x: "z", t: "m", r: "l", v: "c" }[t] || "M") +
                            "z",
                      }),
                      a.k)
                    )
            ...
            (E.print = function (t, r, i, n, a, s, o, l) {
              (s = s || "middle"), (o = Y(G(o || 0, 1), -1)), (l = Y(G(l || 1, 3), 1));
              var h = q(i)[I](R),
                u = 0,
                c = 0,
                f = R,
              ...
              if ((e.is(n, "string") && (n = this.getFont(n)), n)) {
                ...
                for (
                  ...
                  w &&
                    w.d &&
                    (f += e.transformPath(w.d, ["t", u * p, v * p, "s", p, p, g, y, "t", (t - g) / p, (r - y) / p]));
                }
              }
            ...
            (E.add = function (t) {
              if (e.is(t, "array"))
                for (var r = this.set(), i = 0, n = t.length, a; i < n; i++)
                  (a = t[i] || {}), B[T](a.type) && r.push(this[a.type]().attr(a));
              return r;
            }),
            (e.format = (t, r) => {
              ...
              return (
                t &&
                  e.is(t, Z) &&
                  i.length - 1 &&
                  (t = t.replace(C, (t, e) => null == i[++e] ? R : i[e])),
                t || R
              );
            }),
            (e.fullfill = (() => {
              var t = /\{([^\}]+)\}/g,
                ...
                r = (t, r, i) => {
                  var n = i;
                  return (
                    r.replace(e, (t, e, r, i, a) => {
                      (e = e || i), n && (e in n && (n = n[e]), "function" == typeof n && a && (n = n()));
                    }),
                    (n = (null == n || n == i ? t : n) + "")
                  );
                };
              return (e, i) => String(e).replace(t, (t, e) => r(t, e, i));
            })()),
            (e.ninja = () => {
          ...
          if (!t || t.svg) {
            ...
            var x = (i, n) => {
              ...
              v = (e, n) => {
                ...
                if (!y) {
                  if (
                    ((n = r(n).replace(t._radial_gradient, (t, e, r) => {
                      if (((h = "radial"), e && r)) {
                        (f = i(e)), (p = i(r));
                        var n = 2 * (p > 0.5) - 1;
                  ...
                  if (
                    ...
                    e.gradient && u != e.gradient.id && (g.defs.removeChild(e.gradient), delete e.gradient),
                    !e.gradient)
                  ) {
                    (y = x(h + "Gradient", { id: u })),
                      (e.gradient = y),
                ...
                if ("path" == i.type) {
                  ...
                  if (
                    ...
                    t._g.doc.getElementById(S)
                      ? g[S]++
                      : (o.defs.appendChild(x(x("path"), { "stroke-linecap": "round", d: d[v], id: S })), (g[S] = 1));
                    ...
                    A
                      ...
                      : ((A = x(x("marker"), {
                        ...
                        (M = x(x("use"), {
                          "xlink:href": "#" + S,
                          transform:
                            (a ? "rotate(180 " + k / 2 + " " + B / 2 + ") " : c) + "scale(" + k / C + "," + B / C + ")",
                    ...
                    a
                      ? ((y = i._.arrows.startdx * f || 0), (m = t.getTotalLength(u.path) - N * f))
                      : ((y = N * f), (m = t.getTotalLength(u.path) - (i._.arrows.enddx * f || 0))),
                      (w = {}),
                      (w["marker-" + l] = "url(#" + T + ")"),
                    ...
                    a
                      ...
                      i._.arrows[l + "Path"] && x(h, { d: t.getSubpath(u.path, y, m) }),
                ...
                if ((e = w[r(e).toLowerCase()])) {
                  for (
                    var n = t.attrs["stroke-width"] || "1",
                      a = { round: n, square: n, butt: 0 }[t.attrs["stroke-linecap"] || i["stroke-linecap"]] || 0,
                      s = [],
                      o = e.length;
                    o--;
                  )
                    ...
                    switch (((u[d] = g), d)) {
                      ...
                      case "clip-rect":
                        ...
                        if (4 == C.length) {
                          ...
                          var T = x("clipPath"),
                            A = x("rect");
                          (T.id = t.createUUID()),
                            x(A, { x: C[0], y: C[1], width: C[2], height: C[3] }),
                            T.appendChild(A),
                        ...
                        if (!g) {
                          ...
                          if (M) {
                            var N = t._g.doc.getElementById(M.replace(/(^url\(#|\)$)/g, c));
                      ...
                      case "fill":
                        ...
                        if (E) {
                          ...
                          var L = x("image");
                          (T.id = t.createUUID()),
                            x(T, { x: 0, y: 0, patternUnits: "userSpaceOnUse", height: 1, width: 1 }),
                          ...
                          if (("circle" == i.type || "ellipse" == i.type || "r" != r(g).charAt()) && v(i, g)) {
                            if ("opacity" in u || "fill-opacity" in u) {
                              ...
                              if (P) {
                                ...
                                x(z[z.length - 1], {
                                  "stop-opacity":
                                    ("opacity" in u ? u.opacity : 1) * ("fill-opacity" in u ? u["fill-opacity"] : 1),
                                });
                              }
                            }
                        ...
                        F[e]("opacity") && x(l, { "fill-opacity": F.opacity > 1 ? F.opacity / 100 : F.opacity });
                      case "stroke":
                        (F = t.getRGB(g)),
                          l.setAttribute(d, F.hex),
                          "stroke" == d &&
                            F[e]("opacity") &&
                            x(l, { "stroke-opacity": F.opacity > 1 ? F.opacity / 100 : F.opacity }),
                          "stroke" == d &&
                            i._.arrows &&
                            ("startString" in i._.arrows && _(i, i._.arrows.startString),
                            "endString" in i._.arrows && _(i, i._.arrows.endString, 1));
                      ...
                      case "fill-opacity":
                        if (u.gradient) {
                          (P = t._g.doc.getElementById(l.getAttribute("fill").replace(/^url\(#|\)$/g, c))),
                            P && ((z = P.getElementsByTagName("stop")), x(z[z.length - 1], { "stop-opacity": g }));
                          break;
                        }
                      default:
              ...
              S = (i, a) => {
                if ("text" == i.type && (a[e]("text") || a[e]("font") || a[e]("font-size") || a[e]("x") || a[e]("y"))) {
                  var s = i.attrs,
                    o = i.node,
                    l = o.firstChild
                      ? n(t._g.doc.defaultView.getComputedStyle(o.firstChild, c).getPropertyValue("font-size"), 10)
                      : 10;
                  if (a[e]("text")) {
              ...
              T = (t) => t.parentNode && "a" === t.parentNode.tagName.toLowerCase() ? t.parentNode : t,
              A = function (e, r) {
                function i() {
            ...
            (A.prototype = M),
              ...
              (M.insertAfter = function (e) {
                ...
                return (
                  i.nextSibling ? i.parentNode.insertBefore(r, i.nextSibling) : i.parentNode.appendChild(r),
              ...
              (M.blur = function (e) {
                if (0 !== +e) {
                  ...
                  (this.attrs.blur = e),
                    ...
                    i.appendChild(n),
                    this.paper.defs.appendChild(i),
                    (this._blur = i),
                    x(this.node, { filter: "url(#" + i.id + ")" });
                } else
              ...
              (t._engine.rect = (t, e, r, i, n, a) => {
                var s = x("rect");
                t.canvas && t.canvas.appendChild(s);
                var o = new A(s, t);
                return (
                  (o.attrs = { x: e, y: r, width: i, height: n, rx: a || 0, ry: a || 0, fill: "none", stroke: "#000" }),
                  (o.type = "rect"),
                  x(s, o.attrs),
                  o
                );
              ...
              (t._engine.setViewBox = function (t, e, r, i, n) {
                ...
                for (
                  null == t
                    ? (this._vbSize && (o = 1), delete this._vbSize, (c = "0 0 " + this.width + f + this.height))
            ...
            var e = "hasOwnProperty",
              ...
              k = (e) => {
                ...
                for (var u = 0, c = o.length; u < c; u++) {
                  ...
                  for (var f = 1, v = l.length; f < v; f++) h += a(l[f] * b) + (f != v - 1 ? "," : d);
                  s.push(h);
                }
                return s.join(p);
              },
              ...
              C = (t, e, r, i, n, a) => {
                ...
                if (((f.visibility = "hidden"), e && r)) {
                  if (((c.coordsize = l(v) + p + l(y)), (f.rotation = a * (e * r < 0 ? -1 : 1)), a)) {
                    var m = B(a, i, n);
                    (i = m.dx), (n = m.dy);
                  }
                  if (
            ...
            var S = (t, e, i) => {
              ...
              T = (n, l) => {
                ...
                if (
                  ...
                  ((l.path && "path" == n.type) || v) &&
                    ...
                    (n._.dirty = 1),
                    "image" == n.type &&
                      ((n._.fillpos = [f.x, f.y]), (n._.fillsize = [f.width, f.height]), C(n, 1, 1, 0, 0, 0))),
                ...
                if (n.textpath) {
                  ...
                  l.font && (R.font = l.font),
                    l["font-family"] &&
                      (R.fontFamily = '"' + l["font-family"].split(",")[0].replace(/^['"]+|['"]+$/g, d) + '"'),
                ...
                if (
                    ...
                    if (I) {
                      ...
                      (j.color = t.getRGB(l.fill).hex),
                        ...
                        t.getRGB(l.fill).error &&
                          (m.type in { circle: 1, ellipse: 1 } || "r" != r(l.fill).charAt()) &&
                          A(m, l.fill, j) &&
                  ...
                  O.on && l.stroke && (O.color = Y.hex),
                    (V = ((+f["stroke-opacity"] + 1 || 2) - 1) * ((+f.opacity + 1 || 2) - 1) * ((+Y.o + 1 || 2) - 1));
                  ...
                  if (
                    ...
                    l["stroke-linecap"] &&
                      (O.endcap =
                        "butt" == l["stroke-linecap"] ? "flat" : "square" == l["stroke-linecap"] ? "square" : "round"),
                ...
                if ("text" == m.type) {
                  ...
                  (m.W = f.w = (Z.right - Z.left) / U),
                    ...
                    (m.Y = f.y + m.H / 2),
                    ("x" in l || "y" in l) &&
                      (m.path.v = t.format("m{0},{1}l{2},{1}", a(f.x * b), a(f.y * b), a(f.x * b) + 1));
                  for (
              ...
              A = (e, a, s) => {
                ...
                if (((e = e.shape || e.node), x.length)) {
                  ...
                  for (var v = [], y = 0, m = x.length; y < m; y++) x[y].offset && v.push(x[y].offset + p + x[y].color);
            ...
            (M.prototype = N),
              ...
              (N.transform = function (e) {
                ...
                if ((s.translate(1, 1), c || u || "image" == this.type))
                  if (
                    ((o.matrix = "1 0 0 1"), (o.offset = "0 0"), (h = s.split()), (u && h.noRotation) || !h.isSimple)
                  ) {
              ...
              (N.scale = function (t, e, n, a) {
                ...
                if (
                  ((t = r(t).split(u)),
                  t.length - 1 &&
                    ((e = i(t[1])), (n = i(t[2])), (a = i(t[3])), isNaN(n) && (n = null), isNaN(a) && (a = null)),
                  (t = i(t[0])),
                  null == e && (e = t),
                  null == a && (n = a),
                  null == n || null == a)
            ...
            (t._engine.initWin = (t) => {
              ...
              try {
                !e.namespaces.rvml && e.namespaces.add("rvml", "urn:schemas-microsoft-com:vml"),
                  (E = (t) => e.createElement("<rvml:" + t + ' class="rvml">'));
              } catch (r) {
                E = (t) => e.createElement("<" + t + ' xmlns="urn:schemas-microsoft.com:vml" class="rvml">');
              }
            }),
              ...
              (t._engine.create = () => {
                ...
                return (
                  ...
                  1 == r
                    ? (t._g.doc.body.appendChild(h), (u.left = s + "px"), (u.top = o + "px"), (u.position = "absolute"))
                    : r.firstChild
