        ...
        (n = ((t) => {
          ...
          function n(t, e, r) {
            function n() {
              ...
              return o[A](s)
                ? (i(l, s), r ? r(o[s]) : o[s])
                : (l.length >= 1e3 && delete o[l.shift()], l.push(s), (o[s] = t[z](e, a)), r ? r(o[s]) : o[s]);
            }
            return n;
          }
          function a() {
                  ...
                  if (l[A](C) && (pt[A](C) || i.paper.customAttributes[A](C)))
                    switch (((x[C] = i.attr(C)), null == x[C] && (x[C] = ft[C]), (m[C] = l[C]), pt[C])) {
                      ...
                      case "transform":
                        ...
                        if (z)
                          for (
                            x[C] = z.from, m[C] = z.to, b[C] = [], b[C].real = !0, w = 0, B = x[C].length;
                            w < B;
                            w++
                          )
          ...
          var zt = (e.createUUID = ((t, e) => () => "xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(t, e).toUpperCase())(/[xy]/g, (t) => {
            var e = (16 * Y.random()) | 0,
              r = "x" == t ? e : (3 & e) | 8;
          ...
          var Pt = (t) => {
              if (e.vml) {
                ...
                (l.title = "Raphaël Colour Picker"),
                  ...
                  (Pt = n((t) => ((l.style.color = t), T.doc.defaultView.getComputedStyle(l, R).getPropertyValue("color"))));
              }
              return Pt(t);
            },
            Ft = function () {
          ...
          (e.findDotsAtSegment = (t, e, r, i, n, a, s, o, l) => {
            ...
            return (
              (v > y || x < m) && (B += 180),
              { x: d, y: g, m: { x: v, y: x }, n: { x: y, y: m }, start: { x: b, y: _ }, end: { x: w, y: k }, alpha: B }
            );
          }),
          ...
          var Ot = (e.pathBBox = (t) => {
            ...
            ae = (e.transformPath = (t, e) => Mt(t, ne(t, e))),
            ...
            (ye.getBBox = function (t) {
              ...
              return t
                ...
                : ((e.dirty || e.dirtyT || !e.bbox) &&
                    ((!e.dirty && this.realPath) || ((e.bboxwt = 0), (this.realPath = Et[this.type](this))),
          ...
          var Te = (e.easing_formulas = {
            ...
            elastic: (t) => t == !!t ? t : X(2, -10 * t) * Y.sin(((t - 0.075) * (2 * U)) / 0.3) + 1,
            bounce: (t) => {
              var e = 7.5625,
                r = 2.75,
                i;
          ...
          (ye.animateWith = function (t, r, i, n, a, s) {
            ...
            (ye.pause = function (e) {
              for (var r = 0; r < Ee.length; r++)
                Ee[r].el.id != this.id ||
                  (e && Ee[r].anim != e) ||
                  (t("raphael.anim.pause." + this.id, this, Ee[r].anim) !== !1 && (Ee[r].paused = !0));
              return this;
            }),
            ...
            (N.print = function (t, r, i, n, a, s, o, l) {
              ...
              if ((e.is(n, "string") && (n = this.getFont(n)), n)) {
                ...
                for (
                  ...
                  w &&
                    w.d &&
                    (f += e.transformPath(w.d, ["t", u * p, x * p, "s", p, p, g, y, "t", (t - g) / p, (r - y) / p]));
                }
              }
    ...
    function (t, e, r) {
      ...
      !((r) => {
        var a = "0.5.0",
          ...
          m =
            Array.isArray ||
            ((t) => t instanceof Array || "[object Array]" == x.call(t));
        (eve = (t, e) => {
          var r = d,
            i = p,
          ...
          (eve.version = a),
          (eve.toString = () => "You are running Eve " + a),
        ...
        (n = ((t) => {
          if (!t || t.svg) {
            ...
            var v = (i, n) => {
                ...
                if ("path" == i.type) {
                  ...
                  if (
                    ...
                    t._g.doc.getElementById(S)
                      ? g[S]++
                      : (o.defs.appendChild(v(v("path"), { "stroke-linecap": "round", d: d[x], id: S })), (g[S] = 1));
                    ...
                    a
                      ? ((y = i._.arrows.startdx * f || 0), (m = t.getTotalLength(u.path) - M * f))
                      : ((y = M * f), (m = t.getTotalLength(u.path) - (i._.arrows.enddx * f || 0))),
                      (w = {}),
                      (w["marker-" + l] = "url(#" + A + ")"),
                    ...
                    switch (((u[d] = g), d)) {
                      ...
                      case "stroke":
                        (z = t.getRGB(g)),
                          ...
                          "stroke" == d &&
                            z[e]("opacity") &&
                            v(l, { "stroke-opacity": z.opacity > 1 ? z.opacity / 100 : z.opacity }),
                          "stroke" == d &&
                            i._.arrows &&
                            ("startString" in i._.arrows && _(i, i._.arrows.startString),
                            "endString" in i._.arrows && _(i, i._.arrows.endString, 1));
                      ...
                      case "fill-opacity":
                        if (u.gradient) {
                          (P = t._g.doc.getElementById(l.getAttribute("fill").replace(/^url\(#|\)$/g, c))),
                            P && ((F = P.getElementsByTagName("stop")), v(F[F.length - 1], { "stop-opacity": g }));
                          break;
                        }
                      default:
              ...
              A = (t) => t.parentNode && "a" === t.parentNode.tagName.toLowerCase() ? t.parentNode : t,
              T = function (e, r) {
                function i() {
            ...
            (t._engine.initWin = (t) => {
              ...
              try {
                !e.namespaces.rvml && e.namespaces.add("rvml", "urn:schemas-microsoft-com:vml"),
                  (N = (t) => e.createElement("<rvml:" + t + ' class="rvml">'));
              } catch (r) {
                N = (t) => e.createElement("<" + t + ' xmlns="urn:schemas-microsoft.com:vml" class="rvml">');
              }
            }),
