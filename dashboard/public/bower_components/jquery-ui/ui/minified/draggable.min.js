  ...
  (t) => (
    t.widget("ui.draggable", t.ui.mouse, {
      ...
      _createHelper: function (e) {
        ...
        return (
          o.parents("body").length ||
            o.appendTo("parent" === i.appendTo ? this.element[0].parentNode : i.appendTo),
      ...
      _getParentOffset: function () {
        ...
        return (
          ...
          {
            top: e.top + (Number.parseInt(this.offsetParent.css("borderTopWidth"), 10) || 0),
            left: e.left + (Number.parseInt(this.offsetParent.css("borderLeftWidth"), 10) || 0),
          }
        );
      },
          ...
          e &&
            ...
            r.grid &&
              ((o = r.grid[1]
                ...
                : this.originalPageY),
              (h = i
                ? o - this.offset.click.top >= i[1] || o - this.offset.click.top > i[3]
                  ? o
                ...
                : o),
              (n = r.grid[0]
                ? this.originalPageX + Math.round((l - this.originalPageX) / r.grid[0]) * r.grid[0]
                : this.originalPageX),
              (l = i
                ? n - this.offset.click.left >= i[0] || n - this.offset.click.left > i[2]
                  ? n
      ...
      start: (e, i, s) => {
        ...
        (s.sortables = []),
          t(s.options.connectToSortable).each(function () {
            ...
            i &&
              !i.options.disabled &&
              (s.sortables.push(i), i.refreshPositions(), i._trigger("activate", e, o));
          });
      },
      stop: (e, i, s) => {
        var o = t.extend({}, i, { item: s.element });
        (s.cancelHelperRemoval = !1),
          t.each(s.sortables, function () {
            this.isOver
              ...
              : ((this.cancelHelperRemoval = !0), this._trigger("deactivate", e, o));
          });
      },
      drag: (e, i, s) => {
        t.each(s.sortables, function () {
    ...
    t.ui.plugin.add("draggable", "scroll", {
      ...
      drag: (e, i, s) => {
        ...
        r !== a && "HTML" !== r.tagName
          ? ((o.axis && "x" === o.axis) ||
              (s.overflowOffset.top + r.offsetHeight - e.pageY < o.scrollSensitivity
                ? (r.scrollTop = n = r.scrollTop + o.scrollSpeed)
                : e.pageY - s.overflowOffset.top < o.scrollSensitivity &&
                  (r.scrollTop = n = r.scrollTop - o.scrollSpeed)),
            (o.axis && "y" === o.axis) ||
              (s.overflowOffset.left + r.offsetWidth - e.pageX < o.scrollSensitivity
          ...
          : ((o.axis && "x" === o.axis) ||
              (e.pageY - t(a).scrollTop() < o.scrollSensitivity
                ...
                : t(window).height() - (e.pageY - t(a).scrollTop()) < o.scrollSensitivity &&
                  (n = t(a).scrollTop(t(a).scrollTop() + o.scrollSpeed))),
            (o.axis && "y" === o.axis) ||
              (e.pageX - t(a).scrollLeft() < o.scrollSensitivity
                ? (n = t(a).scrollLeft(t(a).scrollLeft() - o.scrollSpeed))
                : t(window).width() - (e.pageX - t(a).scrollLeft()) < o.scrollSensitivity &&
                  (n = t(a).scrollLeft(t(a).scrollLeft() + o.scrollSpeed)))),
    ...
    t.ui.plugin.add("draggable", "snap", {
      start: (e, i, s) => {
        var o = s.options;
        (s.snapElements = []),
          t(o.snap.constructor !== String ? o.snap.items || ":data(ui-draggable)" : o.snap).each(
            function () {
              var e = t(this),
                i = e.offset();
              this !== s.element[0] &&
      ...
      drag: (e, i, s) => {
        ...
        for (u = s.snapElements.length - 1; u >= 0; u--)
          (l = s.snapElements[u].left - s.margins.left),
            ...
            c - g > b ||
            _ > p + g ||
            !t.contains(s.snapElements[u].item.ownerDocument, s.snapElements[u].item)
              ...
              : ("inner" !== d.snapMode &&
                  ...
                  n && (i.position.top = s._convertPositionTo("relative", { top: p, left: 0 }).top),
                  r &&
      ...
      start: function (e, i, s) {
        var o,
          ...
          r = t
            ...
            .sort(
              (e, i) =>
                (Number.parseInt(t(e).css("zIndex"), 10) || 0) -
                (Number.parseInt(t(i).css("zIndex"), 10) || 0)
            );
        r.length &&
          ((o = Number.parseInt(t(r[0]).css("zIndex"), 10) || 0),
          t(r).each(function (e) {
