    ...
    for (var e, i; t.length && t[0] !== document; ) {
      if (
        ...
        ("absolute" === e || "relative" === e || "fixed" === e) &&
          ((i = Number.parseInt(t.css("zIndex"), 10)), !isNaN(i) && 0 !== i))
      )
        return i;
      t = t.parent();
    }
    ...
    t.extend(i.prototype, {
      ...
      _autoSize: function (t) {
        if (this._get(t, "autoSize") && !t.inline) {
          ...
          r.match(/[DM]/) &&
            ...
            o.setDate(
              e(this._get(t, r.match(/DD/) ? "dayNames" : "dayNamesShort")) + 20 - o.getDay()
            )),
      ...
      parseDate: function (e, i, s) {
        ...
        var n,
          ...
          c = "string" != typeof l ? l : (new Date().getFullYear() % 100) + Number.parseInt(l, 10),
          ...
          w = (t) => {
            ...
            return (h += r[0].length), Number.parseInt(r[0], 10);
          },
          k = (e, s, n) => {
            var o = -1,
              r = t
        ...
        if ((0 > Z && ((Z += 12), te--), J))
          for (
            e = this._daylightSavingAdjust(
              new Date(J.getFullYear(), J.getMonth() - q[0] * q[1] + 1, J.getDate())
            ),
              e = G && G > e ? G : e;
          ...
          t.drawMonth = Z,
            ...
            l = B
              ? "<div class='ui-datepicker-buttonpane ui-widget-content'>" +
                ...
                "</div>"
              : "",
            c = Number.parseInt(this._get(t, "firstDay"), 10),
            c = isNaN(c) ? 0 : c,
          ...
          if (((t.yearshtml = ""), o || !v))
            ...
            for (
              u = this._get(t, "yearRange").split(":"),
                ...
                p = (t) => {
                  var e = t.match(/c[+\-].*/)
                    ? i + Number.parseInt(t.substring(1), 10)
                    : t.match(/[+\-].*/)
                      ? d + Number.parseInt(t, 10)
      ...
      _isInRange: function (t, e) {
        ...
        return (
          h &&
            ...
            (r = Number.parseInt(i[0], 10)),
            (a = Number.parseInt(i[1], 10)),
            i[0].match(/[+\-].*/) && (r += s),
            i[1].match(/[+\-].*/) && (a += s)),
      ...
      _getFormatConfig: function (t) {
        ...
        return (
          (e =
            "string" != typeof e ? e : (new Date().getFullYear() % 100) + Number.parseInt(e, 10)),
          {
            shortYearCutoff: e,
