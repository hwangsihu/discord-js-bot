    ...
    t.extend(i.prototype, {
          ...
          o = function (i) {
            ...
            for (
              ...
              switch (l[2] || "d") {
                ...
                case "m":
                case "M":
                  (r += parseInt(l[1], 10)), (a = Math.min(a, t.datepicker._getDaysInMonth(o, r)));
                  break;
                case "y":
                case "Y":
                  (o += parseInt(l[1], 10)), (a = Math.min(a, t.datepicker._getDaysInMonth(o, r)));
              }
              l = h.exec(i);
            }
      ...
      _generateHTML: function (t) {
        var e,
          ...
          R,
          Y = new Date(),
          j = this._daylightSavingAdjust(new Date(Y.getFullYear(), Y.getMonth(), Y.getDate())),
          L = this._get(t, "isRTL"),
        ...
        if ((0 > Z && ((Z += 12), te--), J))
          for (
            e = this._daylightSavingAdjust(new Date(J.getFullYear(), J.getMonth() - q[0] * q[1] + 1, J.getDate())),
              e = G && G > e ? G : e;
        ...
        for (
          ...
          for (D = "", this.maxRows = 4, C = 0; q[1] > C; C++) {
            if (
              ((x = this._daylightSavingAdjust(new Date(te, Z, t.selectedDay))), (I = " ui-corner-all"), (P = ""), Q)
            ) {
              if (((P += "<div class='ui-datepicker-group"), q[1] > 1))
                switch (C) {
                  case 0:
                    (P += " ui-datepicker-group-first"), (I = " ui-corner-" + (L ? "right" : "left"));
                    break;
                  case q[1] - 1:
                    (P += " ui-datepicker-group-last"), (I = " ui-corner-" + (L ? "left" : "right"));
                    break;
                  default:
            ...
            for (
              P +=
                ...
                this._generateMonthYearHeader(t, Z, te, G, J, k > 0 || C > 0, f, g) +
            ...
            for (
              P += M + "</tr></thead><tbody>",
                ...
                te === t.selectedYear && Z === t.selectedMonth && (t.selectedDay = Math.min(t.selectedDay, z)),
              ...
              for (
                ...
                (W = m ? m.apply(t.input ? t.input[0] : null, [H]) : [!0, ""]),
                  ...
                  (O +=
                    ...
                    ((H.getTime() === x.getTime() && Z === t.selectedMonth && t._keyEvent) ||
                    ...
                    (F && !v
                      ...
                      : " " +
                        W[1] +
                        (H.getTime() === V.getTime() ? " " + this._currentClass : "") +
                        (H.getTime() === j.getTime() ? " ui-datepicker-today" : "")) +
                    "'" +
                    ((F && !v) || !W[2] ? "" : " title='" + W[2].replace(/'/g, "&#39;") + "'") +
                    (R
                      ? ""
                    ...
                    (F && !v
                      ...
                      : R
                        ...
                        : "<a class='ui-state-default" +
                          (H.getTime() === j.getTime() ? " ui-state-highlight" : "") +
                          (H.getTime() === V.getTime() ? " ui-state-active" : "") +
            ...
            Z++,
              ...
              (P +=
                "</tbody></table>" +
                (Q
                  ? "</div>" + (q[0] > 0 && C === q[1] - 1 ? "<div class='ui-datepicker-row-break'></div>" : "")
                  : "")),
              (D += P);
          }
          y += D;
      ...
      _generateMonthYearHeader: function (t, e, i, s, n, o, r, a) {
        ...
        if (o || !m) y += "<span class='ui-datepicker-month'>" + r[e] + "</span>";
          ...
          for (
            ...
            (!h || c >= s.getMonth()) &&
              (!l || n.getMonth() >= c) &&
              (y += "<option value='" + c + "'" + (c === e ? " selected='selected'" : "") + ">" + a[c] + "</option>");
          y += "</select>";
        }
