    ...
    t.widget("ui.button", {
      ...
      _create: function () {
        ...
        null === r.label &&
          ...
          this.buttonElement
            ...
            .bind("click" + this.eventNamespace, (t) => {
      ...
      _resetButton: function () {
        ...
        n.primary || n.secondary
          ? (this.options.text &&
              r.push("ui-button-text-icon" + (o ? "s" : n.primary ? "-primary" : "-secondary")),
            n.primary &&
              e.prepend("<span class='ui-button-icon-primary ui-icon " + n.primary + "'></span>"),
            n.secondary &&
              e.append(
                "<span class='ui-button-icon-secondary ui-icon " + n.secondary + "'></span>"
              ),
            this.options.text ||
