...
((t) => {
  ...
  (t) => (
    (() => {
      function e(t, e, i) {
        return [
          Number.parseFloat(t[0]) * (p.test(t[0]) ? e / 100 : 1),
          Number.parseFloat(t[1]) * (p.test(t[1]) ? i / 100 : 1),
        ];
      }
      function i(e, i) {
        return Number.parseInt(t.css(e, i), 10) || 0;
      }
      function s(e) {
        var i = e[0];
        return 9 === i.nodeType
      ...
      (t.position = {
        ...
        (t.fn.position = function (n) {
          ...
          return (
            ...
            1 === D.length && (D[1] = D[0]),
            "right" === n.at[0] ? (_.left += g) : "center" === n.at[0] && (_.left += g / 2),
            "bottom" === n.at[1] ? (_.top += m) : "center" === n.at[1] && (_.top += m / 2),
            (p = e(x.at, g, m)),
            (_.left += p[0]),
            (_.top += p[1]),
            this.each(function () {
