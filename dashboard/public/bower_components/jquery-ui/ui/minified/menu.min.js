  ...
  t.widget("ui.menu", {
    ...
    _activate: function (t) {
      this.active.is(".ui-state-disabled") ||
        (this.active.is("[aria-haspopup='true']") ? this.expand(t) : this.select(t));
    },
    refresh: function () {
      var e,
        i,
    ...
    _scrollIntoView: function (e) {
      var i, s, n, o, a, r;
      this._hasScroll() &&
        ((i = Number.parseFloat(t.css(this.activeMenu[0], "borderTopWidth")) || 0),
        (s = Number.parseFloat(t.css(this.activeMenu[0], "paddingTop")) || 0),
