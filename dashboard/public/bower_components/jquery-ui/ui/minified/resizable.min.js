...
((t) => {
  ...
  (t) => (
    t.widget("ui.resizable", t.ui.mouse, {
      ...
      _num: (t) => Number.parseInt(t, 10) || 0,
      _isNumber: (t) => !isNaN(Number.parseInt(t, 10)),
      _hasScroll: (e, i) => {
      ...
      _mouseCapture: function (e) {
        var i,
          ...
          o = !1;
        for (i in this.handles)
          (s = t(this.handles[i])[0]), (s === e.target || t.contains(s, e.target)) && (o = !0);
      ...
      _mouseStart: function (e) {
        ...
        return (
          ...
          n.containment &&
            ((i += t(n.containment).scrollLeft() || 0), (s += t(n.containment).scrollTop() || 0)),
      ...
      _mouseStop: function (e) {
        ...
        return (
          this._helper &&
            ...
            (o = s && this._hasScroll(i[0], "left") ? 0 : this.sizeDiff.height),
            (n = s ? 0 : this.sizeDiff.width),
            (r = { width: this.helper.width() - n, height: this.helper.height() - o }),
            (a =
      ...
      _getPaddingPlusBorderDimensions: (t) => {
        for (
          ...
          (i[e] = Number.parseInt(s[e], 10) || 0), (i[e] += Number.parseInt(o[e], 10) || 0);
    ...
    t.ui.plugin.add("resizable", "containment", {
      start: function () {
        var e,
          ...
          p = h.element,
          d = l.containment,
          c = d instanceof t ? d.get(0) : /parent/.test(d) ? p.parent().get(0) : d;
        c &&
          ...
          /document/.test(d) || d === document
            ...
            : ((e = t(c)),
              ...
              (h.parentData = { element: c, left: s.left, top: s.top, width: r, height: a })));
      },
      resize: function (e) {
        var i,
          s,
        ...
        c[0] !== document && /static/.test(c.css("position")) && (d = h),
          l.left < (r._helper ? h.left : 0) &&
            ((r.size.width =
              r.size.width + (r._helper ? r.position.left - h.left : r.position.left - d.left)),
            p && ((r.size.height = r.size.width / r.aspectRatio), (u = !1)),
            (r.position.left = a.helper ? h.left : 0)),
          l.top < (r._helper ? h.top : 0) &&
            ((r.size.height =
              r.size.height + (r._helper ? r.position.top - h.top : r.position.top)),
          ...
          (i = Math.abs(
            r.sizeDiff.width + (r._helper ? r.offset.left - d.left : r.offset.left - h.left)
          )),
          (s = Math.abs(
            r.sizeDiff.height + (r._helper ? r.offset.top - d.top : r.offset.top - h.top)
          )),
      ...
      start: function () {
        ...
        t(i.alsoResize).each(function () {
          ...
          e.data("ui-resizable-alsoresize", {
            width: Number.parseInt(e.width(), 10),
            height: Number.parseInt(e.height(), 10),
            left: Number.parseInt(e.css("left"), 10),
            top: Number.parseInt(e.css("top"), 10),
          });
        });
      },
      resize: function (e, i) {
      ...
      resize: function () {
        ...
        (s.grid = h),
          ...
          /^(se|s|e)$/.test(a)
            ...
            : /^(ne)$/.test(a)
              ? ((i.size.width = u), (i.size.height = f), (i.position.top = r.top - c))
              : /^(sw)$/.test(a)
                ? ((i.size.width = u), (i.size.height = f), (i.position.left = r.left - d))
                : ((0 >= f - p || 0 >= u - l) && (e = i._getPaddingPlusBorderDimensions(this)),
                  f - p > 0
