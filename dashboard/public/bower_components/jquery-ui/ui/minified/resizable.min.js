    ...
    t.widget("ui.resizable", t.ui.mouse, {
      ...
      _mouseStart: function (e) {
        ...
        return (
          ...
          n.containment && ((i += t(n.containment).scrollLeft() || 0), (s += t(n.containment).scrollTop() || 0)),
      ...
      resize: function (e) {
        ...
        c[0] !== document && /static/.test(c.css("position")) && (d = h),
          l.left < (r._helper ? h.left : 0) &&
            ((r.size.width = r.size.width + (r._helper ? r.position.left - h.left : r.position.left - d.left)),
          ...
          i + r.size.width >= r.parentData.width &&
            ((r.size.width = r.parentData.width - i), p && ((r.size.height = r.size.width / r.aspectRatio), (u = !1))),
              ...
              : /^(sw)$/.test(a)
                ...
                : ((0 >= f - p || 0 >= u - l) && (e = i._getPaddingPlusBorderDimensions(this)),
                  f - p > 0
                    ...
                    : ((f = p - e.height), (i.size.height = f), (i.position.top = r.top + n.height - f)),
                  u - l > 0
                    ? ((i.size.width = u), (i.position.left = r.left - d))
                    : ((u = l - e.width), (i.size.width = u), (i.position.left = r.left + n.width - u)));
      },
    }),
    t.ui.resizable
  );
