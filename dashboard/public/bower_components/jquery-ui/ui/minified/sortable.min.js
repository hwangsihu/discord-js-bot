...
(function (t) {
  ...
  return t.widget("ui.sortable", t.ui.mouse, {
          ...
          this.options.scroll &&
            (this.scrollParent[0] !== this.document[0] && "HTML" !== this.scrollParent[0].tagName
              ? (this.overflowOffset.top + this.scrollParent[0].offsetHeight - e.pageY < r.scrollSensitivity
                  ? (this.scrollParent[0].scrollTop = h = this.scrollParent[0].scrollTop + r.scrollSpeed)
                ...
                this.overflowOffset.left + this.scrollParent[0].offsetWidth - e.pageX < r.scrollSensitivity
                  ? (this.scrollParent[0].scrollLeft = h = this.scrollParent[0].scrollLeft + r.scrollSpeed)
    ...
    _intersectsWithPointer: function (t) {
      var e =
          "x" === this.options.axis || this._isOverAxis(this.positionAbs.top + this.offset.click.top, t.top, t.height),
        i =
          "y" === this.options.axis ||
              ...
              r &&
                ...
                a.push([
                  t.isFunction(r.options.items)
                    ...
                    : t(r.options.items, r.element).not(".ui-sortable-helper").not(".ui-sortable-placeholder"),
                  r,
                ]);
      for (
        a.push([
        ...
        if (1 === this.containers.length)
          ...
          for (
            ...
            t.contains(this.containers[u].element[0], this.items[s].item[0]) &&
              ...
              n > Math.abs(e[p] - a) &&
                ((n = Math.abs(e[p] - a)), (o = this.items[s]), (this.direction = l ? "up" : "down")));
      ...
      return (
              ...
              : s))),
        {
          ...
          left:
            ...
            this.offset.parent.left +
            ("fixed" === this.cssPosition ? -this.scrollParent.scrollLeft() : a ? 0 : h.scrollLeft()),
        }
      );
    },
