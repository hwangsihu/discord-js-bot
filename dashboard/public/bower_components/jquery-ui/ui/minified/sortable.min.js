          ...
          this.options.scroll &&
            (this.scrollParent[0] !== this.document[0] && "HTML" !== this.scrollParent[0].tagName
              ...
              : (e.pageY - this.document.scrollTop() < r.scrollSensitivity
                  ? (h = this.document.scrollTop(this.document.scrollTop() - r.scrollSpeed))
                  : this.window.height() - (e.pageY - this.document.scrollTop()) <
                      r.scrollSensitivity &&
                    (h = this.document.scrollTop(this.document.scrollTop() + r.scrollSpeed)),
                e.pageX - this.document.scrollLeft() < r.scrollSensitivity
                  ? (h = this.document.scrollLeft(this.document.scrollLeft() - r.scrollSpeed))
      ...
      if (e) {
        if (
          ...
          (o && "x" !== o) ||
            ...
            (this.reverting = !0),
            t(this.helper).animate(r, Number.parseInt(this.options.revert, 10) || 500, () => {
              this._clear(e);
            });
      ...
      for (i = p.length - 1; i >= 0; i--)
        for (r = p[i][1], h = p[i][0], s = 0, l = h.length; l > s; s++)
          (a = t(h[s])),
            ...
            c.push({ item: a, instance: r, width: 0, height: 0, left: 0, top: 0 });
    },
              ...
              (n.height() ||
                n.height(
                  e.currentItem.innerHeight() -
                    Number.parseInt(e.currentItem.css("paddingTop") || 0, 10) -
                    Number.parseInt(e.currentItem.css("paddingBottom") || 0, 10)
                ),
              n.width() ||
                n.width(
                  e.currentItem.innerWidth() -
                    Number.parseInt(e.currentItem.css("paddingLeft") || 0, 10) -
                    Number.parseInt(e.currentItem.css("paddingRight") || 0, 10)
                ));
          },
        })),
    ...
    _setContainment: function () {
      ...
      "parent" === n.containment && (n.containment = this.helper[0].parentNode),
        ...
        /^(document|window|parent)$/.test(n.containment) ||
          ...
          (this.containment = [
            i.left +
              (Number.parseInt(t(e).css("borderLeftWidth"), 10) || 0) +
              (Number.parseInt(t(e).css("paddingLeft"), 10) || 0) -
              this.margins.left,
            i.top +
              (Number.parseInt(t(e).css("borderTopWidth"), 10) || 0) +
              (Number.parseInt(t(e).css("paddingTop"), 10) || 0) -
              this.margins.top,
            i.left +
              (s ? Math.max(e.scrollWidth, e.offsetWidth) : e.offsetWidth) -
              (Number.parseInt(t(e).css("borderLeftWidth"), 10) || 0) -
              (Number.parseInt(t(e).css("paddingRight"), 10) || 0) -
              this.helperProportions.width -
              this.margins.left,
            i.top +
              (s ? Math.max(e.scrollHeight, e.offsetHeight) : e.offsetHeight) -
              (Number.parseInt(t(e).css("borderTopWidth"), 10) || 0) -
              (Number.parseInt(t(e).css("paddingBottom"), 10) || 0) -
              this.helperProportions.height -
              this.margins.top,
          ]));
    },
    ...
    _generatePosition: function (e) {
      ...
      return (
        ...
        this.originalPosition &&
          ...
          n.grid &&
            ((i =
              this.originalPageY + Math.round((r - this.originalPageY) / n.grid[1]) * n.grid[1]),
            (r = this.containment
              ...
              : s))),
        {
          top:
            ...
            this.offset.parent.top +
            ("fixed" === this.cssPosition ? -this.scrollParent.scrollTop() : a ? 0 : h.scrollTop()),
          left:
            o -
