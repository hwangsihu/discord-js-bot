...
((t) => {
  ...
  t.widget("ui.selectmenu", {
          ...
          .menu({
            ...
            focus: (t, i) => {
              ...
              null != this.focusIndex &&
                ...
                (this._trigger("focus", t, { item: s }), this.isOpen || this._select(s, t)),
    ...
    _renderItem: function (e, i) {
      var s = t("<li>");
      return (
        i.disabled && s.addClass("ui-state-disabled"), this._setText(s, i.label), s.appendTo(e)
      );
    },
    _setText: (t, e) => {
      e ? t.text(e) : t.html("&#160;");
    ...
    _documentClick: {
      mousedown: function (e) {
        this.isOpen &&
          (t(e.target).closest(".ui-selectmenu-menu, #" + this.ids.button).length || this.close(e));
      },
    },
    _buttonEvents: {
      mousedown: function () {
    ...
    _setOption: function (t, e) {
      "icons" === t &&
        this.button.find("span.ui-icon").removeClass(this.options.icons.button).addClass(e.button),
        this._super(t, e),
