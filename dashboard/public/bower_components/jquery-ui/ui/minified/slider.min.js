  ...
  t.widget("ui.slider", t.ui.mouse, {
              ...
              (this._clickOffset = l
                ...
                : {
                    ...
                    top:
                      ...
                      h.top -
                      o.height() / 2 -
                      (Number.parseInt(o.css("borderTopWidth"), 10) || 0) -
                      (Number.parseInt(o.css("borderBottomWidth"), 10) || 0) +
                      (Number.parseInt(o.css("marginTop"), 10) || 0),
                  }),
    ...
    _trimAlignValue: function (t) {
      ...
      var e = this.options.step > 0 ? this.options.step : 1,
        ...
        s = t - i;
      return 2 * Math.abs(i) >= e && (s += i > 0 ? e : -e), Number.parseFloat(s.toFixed(5));
    },
    _calculateNewMax: function () {
      ...
      (t = s + e), (this.max = Number.parseFloat(t.toFixed(this._precision())));
    },
    _precision: function () {
    ...
    _handleEvents: {
      keydown: function (e) {
        ...
        switch (
          ((o = this.options.step),
          (s = n =
            this.options.values && this.options.values.length ? this.values(a) : this.value()),
          e.keyCode)
        ) {
          case t.ui.keyCode.HOME:
            n = this._valueMin();
