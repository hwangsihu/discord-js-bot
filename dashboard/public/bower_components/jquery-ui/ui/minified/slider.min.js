  ...
  return t.widget("ui.slider", t.ui.mouse, {
      ...
      this.options.values && this.options.values.length
        ? ((s = this.values(e ? 0 : 1)),
          ...
          i !== this.values(e) &&
            ...
            o !== !1 && this.values(e, i)))
        : i !== this.value() &&
          ((o = this._trigger("slide", t, { handle: this.handles[e], value: i })), o !== !1 && this.value(i));
    },
    _stop: function (t, e) {
      var i = { handle: this.handles[e], value: this.value() };
      this.options.values && this.options.values.length && ((i.value = this.values(e)), (i.values = this.values())),
    ...
    _handleEvents: {
        ...
        switch (e.keyCode) {
          ...
          case t.ui.keyCode.LEFT:
            if (
              (e.preventDefault(),
              !this._keySliding &&
                ((this._keySliding = !0), t(e.target).addClass("ui-state-active"), (i = this._start(e, a)), i === !1))
            )
              return;
        }
        switch (
      ...
      keyup: function (e) {
        ...
        this._keySliding &&
          ((this._keySliding = !1), this._stop(e, i), this._change(e, i), t(e.target).removeClass("ui-state-active"));
      },
    },
  });
});
