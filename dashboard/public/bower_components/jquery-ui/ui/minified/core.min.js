  ...
  (t.ui = t.ui || {}),
          ...
          o = this.parents()
            .filter(function () {
              ...
              return i && "static" === e.css("position")
                ? !1
                : r.test(e.css("overflow") + e.css("overflow-y") + e.css("overflow-x"));
            })
            .eq(0);
    ...
    t.extend(t.expr[":"], {
      data: t.expr.createPseudo
        ? t.expr.createPseudo((e) => (n) => !!t.data(n, e))
        : (e, n, i) => !!t.data(e, i[3]),
      focusable: (n) => e(n, !isNaN(t.attr(n, "tabindex"))),
      tabbable: (n) => {
    ...
    t("<a>").outerWidth(1).jquery ||
      t.each(["Width", "Height"], (e, n) => {
        function i(e, n, i, o) {
          return (
            t.each(r, function () {
              (n -= Number.parseFloat(t.css(e, "padding" + this)) || 0),
                i && (n -= Number.parseFloat(t.css(e, "border" + this + "Width")) || 0),
                o && (n -= Number.parseFloat(t.css(e, "margin" + this)) || 0);
            }),
            n
          );
        }
    ...
    t.fn.extend({
      ...
      disableSelection: (() => {
        ...
        return function () {
          return this.bind(t + ".ui-disableSelection", (t) => {
            t.preventDefault();
          });
        };
      })(),
          ...
          for (var n, i, r = t(this[0]); r.length && r[0] !== document; ) {
            if (
              ...
              ("absolute" === n || "relative" === n || "fixed" === n) &&
                ((i = Number.parseInt(r.css("zIndex"), 10)), !isNaN(i) && 0 !== i))
            )
              return i;
            r = r.parent();
          }
