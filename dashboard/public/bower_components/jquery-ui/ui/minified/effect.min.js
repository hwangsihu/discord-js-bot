  ...
  return (
    ...
    (function (t, e) {
        ...
        return (
          ...
          f(h, function (t, o) {
            var r,
              ...
              h = a && o.parse(a),
              l = o.space || "rgba";
            return h ? ((r = s[l](h)), (s[c[l].cache] = r[c[l].cache]), (n = s._rgba = r._rgba), !1) : e;
          }),
      ...
      var o,
        ...
        p = { byte: { floor: !0, max: 255 }, percent: { max: 1 }, degrees: { mod: 360, floor: !0 } },
        u = (l.support = {}),
        d = t("<p>")[0],
        f = t.each;
            ...
            return (
              ...
              f(o.props, function (t, n) {
                ...
                null !== l &&
                  (null === r
                    ? (h[o] = l)
                    : (c.mod && (l - r > c.mod / 2 ? (r += c.mod) : r - l > c.mod / 2 && (r -= c.mod)),
                      (h[o] = i((l - r) * e + r, n))));
              }),
              this[n](h)
            );
                  ...
                  return "undefined" === r
                    ...
                    : ("function" === r && ((n = n.call(this, c)), (r = t.type(n))),
                      null == n && i.empty
                        ? this
                        : ("string" === r &&
                            ((o = a.exec(n)), o && (n = c + parseFloat(o[2]) * ("+" === o[1] ? 1 : -1))),
                          (l[i.idx] = n),
                          this[h](l)));
                });
            });
