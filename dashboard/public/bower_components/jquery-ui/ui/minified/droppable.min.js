    ...
    (t.ui.intersect = (() => {
      ...
      return (e, i, s, o) => {
        ...
        switch (s) {
          ...
          case "pointer":
            return t(o.pageY, p, i.proportions().height) && t(o.pageX, h, i.proportions().width);
          case "touch":
            return (
        ...
        t: for (s = 0; n.length > s; s++)
          if (
            !(
              ...
              (e && !n[s].accept.call(n[s].element[0], e.currentItem || e.element))
            )
          ) {
            ...
            if (!this.options.disabled && !this.greedyChild && this.visible) {
              ...
              a &&
                (this.options.greedy &&
                  ...
                  n.length &&
                    ((s = t(n[0]).droppable("instance")), (s.greedyChild = "isover" === a))),
                s && "isover" === a && ((s.isover = !1), (s.isout = !0), s._out.call(s, i)),
                (this[a] = !0),
                (this["isout" === a ? "isover" : "isout"] = !1),
                this["isover" === a ? "_over" : "_out"].call(this, i),
                s && "isout" === a && ((s.isout = !1), (s.isover = !0), s._over.call(s, i)));
            }
          });
      },
      dragStop: (e, i) => {
