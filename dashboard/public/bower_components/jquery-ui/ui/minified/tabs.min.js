  ...
  t.widget("ui.tabs", {
      ...
      (this.running = !1),
        ...
        t.isArray(i.disabled) &&
          (i.disabled = t
            .unique(
              i.disabled.concat(
                t.map(this.tabs.filter(".ui-state-disabled"), (t) => this.tabs.index(t))
              )
            )
            .sort()),
        (this.active =
    ...
    _initialActive: function () {
      ...
      return (
        null === e &&
          (s &&
            this.tabs.each((i, n) => (t(n).attr("aria-controls") === s ? ((e = i), !1) : void 0)),
    ...
    _sanitizeSelector: (t) => (t ? t.replace(/[!"$%&'()*+,.\/:;<=>?@\[\]\^`{|}~]/g, "\\$&") : ""),
    refresh: function () {
      var e = this.options,
        ...
        this.anchors.each((i, s) => {
          ...
          this._isLocal(s)
            ...
            : ((a = h.attr("aria-controls") || t({}).uniqueId()[0].id),
              ...
              o.length ||
                ((o = this._createPanel(a)), o.insertAfter(this.panels[i - 1] || this.tablist)),
    ...
    _ajaxSettings: function (e, i, s) {
      return {
        url: e.attr("href"),
        beforeSend: (e, o) =>
          this._trigger("beforeLoad", i, t.extend({ jqXHR: e, ajaxSettings: o }, s)),
      };
    },
