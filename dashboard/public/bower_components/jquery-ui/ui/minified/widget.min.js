  ...
  return (
    ...
    (t.widget = (e, i, n) => {
      ...
      return (
        ...
        (s = d + "-" + e),
        n || ((n = i), (i = t.Widget)),
        (t.expr[":"][s.toLowerCase()] = (e) => !!t.data(e, s)),
        (t[d] = t[d] || {}),
        (o = t[d][e]),
        (r = t[d][e] =
          function (t, e) {
        ...
        o
          ? (t.each(o._childConstructors, (e, i) => {
              var n = i.prototype;
    ...
    (t.Widget.prototype = {
      ...
      option: function (e, i) {
        ...
        if ("string" == typeof e)
          if (((r = {}), (n = e.split(".")), (e = n.shift()), n.length)) {
            for (s = r[e] = t.widget.extend({}, this.options[e]), o = 0; n.length - 1 > o; o++)
              (s[n[o]] = s[n[o]] || {}), (s = s[n[o]]);
      ...
      _trigger: function (e, i, n) {
        ...
        return (
          ...
          !(
            (t.isFunction(r) && r.apply(this.element[0], [i].concat(n)) === !1) ||
