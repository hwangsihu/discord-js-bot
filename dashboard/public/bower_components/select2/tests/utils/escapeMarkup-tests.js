...
test("text passes through", (assert) => {
...
test("html tags are escaped", (assert) => {
...
test("quotes are killed as well", (assert) => {
...
test("DocumentFragment options pass through", (assert) => {
