...
test("appends to the dropdown parent", (assert) => {
  assert.expect(4);
...
test("dropdown is positioned down with static margins", (assert) => {
  var $ = require("jquery");
  var $select = $("<select></select>");
  var $parent = $("<div></div>");
  $parent.css({
...
test("dropdown is positioned down with absolute offsets", (assert) => {
  var $ = require("jquery");
  var $select = $("<select></select>");
  var $parent = $("<div></div>");
  $parent.css({
