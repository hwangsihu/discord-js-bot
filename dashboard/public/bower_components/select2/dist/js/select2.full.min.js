/*! Select2 4.0.7 | https://github.com/select2/select2/blob/master/LICENSE.md */ !((a) => {
  "function" == typeof define && define.amd
    ? define(["jquery"], a)
    : "object" == typeof module && module.exports
      ? (module.exports = (b, c) => (
          void 0 === c &&
            (c = "undefined" != typeof window ? require("jquery") : require("jquery")(b)),
          a(c),
          c
        ))
      : a(jQuery);
  ...
  var b = (() => {
      ...
      return (
            ...
            !((b) => {
              ...
              (p = (a, b) => {
                ...
                (q = {
                  ...
                  module: (a) => ({ id: a, uri: "", exports: r[a], config: m(a) }),
                }),
                (n = (a, c, d, f) => {
                  var h,
                    k,
        ...
        b.define("select2/utils", ["jquery"], (a) => {
          function b(a) {
            var b = a.prototype,
              c = [];
            for (var d in b) {
          ...
          (d.prototype.on = function (a, b) {
            ...
            (c.escapeMarkup = (a) => {
              ...
              return "string" != typeof a ? a : String(a).replace(/[&<>"'\/\\]/g, (a) => b[a]);
            }),
            (c.appendMany = (b, c) => {
        ...
        b.define("select2/results", ["jquery", "./utils"], (a, b) => {
          function c(a, b, d) {
            (this.$element = a),
              (this.data = d),
              (this.options = b),
          ...
          return (
            ...
            (c.prototype.setClasses = function () {
              this.data.current((d) => {
                var e = a.map(d, (a) => a.id.toString());
                this.$results.find(".select2-results__option[aria-selected]").each(function () {
                  var c = a(this),
            ...
            (c.prototype.bind = function (c, d) {
              ...
              this.$results.attr("id", f),
                ...
                c.on("select", () => {
                  c.isOpen() &&
                    (e.setClasses(), e.options.get("scrollAfterSelect") && e.highlightFirstItem());
                }),
                c.on("unselect", () => {
                  c.isOpen() &&
                    (e.setClasses(), e.options.get("scrollAfterSelect") && e.highlightFirstItem());
                ...
                c.on("results:focus", (a) => {
                  a.element.addClass("select2-results__option--highlighted");
                }),
                c.on("results:message", (a) => {
                  e.displayMessage(a);
                }),
                a.fn.mousewheel &&
                  this.$results.on("mousewheel", (a) => {
        ...
        b.define("select2/selection/base", ["jquery", "../utils", "../keys"], (a, b, c) => {
          function d(a, b) {
          ...
          return (
            ...
            (d.prototype.bind = function (a, b) {
              var e = (a.id, a.id + "-results");
              (this.container = a),
                this.$selection.on("focus", (a) => {
                  this.trigger("focus", a);
                }),
                this.$selection.on("blur", (a) => {
                  this._handleBlur(a);
                }),
                this.$selection.on("keydown", (a) => {
                  this.trigger("keypress", a), a.which === c.SPACE && a.preventDefault();
                }),
                a.on("results:focus", (a) => {
                  this.$selection.attr("aria-activedescendant", a.data._resultId);
                }),
                a.on("selection:update", (a) => {
                  this.update(a.data);
                }),
                a.on("open", () => {
                  this.$selection.attr("aria-expanded", "true"),
                    this.$selection.attr("aria-owns", e),
                    this._attachCloseHandler(a);
                }),
                a.on("close", () => {
            ...
            (d.prototype._handleBlur = function (b) {
              window.setTimeout(() => {
                document.activeElement == this.$selection[0] ||
                  a.contains(this.$selection[0], document.activeElement) ||
                  this.trigger("blur", b);
              }, 1);
            }),
            (d.prototype._attachCloseHandler = (c) => {
              a(document.body).on("mousedown.select2." + c.id, (c) => {
                var d = a(c.target),
                  e = d.closest(".select2");
            ...
            (d.prototype._detachCloseHandler = (b) => {
              a(document.body).off("mousedown.select2." + b.id);
            }),
            (d.prototype.position = (a, b) => {
              b.find(".selection").append(a);
            }),
            (d.prototype.destroy = function () {
              this._detachCloseHandler(this.container);
            }),
            (d.prototype.update = (a) => {
            ...
            return (
              ...
              (e.prototype.bind = function (a, b) {
                ...
                this.$selection
                  ...
                  this.$selection.on("mousedown", (a) => {
                    1 === a.which && this.trigger("toggle", { originalEvent: a });
                  }),
                  this.$selection.on("focus", (a) => {}),
                  this.$selection.on("blur", (a) => {}),
                  a.on("focus", (b) => {
                    a.isOpen() || this.$selection.focus();
                  });
              }),
              ...
              (e.prototype.selectionContainer = () => a("<span></span>")),
        ...
        b.define("select2/selection/multiple", ["jquery", "./base", "../utils"], (a, b, c) => {
          function d(a, b) {
        ...
        b.define("select2/selection/placeholder", ["../utils"], (a) => {
          function b(a, b, c) {
            (this.placeholder = this.normalizePlaceholder(c.get("placeholder"))),
              a.call(this, b, c);
          }
          return (
            (b.prototype.normalizePlaceholder = (a, b) => (
              "string" == typeof b && (b = { id: "", text: b }), b
            )),
        ...
        b.define("select2/selection/allowClear", ["jquery", "../keys", "../utils"], (a, b, c) => {
          function d() {}
          return (
            (d.prototype.bind = function (a, b, c) {
              a.call(this, b, c),
                ...
                this.$selection.on("mousedown", ".select2-selection__clear", (a) => {
                  this._handleClear(a);
                }),
                b.on("keypress", (a) => {
                  this._handleKeyboardClear(a, b);
                });
            }),
            ...
            (d.prototype.update = function (b, d) {
              if (
                ...
                var e = this.options.get("translations").get("removeAllItems"),
                  f = a(
                    '<span class="select2-selection__clear" title="' + e() + '">&times;</span>'
                  );
        ...
        b.define("select2/selection/search", ["jquery", "../utils", "../keys"], (a, b, c) => {
          function d(a, b, c) {
            a.call(this, b, c);
          }
          return (
            ...
            (d.prototype.bind = function (a, d, e) {
              a.call(this, d, e),
                ...
                d.on("results:focus", (a) => {
                  this.$search.attr("aria-activedescendant", a.id);
                }),
                this.$selection.on("focusin", ".select2-search--inline", (a) => {
                  this.trigger("focus", a);
                }),
                this.$selection.on("focusout", ".select2-search--inline", (a) => {
                  this._handleBlur(a);
                }),
                this.$selection.on("keydown", ".select2-search--inline", (a) => {
                  if (
                    (a.stopPropagation(),
                    this.trigger("keypress", a),
                    (this._keyUpPrevented = a.isDefaultPrevented()),
                    a.which === c.BACKSPACE && "" === this.$search.val())
                  ) {
                    var d = this.$searchContainer.prev(".select2-selection__choice");
                    if (d.length > 0) {
                      var e = b.GetData(d[0], "data");
                      this.searchRemoveChoice(e), a.preventDefault();
                    }
                  }
                });
              var g = document.documentMode,
                h = g && g <= 11;
              this.$selection.on("input.searchcheck", ".select2-search--inline", (a) => {
                if (h) return void this.$selection.off("input.search input.searchcheck");
                this.$selection.off("keyup.search");
              }),
                this.$selection.on("keyup.search input.search", ".select2-search--inline", (a) => {
                  if (h && "input" === a.type)
                    return void this.$selection.off("input.search input.searchcheck");
                  var b = a.which;
                  b != c.SHIFT && b != c.CTRL && b != c.ALT && b != c.TAB && this.handleSearch(a);
                });
            }),
        ...
        b.define("select2/selection/eventRelay", ["jquery"], (a) => {
          function b() {}
          return (
        ...
        b.define("select2/translation", ["jquery", "require"], (a, b) => {
          function c(a) {
            this.dict = a || {};
          }
          return (
        ...
        b.define("select2/data/base", ["../utils"], (a) => {
          function b(a, c) {
            b.__super__.constructor.call(this);
          }
          return (
            a.Extend(b, a.Observable),
            (b.prototype.current = (a) => {
              throw new Error("The `current` method must be defined in child classes.");
            }),
            (b.prototype.query = (a, b) => {
              throw new Error("The `query` method must be defined in child classes.");
            }),
            (b.prototype.bind = (a, b) => {}),
            (b.prototype.destroy = () => {}),
            (b.prototype.generateResultId = (b, c) => {
              var d = b.id + "-result-";
              return (
                (d += a.generateChars(4)),
        ...
        b.define("select2/data/select", ["./base", "../utils", "jquery"], (a, b, c) => {
          ...
          return (
            ...
            (d.prototype.item = function (a) {
              ...
              return (
                (d = this._normalizeItem(d)), (d.element = a[0]), b.StoreData(a[0], "data", d), d
              );
            }),
        ...
        b.define("select2/data/array", ["./select", "../utils", "jquery"], (a, b, c) => {
          function d(a, b) {
            var c = b.get("data") || [];
          ...
          return (
            b.Extend(d, a),
            (d.prototype.select = function (a) {
              var b = this.$element.find("option").filter((b, c) => c.value == a.id.toString());
        ...
        b.define("select2/data/ajax", ["./array", "../utils", "jquery"], (a, b, c) => {
          function d(a, b) {
          ...
          return (
            b.Extend(d, a),
            (d.prototype._applyDefaults = (a) => {
              var b = {
                data: (a) => c.extend({}, a, { q: a.term }),
                transport: (a, b, d) => {
                  var e = c.ajax(a);
            ...
            (d.prototype.processResults = (a) => a),
            (d.prototype.query = function (a, b) {
              function d() {
                var d = f.transport(
                  f,
        ...
        b.define("select2/data/tags", ["jquery"], (a) => {
          function b(b, c, d) {
            var e = d.get("tags"),
              f = d.get("createTag");
          ...
          return (
            ...
            (b.prototype.createTag = (b, c) => {
              var d = a.trim(c.term);
              return "" === d ? null : { id: d, text: d };
            }),
            (b.prototype.insertTag = (a, b, c) => {
              b.unshift(c);
            }),
        ...
        b.define("select2/data/tokenizer", ["jquery"], (a) => {
          function b(a, b, c) {
            ...
            (b.prototype.tokenizer = function (b, c, d, e) {
              for (
                var f = d.get("tokenSeparators") || [],
                  g = c.term,
                  h = 0,
                  i = this.createTag || ((a) => ({ id: a.term, text: a.term }));
                h < g.length;
              ) {
                var j = g[h];
                if (-1 !== a.inArray(j, f)) {
          ...
          return (
            (a.prototype.query = function (a, b, c) {
              this.current((e) => {
                ...
                if (this.maximumSelectionLength > 0 && f >= this.maximumSelectionLength)
                  return void this.trigger("results:message", {
        ...
        b.define("select2/dropdown", ["jquery", "./utils"], (a, b) => {
          function c(a, b) {
        ...
        b.define("select2/dropdown/search", ["jquery", "../utils"], (a, b) => {
          function c() {}
          return (
            ...
            (c.prototype.bind = function (b, c, d) {
              b.call(this, c, d),
                this.$search.on("keydown", (a) => {
                  this.trigger("keypress", a), (this._keyUpPrevented = a.isDefaultPrevented());
                }),
                this.$search.on("input", function (b) {
                  a(this).off("keyup");
                }),
                this.$search.on("keyup input", (a) => {
                  this.handleSearch(a);
                }),
                c.on("open", () => {
                ...
                c.on("close", () => {
                  this.$search.attr("tabindex", -1), this.$search.val(""), this.$search.blur();
                }),
                c.on("focus", () => {
                  c.isOpen() || this.$search.focus();
                }),
                c.on("results:all", (a) => {
        ...
        b.define("select2/dropdown/hidePlaceholder", [], () => {
          ...
          return (
            ...
            (a.prototype.normalizePlaceholder = (a, b) => (
              "string" == typeof b && (b = { id: "", text: b }), b
            )),
        ...
        b.define("select2/dropdown/infiniteScroll", ["jquery"], (a) => {
          function b(a, b, c, d) {
            (this.lastParams = {}),
              a.call(this, b, c, d),
          ...
          return (
            ...
            (b.prototype.bind = function (b, c, d) {
              b.call(this, c, d),
                c.on("query", (a) => {
                  (this.lastParams = a), (this.loading = !0);
                }),
                c.on("query:append", (a) => {
                  (this.lastParams = a), (this.loading = !0);
                }),
            ...
            (b.prototype.showLoadingMore = (a, b) => b.pagination && b.pagination.more),
        ...
        b.define("select2/dropdown/attachBody", ["jquery", "../utils"], (a, b) => {
          function c(b, c, d) {
          ...
          return (
            (c.prototype.bind = function (a, b, c) {
              ...
              a.call(this, b, c),
                b.on("open", () => {
                  this._showDropdown(),
                    this._attachPositioningHandler(b),
                    e ||
                      ((e = !0),
                      b.on("results:all", () => {
                ...
                b.on("close", () => {
                  this._hideDropdown(), this._detachPositioningHandler(b);
                }),
                this.$dropdownContainer.on("mousedown", (a) => {
                  a.stopPropagation();
                });
            }),
        ...
        b.define("select2/dropdown/selectOnClose", ["../utils"], (a) => {
          function b() {}
          return (
            (b.prototype.bind = function (a, b, c) {
              a.call(this, b, c),
                b.on("close", (a) => {
                  this._handleSelectOnClose(a);
                });
            }),
          ...
          return (
            ...
            (a.prototype._selectTriggered = function (a, b) {
              ...
              (c && (c.ctrlKey || c.metaKey)) ||
                this.trigger("close", { originalEvent: c, originalSelect2Event: b });
            }),
            a
          );
        }),
        b.define("select2/i18n/en", [], () => ({
          ...
          inputTooShort: (a) =>
            "Please enter " + (a.minimum - a.input.length) + " or more characters",
            ...
            return (
              ...
              (D.prototype.reset = function () {
                ...
                this.defaults = {
                  ...
                  scrollAfterSelect: !1,
                  sorter: (a) => a,
                  templateResult: (a) => a.text,
                  templateSelection: (a) => a.text,
                  theme: "default",
                  width: "resolve",
                };
              }),
        ...
        b.define("select2/core", ["jquery", "./options", "./utils", "./keys"], (a, b, c, d) => {
          var e = function (a, d) {
            ...
            this._bindAdapters(),
              ...
              this.dataAdapter.current((a) => {
                this.trigger("selection:update", { data: a });
              }),
          ...
          return (
            ...
            (e.prototype._registerDomEvents = function () {
              this.$element.on("change.select2", () => {
                ...
                this.$element.on("focus.select2", (a) => {
                  this.trigger("focus", a);
                }),
              ...
              null != d
                ? ((this._observer = new d((c) => {
                    a.each(c, this._syncA), a.each(c, this._syncS);
                  })),
                ...
                : this.$element[0].addEventListener &&
                  (this.$element[0].addEventListener("DOMAttrModified", this._syncA, !1),
                  this.$element[0].addEventListener("DOMNodeInserted", this._syncS, !1),
                  this.$element[0].addEventListener("DOMNodeRemoved", this._syncS, !1));
            }),
            (e.prototype._registerDataEvents = function () {
              this.dataAdapter.on("*", (b, c) => {
                this.trigger(b, c);
              });
            }),
            (e.prototype._registerSelectionEvents = function () {
              ...
              this.selection.on("toggle", () => {
                ...
                this.selection.on("*", (d, e) => {
                  -1 === a.inArray(d, c) && this.trigger(d, e);
                });
            }),
            (e.prototype._registerDropdownEvents = function () {
              this.dropdown.on("*", (b, c) => {
                this.trigger(b, c);
              });
            }),
            ...
            (e.prototype.val = function (b) {
              ...
              var c = b[0];
              a.isArray(c) && (c = a.map(c, (a) => a.toString())),
        ...
        b.define("select2/compat/utils", ["jquery"], (a) => {
          function b(b, c, d) {
            var e,
              f,
              g = [];
        ...
        b.define("select2/compat/containerCss", ["jquery", "./utils"], (a, b) => {
          function c(a) {
            return null;
          }
          function d() {}
        ...
        b.define("select2/compat/dropdownCss", ["jquery", "./utils"], (a, b) => {
          function c(a) {
            return null;
          }
          function d() {}
        ...
        b.define("select2/compat/initSelection", ["jquery"], (a) => {
          function b(a, b, c) {
            c.get("debug") &&
              window.console &&
              console.warn &&
          ...
          return (
            (b.prototype.current = function (b, c) {
              ...
              this.initSelection.call(null, this.$element, (b) => {
                (this._isInitialized = !0), a.isArray(b) || (b = [b]), c(b);
              });
            }),
            b
          );
        }),
        b.define("select2/compat/inputData", ["jquery", "../utils"], (a, b) => {
          function c(a, b, c) {
            (this._currentData = []),
          ...
          return (
            ...
            (c.prototype.unselect = function (a, b) {
              (b.selected = !1),
                this.current((a) => {
                  ...
                  this.$element.val(d.join(this._valueSeparator)), this.$element.trigger("change");
                });
            }),
            ...
            (c.prototype.addOptions = function (c, d) {
              var e = a.map(d, (a) => b.GetData(a[0], "data"));
              this._currentData.push.apply(this._currentData, e);
            }),
            c
          );
        }),
        b.define("select2/compat/matcher", ["jquery"], (a) => {
          function b(b) {
            function c(c, d) {
              var e = a.extend(!0, {}, d);
        ...
        ((c) => {
          ...
          var k = (a.event.special.mousewheel = {
            ...
            getLineHeight: (b) => {
              ...
              return (
                d.length || (d = a("body")),
                Number.parseInt(d.css("fontSize"), 10) ||
                  Number.parseInt(c.css("fontSize"), 10) ||
                  16
              );
            },
            getPageHeight: (b) => a(b).height(),
