((e) => {
  ...
  t.c = {};
  t.c.d = e(document);
  t.c.t = (e) => e.originalEvent.touches.length - 1;
  t.o = function () {
    var n = this;
    this.o = null;
    this.$ = null;
    ...
    this.h2rgba = (e, t) => {
      ...
      e = e.substring(1, 7);
      n = [
        Number.parseInt(e.substring(0, 2), 16),
        Number.parseInt(e.substring(2, 4), 16),
        Number.parseInt(e.substring(4, 6), 16),
      ];
  ...
  t.Dial = function () {
    ...
    this.listen = function () {
      var i,
        ...
        o = (e) => {
          ...
          var o = e.originalEvent,
            ...
            f =
              ...
              (u > 0 || a > 0 ? this.o.step : u < 0 || a < 0 ? -this.o.step : 0);
          f = n(r(f, this.o.max), this.o.min);
          this.val(f, false);
          if (this.rH) {
            clearTimeout(i);
            i = setTimeout(() => {
        ...
        a,
        f = 1,
        l = { 37: -this.o.step, 38: this.o.step, 39: this.o.step, 40: -this.o.step };
      this.$.bind("keydown", (i) => {
        var s = i.keyCode;
        if (s >= 96 && s <= 105) {
          s = i.keyCode = s - 48;
        }
        u = Number.parseInt(String.fromCharCode(s));
        if (isNaN(u)) {
          s !== 13 &&
            s !== 8 &&
            s !== 9 &&
            s !== 189 &&
            (s !== 190 || this.$.val().match(/\./)) &&
            i.preventDefault();
          if (e.inArray(s, [37, 38, 39, 40]) > -1) {
            i.preventDefault();
            var o = this.o.parse(this.$.val()) + l[s] * f;
            this.o.stopper && (o = n(r(o, this.o.max), this.o.min));
            this.change(this._validate(o));
            this._draw();
            a = window.setTimeout(() => {
              f *= 2;
            }, 30);
