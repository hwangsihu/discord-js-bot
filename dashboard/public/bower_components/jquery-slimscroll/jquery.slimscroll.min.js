    ...
    slimScroll: function (f) {
      ...
      this.each(function () {
        ...
        function n(d, g, e) {
          ...
          g &&
            ((g =
              Number.parseInt(c.css("top")) +
              ((d * Number.parseInt(a.wheelStep)) / 100) * c.outerHeight()),
            (g = Math.min(Math.max(g, 0), f)),
            (g = 0 < d ? Math.ceil(g) : Math.floor(g)),
            c.css({ top: g + "px" }));
          l = Number.parseInt(c.css("top")) / (b.outerHeight() - c.outerHeight());
        ...
        if (b.parent().hasClass(a.wrapperClass)) {
          ...
          if (e.isPlainObject(f)) {
            ...
            if ("scrollTo" in f) q = Number.parseInt(a.scrollTo);
            else if ("scrollBy" in f) q += Number.parseInt(a.scrollBy);
          ...
          a.railDraggable &&
            c
              .bind("mousedown", (a) => {
                var b = e(document);
                z = !0;
                t = Number.parseFloat(c.css("top"));
                pageY = a.pageY;
                b.bind("mousemove.slimscroll", (a) => {
                  currTop = t + a.pageY - pageY;
                  c.css("top", currTop);
                  n(0, c.position().top, !1);
                });
                b.bind("mouseup.slimscroll", (a) => {
                  z = !1;
                  p();
                  b.unbind(".slimscroll");
                });
          ...
          "bottom" === a.start
            ...
            : "top" !== a.start &&
              (n(e(a.start).position().top, null, !0), a.alwaysVisible || c.hide());
