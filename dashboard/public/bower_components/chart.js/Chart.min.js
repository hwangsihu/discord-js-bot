...
(function () {
  ...
  var s = (e.helpers = {}),
    ...
    a = (s.extend = (t) => (
      n(Array.prototype.slice.call(arguments, 1), (i) => {
        n(i, (e, s) => {
    ...
    f = (s.isNumber = (t) => !isNaN(Number.parseFloat(t)) && isFinite(t)),
    g = (s.max = (t) => Math.max.apply(Math, t)),
    m = (s.min = (t) => Math.min.apply(Math, t)),
    v =
      ((s.cap = (t, i, e) => {
        if (f(i)) {
          if (t > i) return i;
      ...
      (s.getDecimalPlaces = (t) => (t % 1 !== 0 && f(t) ? t.toString().split(".")[1].length : 0))),
    S = (s.radians = (t) => t * (Math.PI / 180)),
    x =
      ((s.getAngleFromPoint = (t, i) => {
        var e = i.x - t.x,
          s = i.y - t.y,
          n = Math.sqrt(e * e + s * s),
      ...
      (s.aliasPixel = (t) => (t % 2 === 0 ? 0 : 0.5))),
    y =
      ((s.splineCurve = (t, i, e, s) => {
      ...
      (s.calculateOrderOfMagnitude = (t) => Math.floor(Math.log(t) / Math.LN10))),
    C =
      ((s.calculateScaleRange = (t, i, e, s, n) => {
        var o = 2,
    ...
    w =
      ...
      (s.easingEffects = {
        ...
        easeInOutSine: (t) => -0.5 * (Math.cos((Math.PI * t) / 1) - 1),
        easeInExpo: (t) => (0 === t ? 1 : 1 * Math.pow(2, 10 * (t / 1 - 1))),
        easeOutExpo: (t) => (1 === t ? 1 : 1 * (-Math.pow(2, (-10 * t) / 1) + 1)),
        easeInOutExpo: (t) =>
          0 === t
            ? 0
            : 1 === t
        ...
        easeInCirc: (t) => (t >= 1 ? t : -1 * (Math.sqrt(1 - (t /= 1) * t) - 1)),
        ...
        easeInBounce: (t) => 1 - w.easeOutBounce(1 - t),
        easeOutBounce: (t) =>
          (t /= 1) < 1 / 2.75
            ? 7.5625 * t * t
            : 2 / 2.75 > t
        ...
        easeInOutBounce: (t) =>
          0.5 > t ? 0.5 * w.easeInBounce(2 * t) : 0.5 * w.easeOutBounce(2 * t - 1) + 0.5,
      })),
    ...
    P = (s.cancelAnimFrame = (() =>
      ...
      ((t) => window.clearTimeout(t, 1e3 / 60)))()),
    L =
      ((s.animationLoop = (t, i, e, s, n, o) => {
        var a = 0,
          h = w[e] || w.linear,
          l = () => {
            a++;
    ...
    R = (s.getMaximumWidth = (t) => {
      var i = t.parentNode;
      return i.clientWidth;
    }),
    T = (s.getMaximumHeight = (t) => {
      var i = t.parentNode;
    ...
    W = (s.fontString = (t, i, e) => i + " " + t + "px " + e),
    z = (s.longestText = (t, i, e) => {
      t.font = i;
      var s = 0;
      return (
        n(e, (i) => {
    ...
    B = (s.drawRoundedRectangle = (t, i, e, s, n, o) => {
      t.beginPath(),
        t.moveTo(i + o, e),
        t.lineTo(i + s - o, e),
  ...
  (e.instances = {}),
      ...
      destroy: function () {
        ...
        (t.width = this.chart.width),
          ...
          t.style.removeProperty
            ...
            : (t.style.removeAttribute("width"), t.style.removeAttribute("height")),
          ...
          if (
            ...
            if (this.datasets && this.datasets.length > 1) {
              for (
                ...
                r >= 0 &&
                ((a =
                  this.datasets[r].points || this.datasets[r].bars || this.datasets[r].segments),
                (h = l(a, t[0])),
                -1 === h);
                r--
              );
    ...
    (e.Scale = e.Element.extend({
      ...
      buildYLabels: function () {
        ...
        this.yLabelWidth =
          this.display && this.showLabels ? z(this.ctx, this.font, this.yLabels) : 0;
      },
      ...
      fit: function () {
        ...
        for (
          this.calculateYRange(i), this.buildYLabels(), this.calculateXLabelRotation();
          i > this.endPoint - this.startPoint;
        )
          (i = this.endPoint - this.startPoint),
            (t = this.yLabelWidth),
      ...
      calculateXLabelRotation: function () {
        ...
        if (
          ...
          for (
            ...
            (this.xLabelWidth > a && this.xLabelRotation <= 90 && this.xLabelRotation > 0);
          )
                    ...
                    if (
                      ...
                      for (var a = 0; a < this.valuesCount; a++)
                        (s = this.getPointPosition(
                          a,
                          this.calculateCenterOffset(this.min + e * this.stepValue)
                        )),
    ...
    p ? define(() => e) : "object" == typeof module && module.exports && (module.exports = e),
    (this.Chart = e),
    (e.noConflict = () => ((this.Chart = i), e));
}).call(this),
  function () {
    var i = this.Chart,
      e = i.helpers,
  ...
  function () {
    ...
    i.Type.extend({
      ...
      initialize: function (t) {
        (this.segments = []),
          (this.outerRadius =
            (e.min([this.chart.width, this.chart.height]) - this.options.segmentStrokeWidth / 2) /
            2),
    ...
    i.Type.extend({
      ...
      draw: function (t) {
        ...
        var s = this.chart.ctx,
          n = (t) => null !== t.value,
          o = (t, i, s) => e.findNextWhere(i, n, s) || t,
          a = (t, i, s) => e.findPreviousWhere(i, n, s) || t;
        this.scale.draw(i),
          e.each(
            this.datasets,
            function (t) {
              ...
              e.each(
                ...
                function (t, e) {
                  t.hasValue() &&
                    t.transition(
                      { y: this.scale.calculateY(t.value), x: this.scale.calculateX(e) },
                      i
                    );
                },
                this
                ...
                e.each(
                  ...
                  function (e, n) {
                    ...
                    this.scale.animation ||
                      (o = this.scale.getPointPosition(n, this.scale.calculateCenterOffset(e))),
                      s.points.push(
                        new this.PointClass({
                          value: e,
                          label: t.labels[n],
            ...
            function (t) {
              e.each(
                ...
                function (t, e) {
                  t.hasValue() &&
                    t.transition(
                      this.scale.getPointPosition(e, this.scale.calculateCenterOffset(t.value)),
                      i
                    );
                },
                this
