          ...
          return 0 === t
            ...
            : 2 == (t /= 0.5)
              ...
              : (e || (e = 0.3 * 1.5),
                s < Math.abs(1) ? ((s = 1), (i = e / 4)) : (i = (e / (2 * Math.PI)) * Math.asin(1 / s)),
                1 > t
                  ? -0.5 * s * Math.pow(2, 10 * (t -= 1)) * Math.sin((2 * (1 * t - i) * Math.PI) / e)
                  : s * Math.pow(2, -10 * (t -= 1)) * Math.sin((2 * (1 * t - i) * Math.PI) / e) * 0.5 + 1);
        },
          ...
          if (
            ...
            if (this.datasets && this.datasets.length > 1) {
              for (
                ...
                r >= 0 &&
                ((a = this.datasets[r].points || this.datasets[r].bars || this.datasets[r].segments),
                (h = l(a, t[0])),
                -1 === h);
                r--
              );
    ...
    (e.RadialScale = e.Element.extend({
      ...
      setScaleSize: function () {
        var t,
          ...
          g = 0;
        for (
          this.ctx.font = W(this.pointLabelFontSize, this.pointLabelFontStyle, this.pointLabelFontFamily), i = 0;
          i < this.valuesCount;
          i++
        )
