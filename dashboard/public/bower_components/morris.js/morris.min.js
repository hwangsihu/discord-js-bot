...
(() => {
  ...
  (b = window.Morris = {}),
    ...
    (b.Grid = ((c) => {
      function d(b) {
        ...
        "static" === this.el.css("position") && this.el.css("position", "relative"),
          ...
          this.el.bind("mousemove", (a) => {
            var b, d, e, f, g;
            return (
              (d = this.el.offset()),
              (g = a.pageX - d.left),
              this.selectFrom
                ? ((b = this.data[this.hitTest(Math.min(g, this.selectFrom))]._x),
                  (e = this.data[this.hitTest(Math.max(g, this.selectFrom))]._x),
                  (f = e - b),
                  this.selectionRect.attr({ x: b, width: f }))
                : this.fire("hovermove", g, a.pageY - d.top)
            );
          }),
          this.el.bind(
            "mouseleave",
            () => (
              this.selectFrom && (this.selectionRect.hide(), (this.selectFrom = null)),
              this.fire("hoverout")
            )
          ),
          this.el.bind("touchstart touchmove touchend", (a) => {
            var b, d;
            return (
              (d = a.originalEvent.touches[0] || a.originalEvent.changedTouches[0]),
              (b = this.el.offset()),
              this.fire("hovermove", d.pageX - b.left, d.pageY - b.top)
            );
          }),
          this.el.bind("click", (a) => {
            var b;
            return (
              (b = this.el.offset()), this.fire("gridclick", a.pageX - b.left, a.pageY - b.top)
            );
          }),
          this.options.rangeSelect &&
            ((this.selectionRect = this.raphael
              ...
              .toBack()
              .hide()),
            this.el.bind("mousedown", (a) => {
              var b;
              return (b = this.el.offset()), this.startRange(a.pageX - b.left);
            }),
            this.el.bind("mouseup", (a) => {
              var b;
              return (
                (b = this.el.offset()),
                this.endRange(a.pageX - b.left),
                this.fire("hovermove", a.pageX - b.left, a.pageY - b.top)
              );
            })),
          this.options.resize &&
            a(window).bind(
      ...
      return (
                    ...
                    (j = a[f]),
                      ...
                      (i.y = function () {
                        ...
                        for (
                          ...
                          (n = c[e]),
                            (q = j[n]),
                            "string" == typeof q && (q = Number.parseFloat(q)),
        ...
        (d.prototype.yboundary = function (a, b) {
          ...
          return (
            ...
            "string" == typeof c
              ? "auto" === c.slice(0, 4)
                ? c.length > 5
                  ? ((d = Number.parseInt(c.slice(5), 10)), null == b ? d : Math[a](b, d))
                  : null != b
                    ? b
                    : 0
        ...
        (d.prototype.autoGridLines = (a, b, c) => {
              ...
              ? ((g = Math.floor(Math.log(i) / Math.log(10))),
                (f = (() => {
                  ...
                  for (b = [], k = a = e; i > 0 ? d >= a : a >= d; k = a += i)
                    b.push(Number.parseFloat(k.toFixed(1 - g)));
                  return b;
                })()))
              : (f = (() => {
                  var a, b;
    ...
    (b.parseDate = (a) => {
      ...
      return "number" == typeof a
        ...
        : ((c = a.match(/^(\d+) Q(\d)$/)),
          ...
          c
            ? new Date(Number.parseInt(c[1], 10), 3 * Number.parseInt(c[2], 10) - 1, 1).getTime()
            : e
              ? new Date(Number.parseInt(e[1], 10), Number.parseInt(e[2], 10) - 1, 1).getTime()
              : f
                ? new Date(
                    Number.parseInt(f[1], 10),
                    Number.parseInt(f[2], 10) - 1,
                    Number.parseInt(f[3], 10)
                  ).getTime()
                : h
                  ? ((k = new Date(Number.parseInt(h[1], 10), 0, 1)),
                    4 !== k.getDay() && k.setMonth(0, 1 + ((4 - k.getDay() + 7) % 7)),
                    k.getTime() + 6048e5 * Number.parseInt(h[2], 10))
                  : i
                    ? i[6]
                      ? ((g = 0),
                        "Z" !== i[6] &&
                          ((g = 60 * Number.parseInt(i[8], 10) + Number.parseInt(i[9], 10)),
                          "+" === i[7] && (g = 0 - g)),
                        Date.UTC(
                          Number.parseInt(i[1], 10),
                          Number.parseInt(i[2], 10) - 1,
                          Number.parseInt(i[3], 10),
                          Number.parseInt(i[4], 10),
                          Number.parseInt(i[5], 10) + g
                        ))
                      : new Date(
                          Number.parseInt(i[1], 10),
                          Number.parseInt(i[2], 10) - 1,
                          Number.parseInt(i[3], 10),
                          Number.parseInt(i[4], 10),
                          Number.parseInt(i[5], 10)
                        ).getTime()
                    : j
                      ? ((l = Number.parseFloat(j[6])),
                        (b = Math.floor(l)),
                        (d = Math.round(1e3 * (l - b))),
                        j[8]
                          ? ((g = 0),
                            "Z" !== j[8] &&
                              ((g = 60 * Number.parseInt(j[10], 10) + Number.parseInt(j[11], 10)),
                              "+" === j[9] && (g = 0 - g)),
                            Date.UTC(
                              Number.parseInt(j[1], 10),
                              Number.parseInt(j[2], 10) - 1,
                              Number.parseInt(j[3], 10),
                              Number.parseInt(j[4], 10),
                              Number.parseInt(j[5], 10) + g,
                              b,
                              d
                            ))
                          : new Date(
                              ...
                              Number.parseInt(j[3], 10),
                              Number.parseInt(j[4], 10),
                              Number.parseInt(j[5], 10),
                              b,
                              d
                            ).getTime())
                      : new Date(Number.parseInt(a, 10), 0, 1).getTime());
    }),
    (b.Hover = (() => {
      function c(c) {
        null == c && (c = {}),
        ...
        (c.prototype.moveTo = function (a, b) {
          ...
          return (
            ...
            null != b
              ...
              : (h = f / 2 - c / 2),
            this.el.css({ left: e + "px", top: Number.parseInt(h) + "px" })
          );
        }),
    ...
    (b.Line = ((a) => {
      ...
      return (
        ...
        (c.prototype._drawPointFor = function (a) {
          ...
          for (this.seriesPoints[a] = [], f = this.data, g = [], d = 0, e = f.length; e > d; d++)
            (c = f[d]),
              (b = null),
              null != c._y[a] &&
                (b = this.drawLinePoint(c._x, c._y[a], this.colorFor(c, a, "point"), a)),
        ...
        (c.gradients = (a) => {
          var b, c, d, e, f, g, h, i;
          for (
            c = (a, b) => (a.y - b.y) / (a.x - b.x), i = [], d = g = 0, h = a.length;
            h > g;
            d = ++g
          )
            (b = a[d]),
    ...
    (c = (a) => ({
      span: 60 * a * 1e3,
      start: (a) => new Date(a.getFullYear(), a.getMonth(), a.getDate(), a.getHours()),
      fmt: (a) => "" + b.pad2(a.getHours()) + ":" + b.pad2(a.getMinutes()),
      incr: (b) => b.setUTCMinutes(b.getUTCMinutes() + a),
    })),
    (d = (a) => ({
      span: 1e3 * a,
      start: (a) =>
        new Date(a.getFullYear(), a.getMonth(), a.getDate(), a.getHours(), a.getMinutes()),
      fmt: (a) =>
        "" + b.pad2(a.getHours()) + ":" + b.pad2(a.getMinutes()) + ":" + b.pad2(a.getSeconds()),
      incr: (b) => b.setUTCSeconds(b.getUTCSeconds() + a),
    })),
    (b.LABEL_SPECS = {
      decade: {
        span: 1728e8,
        start: (a) => new Date(a.getFullYear() - (a.getFullYear() % 10), 0, 1),
        fmt: (a) => "" + a.getFullYear(),
        incr: (a) => a.setFullYear(a.getFullYear() + 10),
      },
      year: {
        span: 1728e7,
        start: (a) => new Date(a.getFullYear(), 0, 1),
        fmt: (a) => "" + a.getFullYear(),
        incr: (a) => a.setFullYear(a.getFullYear() + 1),
      },
      month: {
        span: 24192e5,
        start: (a) => new Date(a.getFullYear(), a.getMonth(), 1),
        fmt: (a) => "" + a.getFullYear() + "-" + b.pad2(a.getMonth() + 1),
        incr: (a) => a.setMonth(a.getMonth() + 1),
      },
      week: {
        span: 6048e5,
        start: (a) => new Date(a.getFullYear(), a.getMonth(), a.getDate()),
        fmt: (a) =>
          "" + a.getFullYear() + "-" + b.pad2(a.getMonth() + 1) + "-" + b.pad2(a.getDate()),
        incr: (a) => a.setDate(a.getDate() + 7),
      },
      day: {
        span: 864e5,
        start: (a) => new Date(a.getFullYear(), a.getMonth(), a.getDate()),
    ...
    (b.Bar = ((c) => {
      ...
      return (
        ...
        (d.prototype.onHoverMove = function (a) {
          var b, c;
          return (
            (b = this.hitTest(a)), (c = this.hover).update.apply(c, this.hoverContentForRow(b))
          );
        }),
        ...
        (d.prototype.roundedRect = (a, b, c, d, e) => (
          null == e && (e = [0, 0, 0, 0]),
          [
            "M",
            a,
          ...
          return (
            ...
            (this.values = function () {
              ...
              for (d = this.data, e = [], a = 0, c = d.length; c > a; a++)
                (b = d[a]), e.push(Number.parseFloat(b.value));
              return e;
            }.call(this)),
            this.redraw()
          );
