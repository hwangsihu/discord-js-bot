...
(function () {
  ...
  (b = window.Morris = {}),
          ...
          if (this.options.grid !== !1 || (e = this.options.axes) === !0 || "both" === e || "y" === e) {
            for (f = this.grid, h = [], c = 0, d = f.length; d > c; c++)
              (a = f[c]),
                ...
                this.options.grid
                  ? h.push(this.drawGridLine("M" + this.left + "," + b + "H" + (this.left + this.width)))
                  : h.push(void 0);
            return h;
          }
        }),
              ...
              a = function (a, b) {
                ...
                return (
                  ...
                  d.x + d.width < l.el.width()
                    ? (0 !== l.options.xLabelAngle &&
                        ((g = (1.25 * l.options.gridTextSize) / Math.sin((l.options.xLabelAngle * Math.PI) / 180)),
                        (e = d.x - g)),
    ...
    (b.labelSeries = function (c, d, e, f, g) {
      ...
      for (
        void 0 === n && (n = b.LABEL_SPECS.second), g && (n = a.extend({}, n, { fmt: g })), h = n.start(i), l = [];
        (o = h.getTime()) <= d;
      )
            ...
            (a = f[d]),
              ...
              (a._y = function () {
                ...
                for (f = a.y, g = [], d = 0, e = f.length; e > d; d++)
                  (c = f[d]),
                    this.options.behaveLikeLine ? g.push(this.transY(c)) : ((b += c || 0), g.push(this.transY(b)));
                return g;
              }.call(this)),
          ...
          for (
            ...
            (h = this.data[this.data.length - 1 - a]),
              ...
              c.x + c.width < this.el.width()
                ? (0 !== this.options.xLabelAngle &&
                    ((d = (1.25 * this.options.gridTextSize) / Math.sin((this.options.xLabelAngle * Math.PI) / 180)),
                    (f = c.x - d)),
