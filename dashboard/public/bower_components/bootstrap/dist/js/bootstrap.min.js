...
!((t) => {
  ...
  ((n) => {
    (n.fn.emulateTransitionEnd = function (t) {
      ...
      return (
        setTimeout(() => {
          e || n(this).trigger(n.support.transition.end);
        }, t),
        this
      );
    }),
            ...
            s.proxy(function () {
              i[o](null == n[t] ? this.options[t] : n[t]),
                "loadingText" == t
                  ...
                  : this.isLoading &&
                    ((this.isLoading = !1), i.removeClass(e).removeAttr(e).prop(e, !1));
            }, this),
            0
          );
      }),
  ...
  ((a) => {
    ...
    (s.VERSION = "3.4.1"),
      ...
      (s.prototype.show = function (i) {
        var t = a.Event("show.bs.modal", { relatedTarget: i });
        this.$element.trigger(t),
          this.isShown ||
            ...
            this.$dialog.on("mousedown.dismiss.bs.modal", () => {
              this.$element.one("mouseup.dismiss.bs.modal", (t) => {
                a(t.target).is(this.$element) && (this.ignoreBackdropClick = !0);
              });
            }),
            this.backdrop(() => {
              var t = a.support.transition && this.$element.hasClass("fade");
              this.$element.parent().length || this.$element.appendTo(this.$body),
                this.$element.show().scrollTop(0),
                this.adjustDialog(),
                t && this.$element[0].offsetWidth,
      ...
      (s.prototype.setScrollbar = function () {
        var t = Number.parseInt(this.$body.css("padding-right") || 0, 10);
        ...
        this.bodyIsOverflowing &&
          ...
          a(this.fixedContent).each((t, e) => {
            ...
            a(e)
              ...
              .css("padding-right", Number.parseFloat(o) + n + "px");
          }));
      }),
  ...
  ((g) => {
    ...
    function u(t, e) {
      ...
      for (var o = g(e).filter((t, e) => e instanceof RegExp), n = 0, s = o.length; n < s; n++)
    ...
    function n(t, e, i) {
      ...
      o.body.innerHTML = t;
      for (
        var n = g.map(e, (t, e) => e), s = g(o.body).find("*"), a = 0, r = s.length;
        a < r;
        a++
      ) {
        var l = s[a],
    ...
    (m.VERSION = "3.4.1"),
      ...
      (m.prototype.getDefaults = () => m.DEFAULTS),
      ...
      (m.prototype.show = function () {
        ...
        if (this.hasContent() && this.enabled) {
          ...
          var u = () => {
            var t = this.hoverState;
            this.$element.trigger("shown.bs." + this.type),
              (this.hoverState = null),
              "out" == t && this.leave(this);
          };
      ...
      (m.prototype.applyPlacement = function (t, e) {
        var i = this.tip(),
          o = i[0].offsetWidth,
          n = i[0].offsetHeight,
          s = Number.parseInt(i.css("margin-top"), 10),
          a = Number.parseInt(i.css("margin-left"), 10);
        isNaN(s) && (s = 0),
          isNaN(a) && (a = 0),
          (t.top += s),
          (t.left += a),
      ...
      (m.prototype.getCalculatedOffset = (t, e, i, o) =>
        "bottom" == t
  ...
  ((n) => {
    ...
    (s.VERSION = "3.4.1"),
      ...
      (((s.prototype = n.extend({}, n.fn.tooltip.Constructor.prototype)).constructor =
        s).prototype.getDefaults = () => s.DEFAULTS),
      (s.prototype.setContent = function () {
        ...
        if (this.options.html) {
          ...
          this.options.sanitize &&
            ((e = this.sanitizeHtml(e)), "string" === o && (i = this.sanitizeHtml(i))),
