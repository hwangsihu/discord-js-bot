...
CKEDITOR.lang["ug"] = {
  ...
  table: {
    ...
    menu: "جەدۋەل خاسلىقى",
    row: { menu: "قۇر", insertBefore: "ئۈستىگە قۇر قىستۇر", insertAfter: "ئاستىغا قۇر قىستۇر", deleteRow: "قۇر ئۆچۈر" },
    rows: "قۇر سانى",
    summary: "ئۈزۈندە",
  ...
  specialchar: { options: "ئالاھىدە ھەرپ تاللانمىسى", title: "ئالاھىدە ھەرپ تاللاڭ", toolbar: "ئالاھىدە ھەرپ قىستۇر" },
