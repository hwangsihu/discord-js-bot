...
CKEDITOR.dialog.add("colordialog", (x) => {
  ...
  function A(a) {
    ...
    "td" == b.getName() &&
      ...
      (q(a),
      c ? (d = b) : (B = b),
      c && b.addClass(D(k) ? "cke_colordialog_focused_light" : "cke_colordialog_focused_dark"),
      r(k));
  }
  function q(a) {
  ...
  function r(a) {
    a
      ...
      : (e.getById(t).removeStyle("background-color"), e.getById(u).setHtml("\x26nbsp;"));
  }
  function E(a) {
    var c = a.data,
      b = c.getTarget(),
              ...
              C,
              {
                ...
                children: [
                  ...
                  },
                  {
                    ...
                    onChange: function () {
                      try {
                        e.getById(n).setStyle("background-color", this.getValue());
                      } catch (a) {
                        m();
                      }
                    },
