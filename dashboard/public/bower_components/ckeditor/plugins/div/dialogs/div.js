(() => {
  ...
  function q(a, m) {
    ...
    return {
              ...
              children: [
                {
                  ...
                  onChange: function () {
                    ...
                    this.commit(g, !0);
                    for (var f = [].concat(f), b = f.length, k, e = 0; e < b; e++)
      ...
      onLoad: function () {
        r.call(this);
        var c = this.getContentElement("info", "elementStyle");
        a.getStylesSet((g) => {
          var b, k;
          if (g)
          ...
          setTimeout(() => {
            this._element && c.setup(this._element);
          }, 0);
        });
      },
      onShow: function () {
          ...
          for (h = 0; h < e.length; h++)
            for (l = e[h].createIterator(); (b = l.getNextParagraph()); )
              if (b.getName() in q && !b.isReadOnly()) {
                ...
                while (!u[b.getName()] && !b.equals(e[h].root)) b = b.getParent();
                t(g, b, c);
              }
          ...
          for (h = 0; h < e.length; h++)
            if (e[h].length) {
              ...
              for (b = 0; b < e[h].length; b++) {
                for (d = e[h][b]; d.getParent() && !d.getParent().equals(g); ) d = d.getParent();
                e[h][b] = d;
              }
              for (b = 0; b < e[h].length; b++)
                (d = e[h][b]),
                  (d.getCustomData && d.getCustomData("block_processed")) ||
                    (d.is && CKEDITOR.dom.element.setMarker(c, d, "block_processed", !0),
                    b || l.insertBefore(d),
                    l.append(d));
              CKEDITOR.dom.element.clearAllMarkers(c);
              f.push(l);
  ...
  CKEDITOR.dialog.add("creatediv", (a) => q(a, "creatediv"));
  CKEDITOR.dialog.add("editdiv", (a) => q(a, "editdiv"));
})();
