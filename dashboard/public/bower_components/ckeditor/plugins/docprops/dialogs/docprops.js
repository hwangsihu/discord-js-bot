  ...
  return {
    ...
    onShow: function () {
      for (
        ...
        var l = c.getItem(k);
        f[l.getAttribute(l.hasAttribute("http-equiv") ? "http-equiv" : "name").toLowerCase()] = l;
      }
      m = f;
        ...
        elements: [
          {
            ...
            commit: function (a, d, e, b, c) {
              c || a.getElementsByTag("title").getItem(0).data("cke-title", this.getValue());
            },
          },
          {
            type: "hbox",
            ...
            children: [
              {
                ...
                commit: function (a, d, e, b, c) {
                  c ||
                    ((b = this.getValue()),
                    (c = this.getDialog().getContentElement("general", "charsetOther")),
            ...
            children: [
              {
                ...
                items: [
                  ...
                  ["HTML 3.2", '\x3c!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 3.2 Final//EN"\x3e'],
                  ["HTML 2.0", '\x3c!DOCTYPE HTML PUBLIC "-//IETF//DTD HTML//EN"\x3e'],
                  [c.other, "other"],
                ],
                onChange: n,
                setup: function () {
                ...
                commit: function (a, d, c, b, f) {
                  f ||
                    ((a = this.getValue()),
                    (d = this.getDialog().getContentElement("general", "docTypeOther")),
                    ...
                    commit: function (a, d, c, b, f) {
                      if (this.isChanged() || f)
                        b.removeAttribute("text"),
                          (a = this.getValue()) ? b.setStyle("color", a) : b.removeStyle("color");
                    },
                  }),
                  r("bgColor", "bgColor", {
                    setup: function (a, d, c, b) {
