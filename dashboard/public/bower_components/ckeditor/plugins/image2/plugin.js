  ...
  function D(a) {
    ...
    function c() {
      var d = a.editable(),
        e = a.document;
      if (this.deflated)
        (this.widget = a.widgets.initOn(this.element, "image", this.widget.data)),
          this.widget.inline &&
            !new CKEDITOR.dom.elementPath(this.widget.wrapper, d).block &&
            ((d = e.createElement(a.activeEnterMode == CKEDITOR.ENTER_P ? "p" : "div")),
    ...
    return {
      ...
      data: function () {
        ...
        "none" == this.data.align || a.filter.checkFeature(d.align) || (this.data.align = "none");
        this.shiftState({
          widget: this,
      ...
      init: function () {
        ...
        c.align ||
          ((b = c.hasCaption ? this.element : b),
          g
            ? (b.hasClass(g[0]) ? (c.align = "left") : b.hasClass(g[2]) && (c.align = "right"),
              c.align ? b.removeClass(g[q[c.align]]) : (c.align = "none"))
            : ((c.align = b.getStyle("float") || "none"), b.removeStyle("float")));
        a.plugins.link &&
          this.parts.link &&
          ((c.link = d.getLinkAttributesParser()(a, this.parts.link)),
          (b = c.link.advanced) &&
            b.advCSSClasses &&
            (b.advCSSClasses = CKEDITOR.tools.trim(b.advCSSClasses.replace(/cke_\S+/, ""))));
  ...
  function H(a) {
    ...
    return (a, f) => {
      ...
      if (
        ...
        (b(a)
          ? ("div" == e && (h = a.getFirst("figure")) && (a.replaceWith(h), (a = h)),
            (f.align = "center"),
  ...
  function I(a) {
    ...
    return function (a) {
      ...
      if (!this.inline) {
        ...
        e && e.replaceWith(e.getFirst({ img: 1, a: 1 }));
      }
      d &&
        "none" != d &&
  ...
  function n(a) {
    ...
    return (f) => {
      ...
      return (
        c
          ? f.hasClass(c[1])
          : "center" == CKEDITOR.tools.parseCssText(f.attributes.style || "", !0)["text-align"]
      )
        ? !0
        : !1;
    };
    ...
    f.on("mousedown", (d) => {
      function l(a, b, d) {
        var l = CKEDITOR.document,
          c = [];
        g.equals(l) || c.push(l.on(a, b));
        c.push(g.on(a, b));
        if (d) for (a = c.length; a--; ) d.push(c.pop());
      }
      function e() {
        t = m + A * x;
        u = Math.round(t / v);
            ...
            : 0 >= x
              ...
              : 0 >= p
                ...
                : y >= v
                  ? e()
                  : w();
          15 <= t && 15 <= u ? (h.setAttributes({ width: t, height: u }), (z = !0)) : (z = !1);
        },
        n
      );
      l(
          ...
          align: (d, c, g) => {
            ...
            d.changed.align
              ? d.newData.hasCaption ||
                ("center" == g && (d.deflate(), (d.element = b(a, e))),
          ...
          link: (b, d, c) => {
            if (b.changed.link) {
              ...
              c
                ...
                : ((c = f.findOne("img")), c.replace(f), (k = c));
              h && (b.element = k);
            }
          },
        };
