      ...
      onOk: function () {
        ...
        this.imageEditMode
          ? !this.linkEditMode && this.addLink
            ...
            : this.linkEditMode &&
              !this.addLink &&
              (d.getSelection().selectElement(this.linkElement), d.insertElement(this.imageElement))
          : this.addLink
            ? this.linkEditMode
                          ...
                          commit: function (a, b) {
                            ...
                            1 == a || 4 == a
                              ? (isNaN(c)
                                  ...
                                  : (b.setStyle("border-width", CKEDITOR.tools.cssLength(c)),
                          ...
                          commit: function (a, b) {
                            ...
                            1 == a || 4 == a
                              ? (isNaN(c)
                                  ? !c &&
                                    this.isChanged() &&
                                    (b.removeStyle("margin-left"), b.removeStyle("margin-right"))
                                  : (b.setStyle("margin-left", CKEDITOR.tools.cssLength(c)),
                          ...
                          commit: function (a, b) {
                            ...
                            1 == a || 4 == a
                              ? (isNaN(c)
                                  ...
                                  : (b.setStyle("margin-top", CKEDITOR.tools.cssLength(c)),
