...
(function () {
  ...
  CKEDITOR.cleanWord = function (a, b) {
    ...
    CKEDITOR.plugins.clipboard.isCustomDataTypesSupported &&
      (a = CKEDITOR.plugins.pastefromword.styles.inliner.inline(a).getBody().getHtml());
      ...
      for (h in e)
        if (!(h.toLowerCase() in d || d[h.toLowerCase().replace(/\-.*$/, "-")] || h.toLowerCase() in b)) {
          for (var f = !1, l = 0; l < a.children.length; l++) {
            ...
            g.type === CKEDITOR.NODE_ELEMENT && ((f = !0), k.setStyle(g, h, e[h]));
          }
          f && delete e[h];
        }
      a.attributes.style = CKEDITOR.tools.writeCssText(e);
  ...
  CKEDITOR.plugins.pastefromword.lists = {
    ...
    createLists: function (a) {
      ...
      for (a = 0; a < h.length; a++) {
        ...
        l[0].children.length &&
          ...
          !d && 1 < l[0].children.length && (d = l[0].children[1].attributes["cke-symbol"]),
    ...
    determineListItemValue: function (a) {
      if ("ol" === a.parent.name) {
        ...
        c &&
          ((c = c[c.length - 1]),
          (d = a.parent.attributes["cke-list-style-type"] || this.numbering.getStyle(c)),
    ...
    getListItemInfo: function (a) {
      ...
      a.attributes["cke-list-level"] =
        void 0 !== a.attributes["cke-list-level"] ? a.attributes["cke-list-level"] : c.level;
