...
(function () {
  ...
  var l = {
    ...
    n = CKEDITOR.dtd,
    A = CKEDITOR.tools.extend({ table: 1 }, n.$block, n.$listItem, n.$tableContent, n.$list),
    C = /\s*(?:;\s*|$)/,
    q = {
      smiley: ":)",
      sad: ":(",
      ...
      for (var b, c, k = 0; (b = this._.bbcPartsRegex.exec(a)); )
        if (
          ...
          var e = l[c],
            ...
            h = {};
          b = b[2];
          if ("left" == c || "right" == c || "center" == c || "justify" == c) b = c;
          if (b)
            if (
              ("list" == c &&
                (isNaN(b)
  ...
  CKEDITOR.htmlParser.fragment.fromBBCode = function (a) {
    ...
    function c(a, e) {
      var b = d.children.length,
        ...
        c = c && c.type == CKEDITOR.NODE_ELEMENT && v.getRule(m[c.name], "breakAfterClose"),
    ...
    e.onTagOpen = function (a, g) {
      ...
      if (CKEDITOR.dtd.$removeEmpty[a]) h.push(f);
        ...
        var w = d.name,
          p = w && (CKEDITOR.dtd[w] || (d._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span));
        if (p && !p[a]) {
          var p = !1,
            l;
          a == w
        ...
        c(),
          ...
          a.replace(/(\r\n|[\r\n])|[^\r\n]*/g, function (a, e) {
            if (void 0 !== e && e.length) f++;
              ...
              b != a.length && k(new CKEDITOR.htmlParser.text(a.substring(b, a.length)), d);
            }
          });
    };
    for (e.parse(CKEDITOR.tools.htmlEncode(a)); d.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT; )
  ...
  var v = new (CKEDITOR.tools.createClass({
    ...
    proto: {
      ...
      openTag: function (a) {
        a in l && (this.getRule(a, "breakBeforeOpen") && this.lineBreak(1), this.write("[", a));
      },
