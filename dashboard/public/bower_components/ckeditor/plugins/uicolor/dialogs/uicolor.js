...
CKEDITOR.dialog.add("uicolor", (f) => {
  ...
  function C(a) {
    ...
    "td" == b.getName() &&
      ...
      (u(a),
      c ? (e = b) : (D = b),
      c && b.addClass(G(h) ? "cke_colordialog_focused_light" : "cke_colordialog_focused_dark"),
      v(h));
  }
  function u(a) {
  ...
  function v(a) {
    a
      ...
      : (l.getById(w).removeStyle("background-color"), l.getById(x).setHtml("\x26nbsp;"));
  }
  function G(a) {
    a = a.replace(/^#/, "");
  ...
  function y(a) {
    return a.getUiColor() ? CKEDITOR.tools.parseCssText("color:" + a.getUiColor(), !0).color : null;
  }
            ...
            children: [
              {
                ...
                focus: function () {
                  var a = y(f),
                    c = a ? E(a) : e || this.getElement().getElementsByTag("td").getItem(0);
                ...
                children: [
                  ...
                  },
                  {
                    ...
                    onChange: function () {
                      try {
                        var a = this.getValue();
                        a && (l.getById(t).setStyle("background-color", a), F(a));
                      } catch (c) {
                        n(), m(null);
                      }
                    },
              ...
              },
              {
                ...
                onChange: function () {
                  ...
                  a &&
                    ...
                    this.setValue('config.uiColor \x3d "' + a.toLowerCase() + '"', !0);
                },
              },
            ],
          },
