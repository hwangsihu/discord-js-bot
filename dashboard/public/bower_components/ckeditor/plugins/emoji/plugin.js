    ...
    h = CKEDITOR.tools.createClass({
      $: function (a, d) {
        ...
        this.groups = [
          ...
          {
            name: "activities",
            sectionName: b.groups.activities,
        ...
        this.elements = {};
        a.ui.addToolbarGroup("emoji", "insert");
        a.ui.add("EmojiPanel", CKEDITOR.UI_PANELBUTTON, {
          label: "emoji",
          title: b.title,
          modes: { wysiwyg: 1 },
          editorFocus: 0,
          toolbar: "insert",
          panel: {
            css: [CKEDITOR.skin.getPath("editor"), d.path + "skins/default.css"],
      ...
      proto: {
        ...
        createEmojiBlock: function () {
          var a = [];
          a.push(this.createGroupsNavigation());
          a.push(this.createSearchSection());
          a.push(this.createEmojiListBlock());
          a.push(this.createStatusBar());
          return '\x3cdiv class\x3d"cke_emoji-inner_panel"\x3e' + a.join("") + "\x3c/div\x3e";
        },
          ...
          CKEDITOR.env.ie && !CKEDITOR.env.edge
            ? ((d = CKEDITOR.getUrl(this.plugin.path + "assets/iconsall.png")),
              (a = new CKEDITOR.template(
                '\x3cli class\x3d"cke_emoji-navigation_item" data-cke-emoji-group\x3d"{group}"\x3e\x3ca href\x3d"#" draggable\x3d"false" _cke_focus\x3d"1" title\x3d"{name}"\x3e\x3cspan style\x3d"background-image:url(' +
                  d +
                  ');background-repeat:no-repeat;background-position:{positionX}px {positionY}px;"\x3e\x3c/span\x3e\x3c/a\x3e\x3c/li\x3e'
              )),
              (d = f.reduce(
                this.groups,
                function (b, c) {
            ...
            : ((d = CKEDITOR.getUrl(this.plugin.path + "assets/iconsall.svg")),
              ...
              (a = new CKEDITOR.template(
                '\x3cli class\x3d"cke_emoji-navigation_item" data-cke-emoji-group\x3d"{group}"\x3e\x3ca href\x3d"#" title\x3d"{name}" draggable\x3d"false" _cke_focus\x3d"1"\x3e\x3csvg viewBox\x3d"0 0 34 34" aria-labelledby\x3d"{svgId}-title"\x3e\x3ctitle id\x3d"{svgId}-title"\x3e{name}\x3c/title\x3e\x3cuse ' +
                  d +
                  "\x3e\x3c/use\x3e\x3c/svg\x3e\x3c/a\x3e\x3c/li\x3e"
              )),
              (d = f.reduce(
                this.groups,
                function (b, c) {
        ...
        createSearchSection: function () {
          this.listeners.push({
            selector: "input",
            event: "input",
            listener: CKEDITOR.tools.throttle(200, this.filter, this).input,
          });
          this.listeners.push({
            selector: "input",
            event: "click",
          ...
          return (
            '\x3clabel class\x3d"cke_emoji-search"\x3e' +
            this.getLoupeIcon() +
            '\x3cinput placeholder\x3d"' +
            e(this.lang.searchPlaceholder) +
            '" type\x3d"search" aria-label\x3d"' +
            e(this.lang.searchLabel) +
            '" role\x3d"search" _cke_focus\x3d"1"\x3e\x3c/label\x3e'
          );
        },
        createEmojiListBlock: function () {
          this.listeners.push({
            ...
            event: "scroll",
            listener: CKEDITOR.tools.throttle(150, this.refreshNavigationStatus, this).input,
          });
          this.listeners.push({
            selector: ".cke_emoji-outer_emoji_block",
            event: "click",
          ...
          this.listeners.push({
            ...
            event: "mouseover",
            listener: function (a) {
              this.updateStatusbar(a.data.getTarget());
            },
          });
          this.listeners.push({
            selector: ".cke_emoji-outer_emoji_block",
        ...
        getLoupeIcon: function () {
          ...
          return CKEDITOR.env.ie && !CKEDITOR.env.edge
            ? '\x3cspan class\x3d"cke_emoji-search_loupe" aria-hidden\x3d"true" style\x3d"background-image:url(' +
                d +
                ');"\x3e\x3c/span\x3e'
            : '\x3csvg viewBox\x3d"0 0 34 34" role\x3d"img" aria-hidden\x3d"true" class\x3d"cke_emoji-search_loupe"\x3e\x3cuse ' +
                (CKEDITOR.env.safari
                  ? 'xlink:href\x3d"' + a + '#cke4-icon-emoji-10"'
                  : 'href\x3d"' + a + '#cke4-icon-emoji-10"') +
        ...
        getEmojiSections: function () {
          return f.reduce(
            this.groups,
            function (a, d) {
              return d.items.length ? a + this.getEmojiSection(d) : a;
            },
            "",
            this
          );
        },
        getEmojiSection: function (a) {
          var d = e(a.name),
            b = e(a.sectionName);
          a = this.getEmojiListGroup(a.items);
          return (
            '\x3csection data-cke-emoji-group\x3d"' +
            d +
            '" \x3e\x3ch2 id\x3d"' +
            d +
            '"\x3e' +
            b +
            "\x3c/h2\x3e\x3cul\x3e" +
            a +
            "\x3c/ul\x3e\x3c/section\x3e"
          );
        },
        getEmojiListGroup: function (a) {
          var d = new CKEDITOR.template(
            '\x3cli class\x3d"cke_emoji-item"\x3e\x3ca draggable\x3d"false" data-cke-emoji-full-name\x3d"{id}" data-cke-emoji-name\x3d"{name}" data-cke-emoji-symbol\x3d"{symbol}" data-cke-emoji-group\x3d"{group}" data-cke-emoji-keywords\x3d"{keywords}" title\x3d"{name}" href\x3d"#" _cke_focus\x3d"1"\x3e{symbol}\x3c/a\x3e\x3c/li\x3e'
          );
          return f.reduce(
            a,
            function (a, c) {
        ...
        filter: function (a) {
          ...
          f.forEach(this.elements.emojiItems.toArray(), function (a) {
            ...
            a: {
              ...
              var f = a.data("cke-emoji-keywords");
              if (-1 !== e.indexOf(b)) e = !0;
              else {
                if (f)
                  for (e = f.split(","), f = 0; f < e.length; f++)
                    if (-1 !== e[f].indexOf(b)) {
                      e = !0;
                      break a;
                    }
        ...
        updateStatusbar: function (a) {
          "a" === a.getName() &&
            a.hasAttribute("data-cke-emoji-name") &&
            (this.elements.statusIcon.setText(e(a.getText())),
            this.elements.statusDescription.setText(e(a.data("cke-emoji-name"))),
            this.elements.statusName.setText(e(a.data("cke-emoji-full-name"))));
        },
        ...
        clearSearchAndMoveFocus: function (a) {
          if ((a = a.data.getTarget().getAscendant("li", !0)))
            this.clearSearchInput(), this.moveFocus(a.data("cke-emoji-group"));
        },
        moveFocus: function (a) {
          a = this.blockElement.findOne('a[data-cke-emoji-group\x3d"' + e(a) + '"]');
          var d;
          a &&
            ((d = this.getItemIndex(this.items, a)),
            a.focus(!0),
  ...
  CKEDITOR.plugins.add("emoji", {
    ...
    beforeInit: function () {
      (CKEDITOR.env.ie && 11 > CKEDITOR.env.version) ||
        g ||
        (CKEDITOR.document.appendStyleSheet(this.path + "skins/default.css"), (g = !0));
    },
    init: function (a) {
      if (!(CKEDITOR.env.ie && 11 > CKEDITOR.env.version)) {
        ...
        a.plugins.toolbar && new h(a, this);
      }
    },
  });
})();
