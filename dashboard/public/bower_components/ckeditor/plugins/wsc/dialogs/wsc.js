...
(function () {
    ...
    L = function (b) {
      ...
      for (e in b)
        (d = a.dialog.getContentElement(a.dialog._.currentTabId, e)),
          d || (d = b[e].instance),
          d.setLabel && ((c = b[e].localizationID || e), d.setLabel(a.LocalizationComing[c] + ":"));
    },
    t,
    B;
        ...
        if (e && c.wsc) {
          ...
          if (f) {
            ...
            h
              ...
              k && ((l = k.split(",")), c.wsc.DataStorage.setData("scayt_user_dictionary", l)),
              d();
        } else d();
      },
                              ...
                              children: [
                                {
                                  ...
                                  onShow: function () {
                                    (this.getElement().getFirst() || this.getElement()).setText(
                                      a.LocalizationComing.Create
                                    );
                                  },
                                  onClick: b,
                                },
  ...
  CKEDITOR.dialog.on("resize", function (b) {
    ...
    "checkspell" == d._.name &&
      (a.bnr ? c && c.setSize("height", b.height - 310) : c && c.setSize("height", b.height - 220),
