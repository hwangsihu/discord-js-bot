...
CKEDITOR.dialog.add("specialchar", (k) => {
  var e,
    ...
    d = (c, b) => {
      ...
      "span" == b.getName() && (b = b.getParent());
      "a" == b.getName() &&
        (e.getContentElement("info", "charPreview").getElement().setHtml("\x26nbsp;"),
        e.getContentElement("info", "htmlPreview").getElement().setHtml("\x26nbsp;"),
      ...
      for (
        ...
        for (var l = 0; l < c; l++, d++) {
          if ((h = b[d])) {
            h instanceof Array
              ? ((e = h[1]), (h = h[0]))
              : ((e = h.replace("\x26", "").replace(";", "").replace("#", "")), (e = n[e] || h));
