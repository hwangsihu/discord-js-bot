...
(function () {
  ...
  CKEDITOR.plugins.add("codesnippet", {
    ...
    lang: "ar,az,bg,ca,cs,da,de,de-ch,el,en,en-au,en-gb,eo,es,es-mx,et,eu,fa,fi,fr,fr-ca,gl,he,hr,hu,id,it,ja,km,ko,ku,lt,lv,nb,nl,no,oc,pl,pt,pt-br,ro,ru,sk,sl,sq,sv,th,tr,tt,ug,uk,vi,zh,zh-cn",
    icons: "codesnippet",
    hidpi: !0,
    beforeInit: function (a) {
      ...
      this.setHighlighter = function (b) {
        ...
        a._.codesnippet.langsRegex = new RegExp(
          "(?:^|\\s)language-(" + CKEDITOR.tools.objectKeys(b).join("|") + ")(?:\\s|$)"
        );
      };
    },
    onLoad: function () {
