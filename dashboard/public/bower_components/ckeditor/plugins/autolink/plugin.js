...
(function () {
  ...
  CKEDITOR.plugins.add("autolink", {
    ...
    init: function (c) {
      ...
      function e(a) {
        return a.match(CKEDITOR.config.autolink_urlRegex) || a.match(CKEDITOR.config.autolink_emailRegex);
      }
            ...
            if (-1 != CKEDITOR.tools.indexOf(a, b.data.keyCode)) {
              ...
              if (
                ...
                !b.getRanges()[0].startContainer.getAscendant("a", !0) &&
                  (b.selectRanges([d.range]), c.insertHtml(f(d.text), "text"), !CKEDITOR.env.webkit))
              ) {
                var d = b.getRanges()[0],
                  e = c.createRange();
