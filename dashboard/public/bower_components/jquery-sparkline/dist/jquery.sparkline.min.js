  ...
  ((factory) => {
    ...
    addCss = (css) => {
      ...
      if (iefail) {
        ...
        tag[typeof document.body.style.WebkitAppearance == "string" ? "innerText" : "innerHTML"] =
          css;
      }
    };
    ...
    Tooltip = createClass({
      ...
      init: function (options) {
        ...
        this.tooltip = $("<div/>", { id: "jqstooltip", class: tooltipClassname }).appendTo(
          this.container
        );
      ...
      setContent: function (content) {
        ...
        this.tooltip
          .html(content)
          .css({ width: this.width, height: this.height, visibility: "visible" });
        if (this.hidden) {
          this.hidden = false;
          this.updatePosition();
        }
