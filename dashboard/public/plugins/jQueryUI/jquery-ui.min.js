                ...
                return "instance" === n
                  ...
                  : a
                    ? e.isFunction(a[n]) && "_" !== n.charAt(0)
                      ? ((i = a[n].apply(a, o)),
                        i !== a && void 0 !== i ? ((r = i && i.jquery ? r.pushStack(i.get()) : i), !1) : void 0)
  ...
  e(document).mouseup(function () {
          ...
          return (
            ...
            e.each(["my", "at"], function () {
              var e,
                ...
                i = (n[this] || "").split(" ");
              1 === i.length &&
                (i = l.test(i[0]) ? i.concat(["center"]) : u.test(i[0]) ? ["center"].concat(i) : ["center", "center"]),
    ...
    e.widget("ui.accordion", {
      ...
      _activate: function (t) {
        ...
        i !== this.active[0] &&
          ((i = i || this.active[0]), this._eventHandler({ target: i, currentTarget: i, preventDefault: e.noop }));
      },
      ...
      _eventHandler: function (t) {
        ...
        t.preventDefault(),
          (a && !i.collapsible) ||
            ...
            i.icons &&
              s.children(".ui-accordion-header-icon").removeClass(i.icons.activeHeader).addClass(i.icons.header),
            a ||
              (n.removeClass("ui-corner-all").addClass("ui-accordion-header-active ui-state-active ui-corner-top"),
              i.icons &&
                n.children(".ui-accordion-header-icon").removeClass(i.icons.header).addClass(i.icons.activeHeader),
            ...
            menufocus: function (t, i) {
              ...
              return this.isNewMenu && ((this.isNewMenu = !1), t.originalEvent && /^mouse/.test(t.originalEvent.type))
                ...
                : ((n = i.item.data("ui-autocomplete-item")),
                  ...
                  s &&
                    e.trim(s).length &&
                    (this.liveRegion.children().hide(), e("<div>").text(s).appendTo(this.liveRegion)),
                  void 0);
            },
    ...
    _resetButton: function () {
      ...
      s.primary || s.secondary
        ? (this.options.text && a.push("ui-button-text-icon" + (n ? "s" : s.primary ? "-primary" : "-secondary")),
          ...
          this.options.text ||
            (a.push(n ? "ui-button-icons-only" : "ui-button-icon-only"), this.hasTitle || t.attr("title", e.trim(i))))
      ...
      for (
        ...
        for (k = "", this.maxRows = 4, T = 0; K[1] > T; T++) {
          ...
          Z++,
            ...
            (M +=
              "</tbody></table>" +
              (Q ? "</div>" + (K[0] > 0 && T === K[1] - 1 ? "<div class='ui-datepicker-row-break'></div>" : "") : "")),
            (k += M);
        }
        _ += k;
      }
            ...
            return (
              ...
              f(a.props, function (e, n) {
                ...
                null !== l &&
                  (null === o
                    ? (h[a] = l)
                    : (u.mod && (l - o > u.mod / 2 ? (o += u.mod) : o - l > u.mod / 2 && (o -= u.mod)),
                      (h[a] = i((l - o) * t + o, n))));
              }),
              this[n](h)
            );
                  ...
                  return "undefined" === o
                    ...
                    : ("function" === o && ((n = n.call(this, u)), (o = e.type(n))),
                      null == n && i.empty
                        ? this
                        : ("string" === o &&
                            ((a = r.exec(n)), a && (n = u + parseFloat(a[2]) * ("+" === a[1] ? 1 : -1))),
                          (l[i.idx] = n),
                          this[h](l)));
                });
            });
    ...
    e.widget("ui.progressbar", {
      ...
      _create: function () {
        (this.oldValue = this.options.value = this._constrainedValue()),
          ...
          (this.valueDiv = e("<div class='ui-progressbar-value ui-widget-header ui-corner-left'></div>").appendTo(
            this.element
          )),
          this._refreshValue();
      },
    ...
    e.widget("ui.selectmenu", {
      ...
      _move: function (e, t) {
        ...
        this.isOpen
          ...
          (s =
            "first" === e || "last" === e ? i["first" === e ? "prevAll" : "nextAll"](n).eq(-1) : i[e + "All"](n).eq(0)),
      ...
      _parse: function (e) {
        return (
          "string" == typeof e &&
            "" !== e &&
            (e =
              window.Globalize && this.options.numberFormat ? Globalize.parseFloat(e, 10, this.options.culture) : +e),
          "" === e || isNaN(e) ? null : e
        );
      },
      _format: function (e) {
        ...
        e.each(this.tooltips, function (i, s) {
          ...
          (n.target = n.currentTarget = a[0]),
            ...
            a.data("ui-tooltip-title") &&
              (a.attr("title") || a.attr("title", a.data("ui-tooltip-title")), a.removeData("ui-tooltip-title"));
        }),
          this.liveRegion.remove();
      },
    });
