...
(jvm.$ = jQuery),
  ...
  (jvm.AbstractShapeElement.prototype.setSelected = function (e) {
    this.isSelected !== e &&
      ((this.isSelected = e), this.updateStyle(), jvm.$(this.node).trigger("selected", [e]));
  }),
  ...
  (jvm.AbstractShapeElement.mergeStyles = (e, t) => {
    var n;
    t = t || {};
  ...
  (jvm.SVGElement.prototype.createElement = (e) =>
    document.createElementNS(jvm.SVGElement.svgns, e)),
  (jvm.SVGElement.prototype.addClass = function (e) {
    this.node.setAttribute("class", e);
  }),
  (jvm.SVGElement.prototype.getElementCtr = (e) => jvm["SVG" + e]),
  ...
  (jvm.VMLElement.initializeVML = () => {
    try {
      document.namespaces.rvml || document.namespaces.add("rvml", "urn:schemas-microsoft-com:vml"),
        (jvm.VMLElement.prototype.createElement = (e) =>
          document.createElement("<rvml:" + e + ' class="rvml">'));
    } catch (e) {
      jvm.VMLElement.prototype.createElement = (e) =>
        document.createElement("<" + e + ' xmlns="urn:schemas-microsoft.com:vml" class="rvml">');
    }
    document.createStyleSheet().addRule(".rvml", "behavior:url(#default#VML)"),
      (jvm.VMLElement.VMLInitialized = !0);
  }),
  (jvm.VMLElement.prototype.getElementCtr = (e) => jvm["VML" + e]),
  ...
  (jvm.VMLShapeElement.prototype.applyAttr = function (e, t) {
    switch (e) {
      ...
      case "stroke-opacity":
        ...
        break;
      case "stroke-width":
        Number.parseInt(t, 10) === 0 ? (this.node.stroked = !1) : (this.node.stroked = !0),
  ...
  (jvm.VMLPathElement.pathSvgToVml = (e) => {
    var t = "",
      n = 0,
      r = 0,
      i,
    ...
    return (
      ...
      e
        .replace(/([MmLlHhVvCcSs])\s*((?:-?\d*(?:\.\d+)?\s*,?\s*)+)/g, (e, t, o, u) => {
          (o = o
            .replace(/(\d)-/g, "$1,-")
            .replace(/^\s+/g, "")
            .replace(/\s+$/g, "")
  ...
  (jvm.SimpleScale.prototype.getValue = (e) => e),
  ...
  (jvm.NumericScale.prototype = {
    ...
    setNormalizeFunction: function (e) {
      e === "polynomial"
        ? (this.normalize = (e) => Math.pow(e, 0.2))
        : e === "linear"
  ...
  (jvm.ColorScale.numToRgb = (e) => {
    e = e.toString(16);
    while (e.length < 6) e = "0" + e;
    return "#" + e;
  }),
  (jvm.ColorScale.rgbToArray = (e) => (
    (e = e.substr(1)),
    [
      Number.parseInt(e.substr(0, 2), 16),
      Number.parseInt(e.substr(2, 2), 16),
      Number.parseInt(e.substr(4, 2), 16),
    ]
  )),
  (jvm.DataSeries = function (e, t) {
    ...
    (e = e || {}),
      ...
      jvm.$.isArray(e.scale)
        ? ((n =
            e.attribute === "fill" || e.attribute === "stroke" ? jvm.ColorScale : jvm.NumericScale),
    ...
    setValues: function (e) {
      ...
      if (this.scale instanceof jvm.OrdinalScale || this.scale instanceof jvm.SimpleScale)
        ...
        if (!this.params.min || !this.params.max) {
          for (i in e) (r = Number.parseFloat(e[i])), r > t && (t = e[i]), r < n && (n = r);
  ...
  (jvm.WorldMap = function (e) {
    ...
    for (n in jvm.WorldMap.apiEvents)
      this.params[n] &&
        this.container.bind(jvm.WorldMap.apiEvents[n] + ".jvectormap", this.params[n]);
  ...
  (jvm.WorldMap.prototype = {
    ...
    bindContainerEvents: function () {
      ...
      this.container
        .mousemove(
          (i) => (
            e &&
              ((this.transX -= (t - i.pageX) / this.scale),
              (this.transY -= (n - i.pageY) / this.scale),
              this.applyTransform(),
              (t = i.pageX),
              (n = i.pageY)),
            !1
        ...
        .mousedown((r) => ((e = !0), (t = r.pageX), (n = r.pageY), !1)),
        jvm.$("body").mouseup(() => {
          e = !1;
        }),
        this.params.zoomOnScroll &&
          this.container.mousewheel((e, t, n, i) => {
            var s = jvm.$(this.container).offset(),
              o = e.pageX - s.left,
              u = e.pageY - s.top,
              a = Math.pow(1.3, i);
            this.label.hide(), this.setScale(this.scale * a, o, u), e.preventDefault();
          });
    },
          ...
          a.type == "touchstart" && (u = 0),
            f.length == 1
              ? (u == 1 &&
                  ((h = this.transX),
                  (p = this.transY),
                  (this.transX -= (r - f[0].pageX) / this.scale),
                  (this.transY -= (i - f[0].pageY) / this.scale),
                  this.applyTransform(),
                  this.label.hide(),
                  (h != this.transX || p != this.transY) && a.preventDefault()),
                (r = f[0].pageX),
                (i = f[0].pageY))
              : f.length == 2 &&
                (u == 2
                  ? ((c =
                    ...
                    this.setScale(e * c, s, o),
                    this.label.hide(),
                    a.preventDefault())
                  : ((l = jvm.$(this.container).offset()),
                    f[0].pageX > f[1].pageX
    ...
    bindElementEvents: function () {
      ...
      this.container.mousemove(() => {
        ...
        this.container.delegate(
          ...
          "mouseover mouseout",
          function (t) {
            var r = jvm.$(this).attr("class").baseVal
        ...
        this.container.delegate("[class~='jvectormap-element']", "mouseup", function (n) {
          var i = jvm.$(this).attr("class").baseVal
              ? jvm.$(this).attr("class").baseVal
              : jvm.$(this).attr("class"),
    ...
    createLabel: function () {
      (this.label = jvm.$("<div/>").addClass("jvectormap-label").appendTo(jvm.$("body"))),
        this.container.mousemove((t) => {
          var n = t.pageX - 15 - this.labelWidth,
            r = t.pageY - 15 - this.labelHeight;
          n < 5 && (n = t.pageX + 15),
            r < 5 && (r = t.pageY + 15),
            this.label.is(":visible") && this.label.css({ left: n, top: r });
        });
    },
        ...
        typeof t != "undefined" &&
          ...
          r
            ? ((this.transX = t + (this.defaultWidth * (this.width / (this.defaultWidth * e))) / 2),
              (this.transY =
                n + (this.defaultHeight * (this.height / (this.defaultHeight * e))) / 2))
