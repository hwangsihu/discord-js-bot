...
((h) => {
  ...
  h.fn[q] = function (a, b) {
    ...
    var f = h.extend(
        { checkedClass: l, disabledClass: s, indeterminateClass: m, labelHover: !0, aria: !1 },
        a
      ),
      k = f.handle,
    ...
    return c.each(function () {
      ...
      a.on("click.i focus.i blur.i keyup.i keydown.i keypress.i", (b) => {
        var d = b[n];
        b = b.keyCode;
        if ("click" == d) return !1;
      ...
      d.on("click mousedown mouseup mouseover mouseout touchbegin.i touchend.i", (b) => {
        var d = b[n],
          e = /wn|up/.test(d) ? w : B;
        if (!c[s]) {
          if ("click" == d) F(a, !1, !0);
