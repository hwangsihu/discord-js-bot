  ...
  (d.prototype = {
    ...
    highlightHour: function () {
      ...
      (this.highlightedUnit = "hour"),
        a.setSelectionRange &&
          setTimeout(() => {
            this.hour < 10 ? a.setSelectionRange(0, 1) : a.setSelectionRange(0, 2);
          }, 0);
    },
    highlightMinute: function () {
      ...
      (this.highlightedUnit = "minute"),
        a.setSelectionRange &&
          setTimeout(() => {
            this.hour < 10 ? a.setSelectionRange(2, 4) : a.setSelectionRange(3, 5);
          }, 0);
    },
    highlightSecond: function () {
      ...
      (this.highlightedUnit = "second"),
        a.setSelectionRange &&
          setTimeout(() => {
            this.hour < 10 ? a.setSelectionRange(5, 7) : a.setSelectionRange(6, 8);
          }, 0);
    },
    highlightMeridian: function () {
      ...
      (this.highlightedUnit = "meridian"),
        a.setSelectionRange &&
          (this.showSeconds
            ? setTimeout(() => {
                this.hour < 10 ? a.setSelectionRange(8, 10) : a.setSelectionRange(9, 11);
              }, 0)
            : setTimeout(() => {
                this.hour < 10 ? a.setSelectionRange(5, 7) : a.setSelectionRange(6, 8);
              }, 0));
    ...
    changeToNearestStep: (a, b) =>
      a % b === 0 ? a : Math.round((a % b) / b) ? (a + (b - (a % b))) % 60 : a - (a % b),
    place: function () {
      if (!this.isInline) {
        ...
        "auto" === q &&
          ...
          "top" === q ? (n += k) : (n -= d + Number.parseInt(this.$widget.css("padding-top"), 10)),
    ...
    showWidget: function () {
      this.isOpen ||
        ...
        "" === this.hour &&
          (this.defaultTime ? this.setDefaultTime(this.defaultTime) : this.setTime("0:0:0")),
        "modal" === this.template && this.$widget.modal
